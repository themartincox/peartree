...
export const metadata: Metadata = {
  title: 'Dentist in Mapperly - Pear Tree Dental | Quality Dental Care Near You',
  description: 'Looking for a dentist near Mapperly? Pear Tree Dental in Burton Joyce offers modern dental care, membership plans, and convenient access for Mapperly residents.',
  keywords: [
    'dentist Mapperly',
  ...
  openGraph: {
    title: 'Dentist in Mapperly - Pear Tree Dental | Quality Dental Care Near You',
    description: 'Modern dental care for Mapperly residents. Membership plans from £8.99/month. Same-day emergency appointments available.',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Modern dental practice serving Mapperly residents with comprehensive dental care and affordable membership plans.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-pear-gold font-medium">Serving Mapperly</span>
            </div>
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Professional dental care for Mapperly residents at Pear Tree Dental in nearby Burton Joyce.
              Just a 10-minute journey for comprehensive dental services with transparent membership pricing.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">Average drive from Mapperly to our Burton Joyce practice</p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">Via Woodborough Road and A612 from Mapperly</p>
                </CardContent>
              </Card>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2">Local Community Care</h3>
                    <p className="text-gray-700">
                      We understand the Mapperly community and provide dental care that fits your busy lifestyle.
                      From families near Mapperly Park to professionals commuting to the city center.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-xl mb-2">Convenient Location</h3>
                    <p className="text-gray-700">
                      Perfect for Mapperly residents - easy access via Woodborough Road or through Gedling.
                      No city center traffic to navigate, with ample free parking on arrival.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">
                      Extended hours including early morning and Saturday appointments to work around
                      Mapperly residents' schedules and family commitments.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Card className="overflow-hidden shadow-xl">
                  <div className="aspect-[4/3] bg-gradient-to-br from-dental-green/10 to-dental-green/20 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <h3 className="text-xl font-bold text-gray-700 mb-2">MAPPERLY TO BURTON JOYCE</h3>
                      <p className="text-gray-600 mb-4">Quick 10-minute journey</p>
              ...
              {([
                {
                  ...
                  icon: Users,
                  features: ["Children's dentistry", "Adult check-ups", "Family appointments", "Preventive care"],
                ...
                },
                {
                  ...
                  icon: Shield,
                  features: ["Same-day availability", "Weekend cover", "Pain relief", "Emergency repairs"],
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600">Based on 40+ reviews from Mapperly area patients</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8">Visit Us from Mapperly</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-8">Directions from Mapperly</h2>
                <div className="bg-white p-6 rounded-lg shadow-sm border border-dental-green/20">
                  <h3 className="font-semibold mb-4 text-dental-green">Direct Route (10 minutes)</h3>
                  <ol className="space-y-2 text-gray-700">
                    ...
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Continue straight through Gedling toward Burton Joyce</span>
                    </li>
                    <li className="flex items-start space-x-2">
                  ...
                  <div className="mt-4 p-3 bg-dental-green/10 rounded">
                    <p className="text-sm text-dental-navy">
                      <strong>Alternative:</strong> Via Gedling bypass for faster journey during peak hours
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join Mapperly residents who've made the switch to convenient, affordable dental care at Pear Tree Dental
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
