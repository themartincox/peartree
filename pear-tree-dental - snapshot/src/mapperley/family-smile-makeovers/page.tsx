...
export const metadata: Metadata = {
  title: "Complete Smile Makeovers in Mapperley - Affordable Transformations for Working Families | Pear Tree Dental",
  description: "Complete smile makeovers for Mapperley working families. Affordable smile transformations, flexible payment plans, and comprehensive care. Quick drive from Mapperley NG3.",
  keywords: [
    "complete smile makeover Mapperley",
    "smile transformation Mapperley NG3",
    "affordable smile makeover Mapperley",
    "comprehensive dental makeover Mapperley",
    "working families smile makeover Mapperley",
    "smile design Mapperley",
    "full smile transformation Mapperley"
  ],
  openGraph: {
    title: "Complete Smile Makeovers in Mapperley - Affordable Transformations for Working Families | Pear Tree Dental",
    description: "Complete smile makeovers for Mapperley working families. Affordable smile transformations with flexible payment plans.",
    url: "https://peartree.dental/mapperley/complete-smile-makeovers"
  },
  alternates: {
    canonical: "https://peartree.dental/mapperley/complete-smile-makeovers"
  }
};

export default function MapperleyCompleteSmileMakeoversPage() {
  const mapperleyMakeoverFAQs = [
    {
      question: "How affordable are complete smile makeovers for working families from Mapperley?",
    ...
    },
    {
      ...
      answer: "Most smile makeovers are completed in 2-6 months, depending on treatments chosen. We can often phase treatment to minimize work disruption for Mapperley families, with initial improvements visible after the first phase of treatment."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pear Tree Dental - Complete Smile Makeovers in Mapperley",
            "image": "https://peartree.dental/images/complete-smile-makeovers-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/complete-smile-makeovers",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Complete Smile Makeovers in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Complete smile transformations from £1,200 with payment plans
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">✨ Complete smile transformations with phased payment plans for Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Complete Smile Makeovers for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Mapperley working families want comprehensive smile transformations that fit their
            ...
            <div className="text-center bg-rose-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We believe every Mapperley working family deserves the confidence that comes with a beautiful smile.
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Smile Makeover Packages for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                helps Mapperley families see the practical value of comprehensive smile transformation.
              </p>
            </div>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Smile Makeover Treatment Options for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Making Complete Smile Makeovers Affordable for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                What Mapperley Families Say About Our Affordable Smile Makeovers
              </h2>
            </div>

            <TestimonialBanner
              text="I'd been hiding my smile for years because of chipped and stained teeth. As a working mum, I thought smile makeovers were only for celebrities! Being just a quick drive from Mapperley, I went for a consultation expecting to be told it was too expensive. Instead, they designed a phased treatment plan that fit our family budget perfectly. Phase 1 was whitening and bonding for just £850 - the transformation was incredible! Six months later, I completed Phase 2 with crowns on my back teeth. The payment plan made it so manageable, and my confidence has completely changed. I smile in every photo now!"
              author="Claire B. from Mapperley, NG3"
              className="mb-8"
            />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Complete Smile Makeover Results for Mapperley Families
            </h2>
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley working parent's comprehensive makeover with phased approach"
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Smile Makeover Questions from Mapperley Families
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working families about affordable complete smile makeovers
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Affordable Smile Transformations - Quick Drive from Mapperley
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Transform Your Smile and Your Confidence from Mapperley Today
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Phased treatment plans • Payment plans available • Natural results • Quick drive from Mapperley
              </p>
            </div>
