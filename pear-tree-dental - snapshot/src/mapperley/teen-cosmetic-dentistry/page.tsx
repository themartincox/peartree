...
export const metadata: Metadata = {
  title: "Composite Bonding in Mapperley - Affordable Smile Improvements for Working Families | Pear Tree Dental",
  description: "Composite bonding for Mapperley working families. Affordable smile improvements, same-day treatment, and flexible payment options. Quick drive from Mapperley NG3.",
  keywords: [
    "composite bonding Mapperley",
    "tooth bonding Mapperley NG3",
    "affordable smile improvement Mapperley",
    "cosmetic dentistry Mapperley",
    "same day bonding Mapperley",
    "working families cosmetic dentist Mapperley",
    "budget smile makeover Mapperley"
  ],
  openGraph: {
    title: "Composite Bonding in Mapperley - Affordable Smile Improvements for Working Families | Pear Tree Dental",
    description: "Composite bonding for Mapperley working families. Affordable smile improvements with same-day treatment and flexible payment options.",
    url: "https://peartree.dental/mapperley/composite-bonding"
  },
  alternates: {
    canonical: "https://peartree.dental/mapperley/composite-bonding"
  }
};

export default function MapperleyCompositeBondingPage() {
  const mapperleyBondingFAQs = [
    {
      question: "How affordable is composite bonding from Mapperley for working families?",
      answer: "Composite bonding is one of the most cost-effective cosmetic treatments available. Starting from £120 per tooth with payment plan options, it's accessible to Mapperley working families. We provide transparent pricing and honest advice about what bonding can achieve for your smile."
    },
    {
      question: "Can composite bonding be completed in one visit?",
      answer: "Yes! Most composite bonding treatments can be completed in a single visit lasting 1-2 hours. This makes it perfect for busy working families from Mapperley who want smile improvements without multiple appointments disrupting their schedule."
    },
    {
    ...
    },
    {
      ...
      answer: "Bonding can address chipped teeth, gaps between teeth, discoloration, slightly crooked teeth, and worn edges. We assess each case honestly and explain what bonding can achieve versus other treatments, helping Mapperley families choose the best option."
    },
    {
      question: "Do you offer payment plans for composite bonding?",
      answer: "Yes! We understand working families need flexible payment options. We offer interest-free payment plans to spread bonding costs over 6-12 months, making smile improvements affordable for Mapperley families on any budget."
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pear Tree Dental - Composite Bonding in Mapperley",
            "image": "https://peartree.dental/images/composite-bonding-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/composite-bonding",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Composite Bonding in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Same-day smile improvements from £120 with payment plans
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">✨ Same-day smile improvements with affordable payment plans for Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Smile Improvements for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Composite bonding offers the most cost-effective way to dramatically improve your smile.
                Perfect for Mapperley working families who want beautiful results without the high costs of veneers or lengthy orthodontic treatment.
              </p>
            </div>
            ...
            <div className="text-center bg-pink-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley working families want smile improvements that fit their budget and busy schedule.
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Composite Bonding Options for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                confidence and professional appearance for Mapperley working families.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                helps Mapperley working families make the best choice for their needs and budget.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                ...
                of affordability, speed, and results for busy Mapperley families seeking smile improvements.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Making Smile Improvements Affordable for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Affordable Smile Improvements for Mapperley Families
            </h2>
            <p className="text-lg text-gray-600">
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley working professional's bonding transformation"
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Composite Bonding Questions from Mapperley Families
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working families about affordable composite bonding treatment
              </p>
            </div>

            <FAQSection faqs={mapperleyBondingFAQs} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Affordable Smile Improvements - Quick Drive from Mapperley
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Transform Your Smile Today with Affordable Bonding from Mapperley
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Same-day results • Payment plans available • Natural appearance • Quick drive from Mapperley
              </p>
            </div>
