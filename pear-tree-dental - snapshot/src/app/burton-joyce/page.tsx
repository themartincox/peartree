            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed mb-8">
                  ...
                  Modern treatments, friendly service, and convenient location for all your family's dental needs.
                </p>
              </div>
              ...
              <div className="grid grid-cols-3 gap-6 pt-8 border-t border-gray-200">
                <div className="text-center">
                  <div className="text-2xl font-bold text-dental-green">15+</div>
                  <div className="text-sm text-gray-600">Years serving Burton Joyce</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-dental-green">2000+</div>
            ...
            <div className="relative">
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <div className="text-center">
                    <h3 className="text-xl font-bold text-gray-700 mb-2">BURTON JOYCE PRACTICE IMAGE</h3>
                    <p className="text-gray-600">Modern dental practice exterior in Burton Joyce</p>
                  </div>
                </div>
              </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Easy to find, easy to park, and easy to book appointments that fit around your busy life
            </p>
          </div>
            ...
            <div className="space-y-6">
              ...
              <Card className="p-6 border border-dental-green/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-pear-primary mb-2">Parking & Access</h3>
              ...
              <Card className="p-6 border border-dental-green/20">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-bold text-pear-primary mb-2">Opening Hours</h3>
      ...
      <section className="py-16 bg-gradient-to-br from-pear-background/30 to-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              From routine check-ups to advanced cosmetic treatments, we provide comprehensive dental care for all ages
            </p>
          </div>
            ...
            {[
              {
                ...
                features: ["Children's dentistry", "Adult check-ups", "Preventive care", "Emergency appointments"],
                price: "From £45",
                icon: Users
              },
              {
              ...
              {
                title: "Orthodontics",
                description: "Straighten teeth discreetly with modern clear aligners",
                features: ["Invisalign", "ClearCorrect", "Adult orthodontics", "Teen treatments"],
                price: "From £2,800",
                icon: CheckCircle
              },
              {
                ...
                features: ["Dental implants", "Crowns & bridges", "Root canal treatment", "Dentures"],
                price: "From £150",
                icon: Shield
              },
              {
                title: "Preventive Care",
                description: "Keep your teeth healthy with regular maintenance",
                features: ["Scale & polish", "Oral health checks", "Fluoride treatments", "Dental hygiene"],
                price: "From £65",
                icon: Heart
              },
              {
                ...
                features: ["Same-day appointments", "Pain relief", "Tooth repairs", "Out-of-hours care"],
                price: "From £75",
                icon: Clock
              }
            ].map((service, index) => {
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">All treatments available with membership plans - save up to 10%</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Read what your neighbors have to say about their dental care experience
            </p>
          </div>
            ...
            {[
              {
                ...
                review: "Excellent local dental practice. The team is friendly, professional, and the location is so convenient. My whole family has been coming here for years.",
                rating: 5,
              ...
              },
              {
                ...
                location: "Burton Joyce",
                review: "Had my teeth whitened here last month and couldn't be happier with the results. Professional service and great value for money.",
                rating: 5,
              ...
              },
              {
                name: "Emma Davis",
                location: "Burton Joyce",
                review: "The emergency dental service saved the day when I had a dental emergency on the weekend. Quick, efficient, and very caring staff.",
                rating: 5,
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-dental-green/10 to-dental-green/5 rounded-2xl p-8 max-w-2xl mx-auto">
              ...
              <p className="text-gray-700 font-semibold">Based on 150+ Google Reviews from Burton Joyce residents</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-white/90">
              Join hundreds of Burton Joyce residents who trust us with their dental care.
              Call us today or book online for your convenience.
            </p>
