...
export const metadata: Metadata = {
  title: "Dental Implants in Arnold - Premium Tooth Replacement | Pear Tree Dental",
  description: "Premium dental implants for Arnold residents. Single implants, All-on-4, and full mouth restoration just 15 minutes away. Expert implant specialists with 95% success rate.",
  keywords: [
  ...
  openGraph: {
    title: "Dental Implants in Arnold - Premium Tooth Replacement | Pear Tree Dental",
    description: "Premium dental implant solutions for Arnold residents. Expert specialists with advanced technology just 15 minutes away.",
  ...
  const arnoldImplantsFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're one of Nottinghamshire's leading implant centres with over 95% success rates and free parking for all patients."
    },
    {
      question: "What dental implant options are available for Arnold patients?",
      answer: "We offer single implants, multiple implants, All-on-4 full arch replacement, and full mouth restoration. All treatments use premium Swiss and German implant systems with lifetime guarantees."
    },
    {
      question: "Can I get same-day dental implants near Arnold?",
      answer: "Yes, we offer same-day implant placement with immediate temporary crowns in suitable cases. This means you can leave with teeth the same day as your implant surgery."
    },
    {
      question: "How long do dental implants last for Arnold patients?",
      answer: "With proper care, dental implants can last 20+ years or even a lifetime. We use only premium implant systems and provide comprehensive aftercare to ensure longevity."
    },
    {
      question: "What makes your implant service different for Arnold residents?",
      answer: "We combine advanced 3D planning, premium implant systems, experienced specialists, and convenient access from Arnold. Our success rates exceed 95% with comprehensive guarantees."
    }
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Arnold's discerning professionals demand the highest quality tooth replacement solutions.
                Our premium dental implant centre in Burton Joyce offers Swiss and German implant systems
                with over 95% success rates, just 15 minutes from Arnold with convenient free parking.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-pear-primary mb-2">Premium Materials</h3>
                  <p className="text-gray-600">Swiss Straumann and German Camlog implants with lifetime guarantees</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-pear-primary mb-2">95% Success Rate</h3>
                  <p className="text-gray-600">Exceptional success rates with experienced implant specialists</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-pear-primary mb-2">Same-Day Options</h3>
                  <p className="text-gray-600">Immediate implants with temporary teeth fitted same day</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From single tooth replacement to full mouth restoration, we offer the complete range
                of premium implant solutions for Arnold's professionals and families.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-8 mb-16">
              ...
              <Card className="border-2 border-pear-gold hover:shadow-xl transition-shadow">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl text-pear-primary">Single Tooth Implants</CardTitle>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-semibold">Replace One Missing Tooth</h4>
                      <p className="text-sm text-gray-600">No damage to adjacent healthy teeth</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-pear-gold mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Straumann implants with lifetime guarantee</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-pear-gold mt-1 flex-shrink-0" />
                    <div>
                      <h4 className="font-semibold">Same-Day Options Available</h4>
                      <p className="text-sm text-gray-600">Immediate implant with temporary crown</p>
                    </div>
                  </div>
                  <div className="pt-4 border-t">
                    <p className="text-2xl font-bold text-pear-primary">From £2,500</p>
                    <p className="text-sm text-gray-600">Complete treatment including crown</p>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-2 border-dental-green hover:shadow-xl transition-shadow">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl text-pear-primary">All-on-4 Full Arch</CardTitle>
                  <Badge className="bg-dental-green text-white">Full Mouth Solution</Badge>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Full arch of teeth on just 4 implants</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-dental-green mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Fixed teeth fitted on surgery day</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-dental-green mt-1 flex-shrink-0" />
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Computer-guided surgery for precision</p>
                    </div>
                  </div>
                  <div className="pt-4 border-t">
                    <p className="text-2xl font-bold text-pear-primary">From £15,000</p>
                    <p className="text-sm text-gray-600">Complete arch replacement per jaw</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="flex items-center gap-3 justify-center">
                  ...
                  <span className="text-gray-600">3D CT planning for precision</span>
                </div>
                <div className="flex items-center gap-3 justify-center">
                  <Award className="w-6 h-6 text-pear-primary" />
                  <span className="text-gray-600">Premium Swiss implant systems</span>
                </div>
                <div className="flex items-center gap-3 justify-center">
                  <Heart className="w-6 h-6 text-pear-primary" />
                  <span className="text-gray-600">Lifetime implant guarantees</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">95%+</div>
                <p className="text-gray-600">Implant success rate</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">20+ years</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the incredible transformations achieved with our premium implant solutions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about premium dental implants
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-pear-primary/10 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-pear-primary mb-2">Premium Patient Experience</h4>
                    <p className="text-gray-600">Free parking, comfortable environment, and refreshments</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your implant consultation from Arnold — premium Swiss implants, 95% success rates,
              and lifetime guarantees just 15 minutes from your doorstep.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free implant consultation worth £200 • 3D CT scan included • 0% interest available
              </p>
            </div>
