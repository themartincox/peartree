...
export const metadata: Metadata = {
  title: "Complete Smile Makeover in Arnold - Full Mouth Transformation | Pear Tree Dental",
  description: "Complete smile makeover for Arnold residents. Full mouth transformation with veneers, whitening, and implants. Premium cosmetic dentistry just 15 minutes away.",
  keywords: [
  ...
  openGraph: {
    title: "Complete Smile Makeover in Arnold - Full Mouth Transformation | Pear Tree Dental",
    description: "Complete smile makeover for Arnold residents. Full mouth transformation with advanced cosmetic dentistry just 15 minutes away.",
  ...
  const arnoldMakeoverFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're Nottinghamshire's premier smile makeover specialists with advanced digital smile design and comprehensive cosmetic dentistry."
    },
    {
      question: "What's included in a complete smile makeover for Arnold patients?",
      answer: "Your makeover may include veneers, crowns, teeth whitening, gum reshaping, orthodontics, and implants. We create a personalized treatment plan to achieve your perfect smile."
    },
    {
      question: "How long does a complete smile makeover take?",
      answer: "Most comprehensive makeovers take 3-6 months depending on complexity. We use digital smile design to show you the final result before we start, ensuring perfect planning."
    },
    {
      question: "Can I see my new smile before treatment begins?",
      answer: "Absolutely! Our digital smile design technology creates a 3D preview of your new smile. You'll see exactly how your transformation will look before any treatment starts."
    },
    {
      question: "What makes your smile makeover service special for Arnold residents?",
      answer: "We combine advanced digital smile design, multiple cosmetic specialties, comprehensive planning, and convenient Arnold access. Our makeovers are life-changing transformations."
    }
  ];
  ...
  const makeoverOptions = [
    {
      ...
      treatments: ["Professional whitening", "Composite bonding", "Digital smile design", "Gum contouring"],
      duration: "4-6 weeks",
      price: "From £1,500",
    ...
    },
    {
      ...
      treatments: ["6-8 porcelain veneers", "Invisalign treatment", "Professional whitening", "Gum reshaping"],
      duration: "3-4 months",
      price: "From £6,500",
    ...
    },
    {
      ...
      treatments: ["Full mouth veneers/crowns", "Dental implants", "Gum surgery", "Complete reconstruction"],
      duration: "4-6 months",
      price: "From £15,000",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Complete Smile Makeover in <span className="text-pear-gold">Arnold</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                For Arnold's ambitious professionals, a perfect smile isn't just about aesthetics—it's about confidence,
                success, and making the right impression. Our comprehensive smile makeovers combine multiple
                cosmetic treatments for life-changing transformations, just 15 minutes from Arnold.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">See your complete transformation before any treatment begins</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-pear-primary mb-2">Personalized Planning</h3>
                  <p className="text-gray-600">Custom treatment plans designed for your unique goals</p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="font-bold text-pear-primary mb-2">Expert Coordination</h3>
                  <p className="text-gray-600">Multiple specialists working together for perfect results</p>
                </CardContent>
              </Card>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From subtle enhancements to complete transformations, our smile makeover packages
                are designed to meet every Arnold patient's needs, goals, and budget.
              </p>
            </div>
              ...
              {makeoverOptions.map((option, index) => (
                <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-pear-gold">
                  <CardHeader className="text-center pb-4">
                    ...
                    <div className="text-2xl font-bold text-pear-primary mb-1">{option.price}</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our proven process ensures your complete smile makeover exceeds expectations
                with careful planning, expert execution, and stunning results.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              ...
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">3-6 months</div>
                <p className="text-gray-600">Complete transformation time</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">Life-changing</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the incredible complete transformations achieved with our comprehensive makeover treatments
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about complete smile makeover treatments
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-pear-primary/10 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-pear-primary mb-2">Luxury Experience</h4>
                    <p className="text-gray-600">Premium environment perfect for smile makeover consultations</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your smile makeover consultation from Arnold — digital smile design, expert planning,
              and life-changing transformations just 15 minutes from your doorstep.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free digital smile design worth £500 • Comprehensive consultation included • 0% finance available
              </p>
            </div>
