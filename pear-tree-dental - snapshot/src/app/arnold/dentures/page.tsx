...
export const metadata: Metadata = {
  ...
  description: "Premium dentures for Arnold residents. Complete dentures, partial dentures, and implant-retained options just 15 minutes away. Natural-looking, comfortable fits guaranteed.",
  keywords: [
    "dentures Arnold",
    "false teeth Arnold",
  ...
  openGraph: {
    title: "Dentures in Arnold - Premium Denture Solutions | Pear Tree Dental",
    description: "Premium denture solutions for Arnold residents. Complete and partial dentures with natural-looking results just 15 minutes away.",
...
export default function ArnoldDenturesPage() {
  const arnoldDenturesFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're one of Nottinghamshire's most experienced denture practices with over 30 years of expertise and free parking."
    },
    {
      question: "What types of dentures are available for Arnold patients?",
      answer: "We offer complete dentures, partial dentures, flexible Valplast dentures, and implant-retained dentures. Each option is custom-made for comfort and natural appearance."
    },
    {
      question: "How long do dentures last for Arnold patients?",
      answer: "High-quality dentures typically last 5-8 years with proper care. We provide comprehensive aftercare, adjustments, and repairs to ensure optimal comfort and function."
    },
    {
      question: "Can I get same-day dentures near Arnold?",
      answer: "Yes, we offer immediate dentures that can be fitted the same day as extractions. This ensures you're never without teeth during the healing process."
    },
    {
      question: "What makes your denture service special for Arnold residents?",
      answer: "We combine 30+ years experience, multiple denture types, expert fitting, natural aesthetics, and convenient Arnold access. Our dentures restore confidence and function."
    }
  ];
  ...
  const dentureTypes = [
    ...
    },
    {
      ...
      features: ["No slipping or movement", "Enhanced chewing power", "Preserves jawbone", "Ultimate stability"],
      price: "From £3,500",
      duration: "3-6 months",
      icon: Zap,
  ...
  const benefits = [
    {
      ...
      description: "Natural-looking teeth that enhance your appearance and confidence"
    },
    {
      icon: Target,
      title: "Improve Function",
      description: "Eat your favorite foods again with properly fitted dentures"
    },
    {
      icon: Users,
      title: "Social Confidence",
      description: "Speak clearly and smile with confidence in social situations"
    },
    {
      icon: Shield,
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                For Arnold residents seeking comfortable, natural-looking dentures, experience matters.
                Our 30+ years of denture expertise in Burton Joyce offers every type of denture solution,
                from traditional complete dentures to cutting-edge implant-retained options, just 15 minutes from Arnold.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From traditional complete dentures to innovative implant-retained options,
                we provide the perfect denture solution for every Arnold patient's needs and budget.
              </p>
            </div>
                ...
                return (
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-pear-primary">
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-lg text-pear-primary">{denture.name}</CardTitle>
                      <p className="text-gray-600 text-sm mb-2">{denture.description}</p>
                      <Badge variant="outline" className="text-xs">{denture.suitable}</Badge>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      ...
                      <div className="pt-4 border-t text-center">
                        <p className="text-xl font-bold text-pear-primary mb-1">{denture.price}</p>
                        <div className="flex items-center justify-center gap-2">
                          <Clock className="w-4 h-4 text-gray-500" />
                          <span className="text-sm text-gray-600">{denture.duration}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="flex items-center gap-3 justify-center">
                  ...
                  <span className="text-gray-600">Ongoing aftercare support</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our proven process ensures your dentures fit perfectly, look natural,
                and provide years of comfortable function.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">30+ years</div>
                <p className="text-gray-600">Denture expertise</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">Perfect fit</div>
                <p className="text-gray-600">Custom-made comfort</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">Natural look</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the incredible transformations achieved with our expertly crafted dentures
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about denture treatments
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-pear-primary/10 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-pear-primary mb-2">Comfortable Environment</h4>
                    <p className="text-gray-600">Relaxing atmosphere perfect for denture fittings</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your denture consultation from Arnold — 30+ years expertise, perfect fitting,
              and natural-looking results just 15 minutes from your doorstep.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free denture consultation worth £150 • Payment plans available • Same-day repairs
              </p>
            </div>
