...
export default function ContactFormCard({
  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-3 gap-8 ${className}`}>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 text-sm mb-3">
                  For immediate booking or urgent concerns
                </p>
                <Button
                  asChild
                  size="sm"
              ...
              <div className="bg-white rounded-lg p-4 text-center hover:shadow-md transition-shadow">
                ...
                >
                  <a href="mailto:hello@peartree.dental">
      ...
      <div
        className={
          showContactInfo ? "lg:col-span-2 order-1 lg:order-2" : "lg:col-span-3"
        }
      >
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <div className="flex space-x-2">
              <Badge
                variant={formType === "emergency" ? "destructive" : "secondary"}
              >
                {formType === "emergency"
                  ? "Emergency"
                  : formType === "booking"
            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onBlur={handleFieldBlur}
                    className={
                      focusedField === "lastName" ? "ring-2 ring-pear-gold" : ""
                    }
                  />
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onBlur={handleFieldBlur}
                    className={
                      focusedField === "email" ? "ring-2 ring-pear-gold" : ""
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onBlur={handleFieldBlur}
                    className={
                      focusedField === "phone" ? "ring-2 ring-pear-gold" : ""
                    }
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <Textarea
                  ...
                  onBlur={handleFieldBlur}
                  className={
                    focusedField === "message" ? "ring-2 ring-pear-gold" : ""
                  }
                />
              </div>
              <div>
              ...
              <Button
                ...
                className={`w-full font-semibold ${formType === "emergency" ? "bg-red-600 hover:bg-red-700" : "btn-gold"} text-white`}
              >
                {isSubmitting ? (
                  <>
