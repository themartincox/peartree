...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a dentist near Arnold? Pear Tree Dental in Burton Joyce offers modern dental care, membership plans, and convenient access for Arnold residents.",
  keywords: [
    "dentist Arnold",
    "dentist near Arnold",
  ...
  openGraph: {
    title: "Dentist in Arnold - Pear Tree Dental | Modern Dental Care Near You",
    description:
      "Modern dental care for Arnold residents. Membership plans from £10.95/month. Same-day emergency appointments available.",
...
export default function ArnoldPage(): React.JSX.Element {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Modern dental practice serving Arnold residents with comprehensive dental care and membership plans.",
            address: {
              "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Modern dental care for Arnold residents at Pear Tree Dental in
              nearby Burton Joyce. Just a 15-minute journey for comprehensive
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Average drive from Arnold to our Burton Joyce practice
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Direct route via A614 and A612 from Arnold
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600">
                Based on 35+ reviews from Arnold area patients
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join Arnold residents who've made the switch to convenient,
