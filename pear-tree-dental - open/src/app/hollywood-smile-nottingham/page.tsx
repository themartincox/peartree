...
export const metadata: Metadata = {
  title:
    "Hollywood Smile Nottingham | Perfect Smile Transformation | Pear Tree Dental",
  description:
    "Transform your smile with a stunning Hollywood smile in Nottingham. Camera-ready results, expert craftsmanship, flexible payments. Book your consultation today at Pear Tree Dental.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Achieve the perfect camera-ready smile with expert Hollywood smile treatments in Nottingham. World-class results, local convenience.",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Transform your smile with expert Hollywood smile treatments in Nottingham. Camera-ready results close to home.",
...
export default function HollywoodSmileNottinghamPage() {
  const hollywoodSmileFAQs = [
    {
      ...
      answer:
        "Most Hollywood smile treatments take 2-4 weeks from consultation to completion, though some complex cases may require additional time for optimal results.",
    },
    {
      question: "Will my Hollywood smile look natural?",
      answer:
        "Absolutely. The hallmark of a great Hollywood smile is that it looks naturally perfect - stunning yet completely believable.",
    },
    {
      question: "How long will my Hollywood smile last?",
      answer:
        "With proper care, your Hollywood smile can maintain its beauty for 15-20 years or more. We'll provide you with everything you need to protect your investment.",
    },
    {
      question: "Do you offer guarantees?",
      answer:
        "Yes, we stand behind our work with comprehensive warranties and are committed to ensuring you absolutely love your new Hollywood smile.",
    },
    {
      question: "How much does a Hollywood smile cost in Nottingham?",
      answer:
        "Investment varies depending on your specific needs and treatment plan. We offer flexible payment plans and will provide detailed pricing during your consultation. Most treatments range from £3,000 to £15,000.",
    },
  ];
  ...
  const treatmentOptions = [
    {
      ...
      description:
        "Ultra-thin, custom-crafted porcelain shells that transform your teeth into works of art",
      features: [
        "Custom design for your face",
    ...
    },
    {
      ...
      description:
        "Combine multiple treatments for dramatic, show-stopping Hollywood smile results",
      features: [
    ...
    },
    {
      ...
      description:
        "Accelerated treatments for those wanting Hollywood sparkle with minimal time investment",
      features: [
  ...
  const whyChooseUs = [
    {
      ...
      description:
        "Our cosmetic dentists specialize in smile design and have created hundreds of stunning Hollywood smiles for Nottingham residents",
    },
    {
      icon: Zap,
      title: "State-of-the-Art Technology",
      description:
        "From digital smile design to precision crafting, we use the most advanced techniques available",
    },
    {
      icon: Heart,
      title: "Personalised Care",
      description:
        "Every Hollywood smile is unique. We take time to understand your lifestyle, personality, and goals",
    },
    {
      icon: Users,
      title: "Proven Results",
      description:
        "Our portfolio of Hollywood smile transformations consistently delivers the stunning results our Nottingham patients dream of",
    },
  ];
  ...
  const testimonials = [
    {
      quote:
        "I never imagined I could have a smile like this without going to London. The team at Pear Tree Dental gave me the Hollywood smile I'd dreamed of for years. Now I smile in every photo!",
      author: "Sarah M.",
      location: "Nottingham",
    },
    {
      quote:
        "The attention to detail was incredible. Every tooth was crafted to perfection. People constantly ask if I've had work done - my Hollywood smile looks completely natural.",
      author: "James R.",
      location: "West Bridgford",
    },
    {
      quote:
        "Best investment I've ever made. My new Hollywood smile has transformed not just how I look, but how I feel about myself.",
      author: "Emma L.",
      location: "Beeston",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed">
              Dreaming of that perfect, camera-ready smile you see on the red
              carpet? Your Hollywood smile awaits right here in Nottingham.
              We've helped hundreds of patients achieve the dazzling,
              confidence-boosting smiles they've always wanted.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-amber-600 to-yellow-600 text-white font-semibold text-lg px-8 py-4 h-auto hover:shadow-lg transition-all"
                >
              ...
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-amber-600 text-amber-600 font-semibold text-lg px-8 py-4 h-auto hover:bg-amber-50"
                >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              A Hollywood smile isn't just about having white teeth - it's about
              creating perfect harmony between your smile and your unique facial
              features.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose the perfect treatment path for your dream smile
              transformation
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {(treatmentOptions || []).map((option, index) => (
              <Card
                key={index}
                className="hover:shadow-xl transition-all duration-300 border-2 border-transparent hover:border-amber-200"
              >
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See what our patients are saying about their life-changing smile
              transformations
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-gray-50 to-amber-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              You don't need to travel to London or abroad for world-class smile
              transformation
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto mt-12 space-y-6">
            <Card className="border-2 border-amber-200">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Our team has trained with leading cosmetic dentists
                  internationally, bringing the latest Hollywood smile
                  techniques directly to Nottingham.
                </p>
              </CardContent>
            </Card>
            <Card className="border-2 border-amber-200">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  No lengthy travel or overnight stays - achieve your dream
                  smile close to home with easy access and familiar
                  surroundings.
                </p>
              </CardContent>
            </Card>
            <Card className="border-2 border-amber-200">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Your relationship with us doesn't end when your treatment
                  does. We're here for maintenance, touch-ups, and ongoing care
                  for years to come.
                </p>
              </CardContent>
            </Card>
              ...
              [
                {
                  ...
                  description:
                    "We begin by understanding your vision for your Hollywood smile. Using advanced digital imaging, we'll show you exactly how your transformed smile will look.",
                  icon: Camera,
                },
                {
                  step: "2",
                  ...
                  description:
                    "Your Hollywood smile design is created specifically for you, taking into account your facial structure, skin tone, and personal style preferences.",
                  icon: Award,
                },
                {
                  step: "3",
                  ...
                  description:
                    "Our skilled technicians create your veneers or restorations using the finest materials and latest techniques, ensuring perfection.",
                  icon: Sparkles,
                },
                {
                  step: "4",
                  ...
                  description:
                    "The moment you see your completed Hollywood smile for the first time is unforgettable. It's one of the most emotional and joyful experiences.",
                  icon: Heart,
                },
              ] || []
            ).map((step, index) => {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Your Hollywood smile is an investment in yourself that pays
            ...
            <p className="text-gray-600 mb-8">
              We offer flexible payment plans to make your dream smile
              accessible, and we'll help you explore any insurance benefits you
              may have.
            </p>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-white text-amber-600 hover:bg-gray-100 font-semibold text-lg px-8 py-4 h-auto"
                >
                  <CalendarDays className="w-5 h-5 mr-2" />
                  Book Your Hollywood Smile Consultation
                  <ArrowRight className="w-5 h-5 ml-2" />
              ...
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-amber-600 font-semibold text-lg px-8 py-4 h-auto bg-transparent"
                >
                  <Phone className="w-5 h-5 mr-2" />
                  Call 0115 931 2935
                </Button>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">
              Pear Tree Dental - Creating Life-Changing Hollywood Smiles in
              Nottingham
            </h3>
            <p className="text-gray-300 mb-6">
              Conveniently located in the heart of Nottingham, serving patients
              throughout Nottinghamshire who dream of achieving their perfect
              Hollywood smile.
            </p>
