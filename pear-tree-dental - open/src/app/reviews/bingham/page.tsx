...
export const metadata: Metadata = {
  title:
    "Bingham Dental Care: What Local Patients Really Value | Pear Tree Dental",
  description:
    "Explore what patients in Bingham say about local dental care – from parking and pricing to modern facilities and appointment access. Find the right practice for you.",
  keywords: [
    "Bingham dental care",
  ...
  openGraph: {
    title:
      "Bingham Dental Care: What Local Patients Really Value | Pear Tree Dental",
    description:
      "Explore what patients in Bingham say about local dental care – from parking and pricing to modern facilities.",
...
export default function BinghamDentalCarePatientFeedbackPage() {
  const patientFeedbackFAQs = [
    {
      question:
        "How does Pear Tree Dental compare to traditional practices serving Bingham?",
      answer:
        "Patients often compare Bingham area practices based on convenience, appointment availability, and modern technology. Pear Tree offers advanced facilities, efficient scheduling, and transparent pricing with easy access from the market town.",
    },
    {
      question: "What do patients say about dental access from Bingham?",
      answer:
        "Access and convenience are key concerns for busy Bingham families. Many local practices have limited parking or outdated facilities, while modern practices like Pear Tree Dental offer comprehensive care with convenient access.",
    },
    {
      question: "How do Bingham dental costs compare between practices?",
      answer:
        "Cost transparency varies significantly between practices serving Bingham. Patients appreciate clear pricing upfront, which is why practices with transparent fee structures tend to receive better feedback than those with hidden costs.",
    },
    {
      question:
        "What technology do Bingham patients expect from modern dental practices?",
      answer:
        "Busy Bingham families increasingly expect efficient, modern technology - digital X-rays, intraoral cameras, and same-day treatments. Reviews show patients value practices that save time with advanced equipment.",
    },
    {
      question:
        "How important is appointment flexibility to Bingham dental patients?",
      answer:
        "Very important! Bingham families often juggle work and school schedules, so they value practices that offer flexible scheduling, same-day emergency appointments, and efficient treatment.",
    },
  ];
  ...
  const patientPriorities = [
    {
      ...
      patientFeedback:
        "Busy families need convenient, stress-free dental appointments",
      peartreeAdvantage:
        "Easy access from Bingham with free parking directly outside",
      icon: Car,
    },
    {
      priority: "Efficient Technology",
      description:
        "Modern equipment that saves time for busy market town families",
      patientFeedback:
        "Working families value efficient, time-saving dental technology",
    ...
    },
    {
      ...
      patientFeedback:
        "Market town families need predictable costs for financial planning",
    ...
    },
    {
      ...
      description:
        "Appointment times that work with busy family and work schedules",
      patientFeedback:
        "Rigid scheduling conflicts with work and school commitments",
      peartreeAdvantage:
        "Flexible scheduling with same-day emergency appointments",
      icon: Calendar,
    },
    {
      ...
      patientFeedback:
        "Long waits and inefficient service frustrate working families",
      peartreeAdvantage:
        "Efficient, professional service designed for busy families",
      icon: Shield,
    },
    {
      ...
      patientFeedback:
        "Market town families prefer one practice for all their needs",
  ...
  const commonConcerns = [
    {
      ...
      solution:
        "Choose practices with dedicated, convenient parking facilities",
      peartreeApproach:
        "Free parking directly outside our practice - just 12 minutes from Bingham",
    },
    {
      ...
      peartreeApproach:
        "CEREC same-day crowns and efficient digital technology minimizing family disruption",
    },
    {
      ...
      peartreeApproach:
        "Flexible appointment times and same-day emergency care for busy families",
    },
    {
      ...
      peartreeApproach:
        "Transparent pricing with detailed family treatment plans and no hidden fees",
    },
    {
      ...
      solution:
        "Choose practices that maintain personal relationships with families",
      peartreeApproach:
        "Personal family care maintaining market town values and relationships",
    },
  ];
  ...
  const researchSources = [
    {
      ...
      keyFindings:
        "Efficient modern facilities and family convenience highly valued",
    },
    {
      ...
      keyFindings:
        "Busy families share experiences about efficient, family-friendly care",
    },
    {
      platform: "Healthcare Review Sites",
      insights:
        "Treatment efficiency and family service most important factors",
      sampleSize: "90+ detailed patient reviews across multiple platforms",
      keyFindings:
        "Market town families willing to travel for efficient, modern care",
    },
    {
      platform: "Local Community Forums",
      insights:
        "Family word-of-mouth emphasizes convenience and professional efficiency",
      sampleSize: "30+ discussion threads about Bingham family dental care",
      keyFindings:
        "Family referrals highly influential in market town practice selection",
    },
  ];
  ...
  const practiceComparison = [
    {
      ...
      traditionalPractices:
        "Limited parking, inflexible hours, multiple appointments",
      modernPractices:
        "Convenient access, flexible scheduling, efficient treatment",
    ...
    },
    {
      ...
      traditionalPractices:
        "Basic equipment, multiple appointments, time-consuming",
    ...
    },
    {
      ...
      modernPractices:
        "Family-friendly hours, emergency access, flexible scheduling",
    ...
    },
    {
      ...
      modernPractices:
        "Clear family pricing, upfront estimates, budget planning",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-yellow-500 hover:bg-yellow-400 text-cyan-800 px-8 py-4 text-lg font-semibold rounded-full"
                >
              ...
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-cyan-600 px-8 py-4 text-lg font-semibold rounded-full"
                >
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🔍 Based on comprehensive analysis of Bingham market town
                patient feedback
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                and healthcare platforms to understand what busy Bingham
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Based on our analysis of market town family reviews and
                community discussions, these are the factors that matter most to
                busy Bingham dental patients.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Understanding what challenges busy families helps identify what
                ...
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardContent className="p-6">
                    <div className="grid md:grid-cols-4 gap-4 items-center">
                      ...
                      <div>
                        <h4 className="font-semibold text-cyan-700 text-sm mb-1">
                          Solution:
                        </h4>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Traditional vs Modern Family Practices: What Bingham Patients
                Prefer
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Market town family feedback clearly shows preferences for
                efficient, modern approaches to dental care.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>Clear Family Preference:</strong> Modern dental
                practices consistently receive better feedback for family
                convenience, efficiency, and understanding of busy market town
                life.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our research into Bingham market town
                patient feedback
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Journey: Just 12 minutes with free family parking
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-cyan-50 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-cyan-700 mb-2">
                      Family Convenience
                    </h4>
                    <p className="text-gray-600">
                      Easy access for busy market town families
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Convenient access, efficient technology, family-friendly service,
              and transparent pricing - all just 12 minutes from Bingham market
              town.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Family-efficient care • Free parking • Modern facilities • Quick
                drive from market town
              </p>
            </div>
