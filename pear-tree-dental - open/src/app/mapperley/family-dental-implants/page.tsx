...
export const metadata: Metadata = {
  title:
    "Family Dental Implants in Mapperley - Multi-Generational Tooth Replacement | Pear Tree Dental",
  description:
    "Family dental implants for affluent Mapperley families. Multi-generational tooth replacement, coordinated family care, and premium implant solutions just down the road.",
  keywords: [
  ...
  openGraph: {
    title:
      "Family Dental Implants in Mapperley - Multi-Generational Tooth Replacement | Pear Tree Dental",
    description:
      "Family dental implants for affluent Mapperley families. Multi-generational tooth replacement and coordinated care just down the road.",
...
export default function MapperleyFamilyDentalImplantsPage() {
  const mapperleyImplantsFAQs = [
    {
      ...
      answer:
        "Pear Tree Dental is literally just down the road from Mapperley. We're specialists in coordinated family implant care, treating multiple generations with premium implant solutions and family-focused scheduling.",
    },
    {
      question:
        "Can you coordinate implant treatment for multiple family members?",
      answer:
        "Absolutely! We excel at multi-generational implant planning. From grandparents needing full mouth restoration to parents requiring single implants, we coordinate care, timing, and recovery for optimal family outcomes.",
    },
    {
      question:
        "What makes your implant service special for affluent Mapperley families?",
      answer:
        "We combine premium implant systems, coordinated family care, convenient location, and comprehensive solutions. Our focus on quality, family coordination, and long-term investment aligns with Mapperley families' expectations.",
    },
    {
      question:
        "Do you offer family payment plans for multiple implant treatments?",
      answer:
        "Yes! We understand implant treatment represents a significant family investment. We offer flexible payment plans, family coordination discounts, and comprehensive treatment packages for multiple family members.",
    },
    {
      question:
        "How do you coordinate implant care for different family generations?",
      answer:
        "We plan treatment timing to minimize family disruption, coordinate recovery periods, and ensure each generation receives age-appropriate implant solutions - from young adults to seniors.",
    },
  ];
  ...
  const familyBenefits = [
    {
      ...
      description:
        "Coordinate implant care across different family generations",
  ...
  const generationalNeeds = [
    ...
    },
    {
      ...
      commonCauses:
        "Periodontal disease, failed treatments, multiple tooth loss",
      implantSolutions: [
        "Multiple implants",
        "Implant bridges",
        "Comprehensive care",
    ...
    },
    {
      ...
      commonCauses:
        "Extensive tooth loss, denture problems, eating difficulties",
  ...
  const treatmentTimeline = [
    {
      ...
      description:
        "Comprehensive assessment for all family members needing implants",
      duration: "1-2 hours",
      activities: [
        "CT scans for all patients",
        "Treatment planning",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://peartree.dental/images/family-dental-implants-mapperley.jpg",
            url: "https://peartree.dental/mapperley/family-dental-implants",
            ...
            medicalSpecialty:
              "Family Dental Implants - Multi-Generational Care",
            geo: {
              "@type": "GeoCoordinates",
              latitude: 52.97335,
              longitude: -1.04211,
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🏆 Treating multiple generations with premium implant solutions!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                When multiple family members need dental implants, we excel at
                coordinated care that maximizes outcomes while minimizing
                disruption to your family's lifestyle and commitments.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {(familyBenefits || []).map((benefit, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="text-center hover:shadow-lg transition-shadow border-2 border-emerald-200"
                  >
            ...
            <div className="text-center bg-emerald-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">
                Premium Multi-Generational Care
              </h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley families value quality and
                coordination. Our approach ensures each generation receives
                optimal implant solutions with family-centered planning.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From young professionals to grandparents, we provide the perfect
                implant solution for each family member's age, lifestyle, and
                specific needs.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {(familyImplantTypes || []).map((implant, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-emerald-400 relative"
                  >
                    {implant.highlight && (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each generation has unique implant needs and considerations. We
                tailor our approach to ensure optimal outcomes for every family
                member's life stage and requirements.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                treating multiple family members, minimizing disruption while
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the life-changing implant transformations achieved by
              Mapperley families
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                ...
                coordinated dental implant care
              </p>
            </div>
                ...
                <div className="text-center">
                  <div className="bg-emerald-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      Multi-generational implant coordination
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Invest in Your Family's Oral Health with Premium Dental Implants
              from Mapperley
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Give your family the gift of confident smiles and optimal
              function. Book your coordinated family implant consultation from
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Multi-generational care • Premium systems • Family coordination
                • Just down the road
              </p>
            </div>
