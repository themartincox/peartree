...
export async function GET() {
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          instructions:
            "Please ensure EMAIL_USER and GMAIL_APP_PASSWORD are set correctly in Netlify and redeploy.",
        },
        { status: 500 },
      );
    }
    ...
    console.log(
      "Final Test - Credentials found, attempting to create transporter...",
    );
