...
export const serviceHeroes: Record<string, ServiceHeroConfig> = {
  ...
  "/services/cosmetic": {
    ...
    heroImageAlt:
      "Professional cosmetic dentistry treatment showing beautiful smile transformation",
    badgeText: "Cosmetic Dentistry",
    badgeIcon: "Sparkles",
    title: "Transform Your",
    subtitle: "Smile Today",
    description:
      "Discover the confidence that comes with a perfect smile. Our expert cosmetic treatments use the latest techniques to give you the smile you've always dreamed of.",
    keyBenefits: [
  ...
  "/services/general": {
    ...
    heroImageAlt:
      "Professional dental checkup with friendly dentist and patient",
    badgeText: "General Dentistry",
    badgeIcon: "Stethoscope",
    title: "Complete Oral",
    subtitle: "Healthcare",
    description:
      "Comprehensive dental care for the whole family. From routine checkups to advanced treatments, we keep your smile healthy and beautiful.",
    keyBenefits: [
  ...
  "/services/restorative": {
    ...
    heroImageAlt:
      "Dental restoration procedure showing crown and filling treatments",
    badgeText: "Restorative Dentistry",
    badgeIcon: "Wrench",
    title: "Restore Your",
    subtitle: "Natural Smile",
    description:
      "Advanced restorative treatments to repair, replace, and strengthen your teeth. Get back to eating, speaking, and smiling with confidence.",
    keyBenefits: [
  ...
  "/services/implants": {
    ...
    description:
      "The gold standard for tooth replacement. Our dental implants look, feel, and function just like natural teeth, lasting a lifetime with proper care.",
    keyBenefits: [
  ...
  "/services/orthodontics": {
    ...
    heroVideoType: "mp4",
    heroImageAlt:
      "Clear aligner orthodontic treatment showing straightened teeth",
    badgeText: "Orthodontics",
    badgeIcon: "Smile",
    title: "Straighten Your",
    subtitle: "Smile Discreetly",
    description:
      "Modern orthodontic solutions including Invisalign and ClearCorrect. Achieve perfectly straight teeth without traditional metal braces.",
    keyBenefits: [
  ...
  "/services/hygiene": {
    ...
    description:
      "Expert hygiene therapy to keep your teeth and gums healthy. Professional cleaning, stain removal, and preventive care for optimal oral health.",
    keyBenefits: [
  ...
  "/services/emergency": {
    ...
    description:
      "Same-day emergency dental care when you need it most. From severe toothache to dental trauma, we're here to provide immediate relief.",
    keyBenefits: [
  ...
  "/services/cosmetic/teeth-whitening": {
    ...
    heroImageAlt:
      "Professional teeth whitening treatment showing dramatic results",
    badgeText: "Teeth Whitening",
    badgeIcon: "Sparkles",
    title: "Whiter Teeth",
    subtitle: "In Just 1 Hour",
    description:
      "Professional teeth whitening that's up to 8 shades whiter in a single visit. Safe, effective, and long-lasting results.",
    keyBenefits: [
  ...
  "/services/cosmetic/veneers": {
    ...
    description:
      "Transform your smile with ultra-thin porcelain veneers. Correct gaps, chips, discoloration, and achieve the perfect smile.",
    keyBenefits: [
  ...
  "/services/cosmetic/edge-bonding": {
    ...
    heroImageAlt:
      "Composite bonding procedure showing immediate smile improvement",
    badgeText: "Composite Bonding",
    badgeIcon: "Heart",
    title: "Quick Smile",
    subtitle: "Improvements",
    description:
      "Affordable and immediate solution for chipped, gapped, or discolored teeth. Same-day treatment with natural-looking results.",
    keyBenefits: [
  ...
  "/services/complete-smile-makeover": {
    ...
    heroImageAlt:
      "Complete smile makeover showing dramatic before and after transformation",
    badgeText: "Complete Smile Makeover",
    badgeIcon: "Sparkles",
    title: "Total Smile",
    subtitle: "Transformation",
    description:
      "Comprehensive smile makeover combining multiple treatments for the ultimate smile transformation. Achieve your dream smile with our expert team.",
    keyBenefits: [
  ...
  "/services/cosmetic/wedding-day-smile": {
    ...
    heroImageAlt:
      "Perfect wedding day smile showing radiant bride with beautiful teeth",
    badgeText: "Wedding Day Smile",
    badgeIcon: "Heart",
    title: "Perfect Smile",
    subtitle: "For Your Big Day",
    description:
      "Ensure your smile is picture-perfect for your wedding day. From whitening to complete makeovers, we'll create your dream smile in time for your special moment.",
    keyBenefits: [
...
export function getServiceHeroConfig(route: string): ServiceHeroConfig {
  return (
    serviceHeroes[route] || {
      ...
      heroImageAlt:
        "Pear Tree Dental Centre - Professional dental care in Burton Joyce",
      badgeText: "Dental Services",
      badgeIcon: "Circle",
      title: "Professional",
      subtitle: "Dental Care",
      description:
        "Expert dental treatments in a modern, comfortable environment. Your oral health and beautiful smile are our priority.",
      keyBenefits: [
