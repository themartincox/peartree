...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive smile design for Bingham families. Veneers, crowns, whitening, and smile makeovers. Transform your family\'s smiles with expert cosmetic dentistry.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Transform your family\'s smiles with comprehensive smile design in Bingham. Expert cosmetic dentistry for all ages.',
    ...
    <div className="min-h-screen bg-dental-navy text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Comprehensive smile design and makeover treatments for Bingham families using advanced cosmetic dentistry techniques.",
            "provider": {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Transform your family's smiles with comprehensive smile design and makeovers. Expert cosmetic dentistry
              combining veneers, crowns, whitening, and alignment for beautiful, confident smiles that last a lifetime.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              >
                <Link href="tel:01159312520">
                  ...
                  Book Design Consultation: 0115 931 2520
                </Link>
              </Button>
              <Button
                asChild
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Comprehensive Smile Design for Bingham Families</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                From subtle family enhancements to complete smile transformations, our expert team creates beautiful, natural-looking results for all ages.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20 bg-gradient-to-br from-white to-dental-green/5">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl">Digital Smile Design</CardTitle>
                  <Badge variant="secondary" className="mt-2 bg-dental-green/10 text-dental-green">
                    See Before You Start
                  </Badge>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-dental-green mb-2">From £295</p>
                  <p className="text-gray-600 mb-4">Preview your family's new smiles before treatment begins</p>
              ...
              <Card className="p-6 border border-pear-gold/20 bg-gradient-to-br from-white to-pear-gold/5">
                ...
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-pear-gold mb-2">From £3,995</p>
                  <p className="text-gray-600 mb-4">Comprehensive smile transformation packages</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
              ...
              <Card className="p-6 border border-pear-primary/20 bg-gradient-to-br from-white to-pear-primary/5">
                ...
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-pear-primary mb-2">From £1,595</p>
                  <p className="text-gray-600 mb-4">Gentle improvements for natural enhancement</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Your Family's Smile Design Journey</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A comprehensive, family-friendly process designed to create perfect smiles for everyone
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Comprehensive assessment of each family member's smile goals",
                  icon: Users,
                  time: "75 minutes"
                },
                {
                  ...
                  description: "3D modeling and preview of everyone's new smile options",
                  icon: Camera,
                  time: "60 minutes"
                },
                {
                  ...
                  description: "Coordinated family treatment plans with flexible scheduling",
                  icon: CheckCircle,
                  time: "45 minutes"
                },
                {
                  ...
                  description: "Precise implementation of each personalized smile design",
                  icon: Crown,
                  time: "2-8 visits"
                }
              ].map((step, index) => {
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Family Smile Design Treatment Options</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Multiple treatment approaches suitable for all family members, tailored to individual needs and budgets
              </p>
            </div>
              ...
              {[
                {
                  ...
                  icon: Crown,
                  features: ["Natural appearance", "Stain resistant", "Long-lasting", "Adult suitability"],
                ...
                },
                {
                  ...
                  icon: Palette,
                  features: ["Same-day treatment", "Affordable option", "Reversible", "Teen-friendly"],
                ...
                },
                {
                  ...
                  icon: Sparkles,
                  features: ["Safe for teens", "Immediate results", "Take-home options", "Family packages"],
                  price: "From £295 per person",
                  popular: "Great starting point"
                },
                {
                  title: "Children's Bonding",
                  description: "Gentle cosmetic improvements for young smiles",
                  icon: Baby,
                  features: ["Age-appropriate", "Conservative approach", "Build confidence", "Pain-free"],
                ...
                },
                {
                  ...
                  icon: Eye,
                  features: ["Nearly invisible", "Removable", "Family treatment", "All ages suitable"],
                  price: "From £1,995",
                ...
                },
                {
                  ...
                  icon: Heart,
                  features: ["Regular check-ups", "Touch-up treatments", "Family hygiene", "Preventive care"],
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Expert Family Smile Design from Bingham</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Expert cosmetic dentistry without the city center hassle. Convenient access and family-focused care for Bingham residents of all ages.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Family-Friendly Location</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Just 8 minutes from Bingham with easy parking and family-friendly facilities.
                </p>
              ...
              <Card className="p-6 border border-pear-gold/20">
                ...
                <p className="text-gray-700 mb-4">
                  Experienced cosmetic dentists with expertise in treating all family members, from children to adults.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-primary/20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Flexible Family Scheduling</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Family-friendly appointment times including after school, weekends, and coordinated family sessions.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Bingham Family Smile Transformations</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real stories from Bingham families who've transformed their confidence with smile design
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Join Bingham families who've discovered the confidence that comes with beautifully designed smiles.
              Book your comprehensive family smile design consultation today.
            </p>
