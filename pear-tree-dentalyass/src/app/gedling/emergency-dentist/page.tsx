    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl sm:text-2xl leading-relaxed opacity-90 mb-4">
              Fast Relief for Working Families - Quick Drive from Gedling
            </p>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Emergency Dental Services for Gedling Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                What Gedling Families Say About Our Emergency Care
              </h2>
            </div>

            <TestimonialBanner
              text="When my daughter broke her front tooth at school, I was panicking about fitting an emergency appointment around work. Being just a quick drive from Gedling made all the difference. They saw us the same hour I called, were incredibly gentle with my anxious daughter, and had her tooth fixed beautifully within the hour. The pricing was transparent and fair, and they even gave me flexible payment options. Couldn't have asked for better emergency care!"
              author="Sarah M. from Gedling, NG4"
              className="mb-8"
            />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Gedling working parent's broken tooth repaired same day"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <FAQSection faqs={gedlingEmergencyFAQs} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Emergency Dental Care - Quick Drive from Gedling
            </h2>
