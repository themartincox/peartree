      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-gray-600 text-lg mb-8">
            Compare the annual cost of our plans against paying for treatments individually
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          <Card className="p-6 shadow-md">
            <CardHeader className="px-0 pt-0">
              <CardTitle className="text-xl">Annual Savings Comparison</CardTitle>
            </CardHeader>
                ...
                {plans.map((plan, index) => (
                  <div key={plan.id} className="space-y-2">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-bold text-pear-primary">£{plan.savings} savings</span>
                    </div>
                    <div className="h-8 bg-gray-200 rounded-full overflow-hidden flex">
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: isVisible ? `${(plan.annualCost / maxCost) * 100}%` : '0%' }}
                        transition={{
                          duration: 1,
                          delay: index * 0.2,
                          ease: "easeOut"
                      ...
                      <motion.div
                        initial={{ width: 0 }}
                        animate={{ width: isVisible ? `${(plan.savings / maxCost) * 100}%` : '0%' }}
                        transition={{
                          duration: 1,
                          delay: (index * 0.2) + 0.5,
                          ease: "easeOut"
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-xl font-semibold mb-6">Why Our Plans Save You Money</h3>
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium mb-1">Preventative Care Savings</h4>
                  <p className="text-gray-600 text-sm">
                    Regular check-ups and cleanings help prevent costly treatments down the line,
                    saving you more than just the immediate plan savings.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium mb-1">Predictable Monthly Costs</h4>
                  <p className="text-gray-600 text-sm">
                    Spread the cost of dental care throughout the year with predictable
                    monthly payments rather than unexpected large bills.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h4 className="font-medium mb-1">Emergency Coverage Included</h4>
                  <p className="text-gray-600 text-sm">
                    All plans include worldwide dental accident and emergency coverage, which
                    would otherwise cost significantly more if purchased separately.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Under 18s join free when a parent joins, providing even more family savings
                    compared to paying for individual treatments.
                  </p>
                </div>
              </div>
            </div>
