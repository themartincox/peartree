...
export const metadata: Metadata = {
  ...
  description: "Comprehensive dental check-ups and professional cleaning in Burton Joyce. Prevent problems, maintain oral health. Book your routine appointment today.",
};
...
export default function CheckupsCleaningPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Structured Data */}
      <ServiceStructuredData {...serviceData.checkupsAndCleaning} />
              ...
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-dental-green-100 to-soft-blue-100 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">PREVENTIVE CARE</h3>
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="font-semibold text-xl text-gray-900 mb-2">{item.examination}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {membershipValue.map((plan, index) => (
              <Card key={index} className={`p-6 ${index === 1 ? 'border-2 border-dental-green bg-dental-green-50' : ''}`}>
                <div className="text-center mb-6">
                  <h3 className="font-semibold text-xl text-gray-900 mb-2">{plan.plan}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {ageSpecificCare.map((group, index) => (
              <Card key={index} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="font-semibold text-lg text-gray-900">{group.ageGroup}</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-dental-green-50 p-3 rounded">
