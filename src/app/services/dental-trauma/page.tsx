...
const immediateActions = [
  {
    ...
    actions: [
      ...
      "Call our emergency line: 0115 931 2525"
    ],
    priority: "Critical"
  },
  {
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <WhatsAppButton
                  ...
                  message="URGENT DENTAL TRAUMA: [Describe injury]. Need immediate emergency appointment for dental trauma treatment!"
                  variant="outline"
            ...
            <div className="relative">
              <Card className="overflow-hidden shadow-2xl border-2 border-red-200">
                <div className="aspect-[4/3] bg-gradient-to-br from-red-100 to-orange-100 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">TRAUMA SPECIALIST</h3>
              ...
              {/* Critical time badge */}
              <Card className="absolute -top-4 -left-4 bg-red-600 text-white p-3 shadow-lg animate-pulse">
                <div className="text-center">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    <div className="grid md:grid-cols-3 gap-4">
                      <div>
                        <h3 className="font-semibold text-xl text-gray-900 mb-2">{period.title}</h3>
            ...
            {preventionTips.map((tip, index) => (
              <Card key={index} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="font-semibold text-lg text-gray-900">{tip.activity}</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-red-600 to-red-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <WhatsAppButton
              text="Emergency WhatsApp"
              message="URGENT DENTAL TRAUMA: Need immediate emergency treatment for dental injury. Please help!"
              variant="outline"
