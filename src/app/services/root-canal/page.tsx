...
export const metadata: Metadata = {
  ...
  description: "Expert root canal treatment in Burton Joyce. Save infected teeth with modern, comfortable endodontic therapy. Myths debunked, pain-free treatment available.",
};
...
const afterCareInstructions = [
  ...
  },
  {
    ...
    whatToExpected: "Decreasing discomfort, improved comfort when eating"
  },
  {
...
const warningSignsAfterTreatment = [
  {
    symptom: "Severe or Worsening Pain",
    urgency: "Urgent - Same Day",
    description: "Pain that increases rather than decreases",
    possibleCause: "Incomplete cleaning or additional infection",
    action: "Contact practice immediately for emergency care"
  },
  {
    symptom: "Significant Swelling",
    urgency: "Urgent - Same Day",
    description: "Facial swelling or gum swelling around treated tooth",
    possibleCause: "Infection or inflammatory reaction",
    action: "Emergency appointment needed immediately"
  },
  {
    symptom: "Temporary Filling Loss",
    urgency: "Urgent - Within Days",
    description: "Temporary filling falls out or breaks",
    possibleCause: "Normal wear or hard food damage",
    action: "Schedule repair appointment to prevent reinfection"
  },
  {
    symptom: "Bite Feels High",
    urgency: "Moderate - Within Week",
    description: "Treated tooth hits first when biting",
    possibleCause: "Filling or crown needs adjustment",
    action: "Simple adjustment appointment needed"
  },
  {
    symptom: "Prolonged Sensitivity",
    urgency: "Moderate - Within Week",
    description: "Sensitivity lasting more than a few days",
    possibleCause: "Normal healing or slight inflammation",
    action: "Evaluation to ensure normal healing"
  }
];
...
export default function RootCanalPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Structured Data */}
      <ServiceStructuredData {...serviceData.rootCanal} />
            ...
            <div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-bold text-blue-800">MYTH BUSTER</div>
                    <div className="text-blue-700 text-sm">Root canal treatment RELIEVES pain, doesn't cause it!</div>
                  </div>
                </div>
              </div>
              ...
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-dental-green-100 to-soft-blue-100 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">ROOT CANAL THERAPY</h3>
              ...
              <Card key={index} className="overflow-hidden">
                <CardContent className="p-6">
                  ...
                  <div className="mt-4 p-4 bg-blue-50 rounded border border-blue-200">
                    ...
                    <Badge className="mt-2 bg-blue-600 text-white">{item.truthLevel}</Badge>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {successRates.map((rate, index) => (
              <Card key={index} className="text-center p-6">
                ...
                <h3 className="font-semibold text-lg text-gray-900 mb-3">{rate.timeframe}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {alternativesToExtraction.map((option, index) => (
              <Card key={index} className={`${option.option === 'Root Canal Treatment' ? 'ring-2 ring-dental-green' : ''}`}>
                <CardHeader>
                  <div className="flex justify-between items-start">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-6">
            {warningSignsAfterTreatment.map((warning, index) => (
              <Card key={index} className={`border-l-4 ${
