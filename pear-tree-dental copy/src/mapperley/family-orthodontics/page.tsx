...
export const metadata: Metadata = {
  title: "Family Orthodontics in Mapperley - Affordable Braces for Working Families | Pear Tree Dental",
  description: "Family orthodontics for Mapperley working families. Affordable braces, flexible payment plans, and convenient scheduling. Quality teeth straightening. Quick drive from Mapperley NG3.",
  keywords: [
    "family orthodontics Mapperley",
    "affordable braces Mapperley NG3",
    "cheap braces Mapperley",
    "family braces Mapperley",
    "working families orthodontics Mapperley",
    "teeth straightening Mapperley",
    "invisalign Mapperley"
  ],
  openGraph: {
    title: "Family Orthodontics in Mapperley - Affordable Braces for Working Families | Pear Tree Dental",
    description: "Family orthodontics for Mapperley working families. Affordable braces with flexible payment plans and convenient scheduling.",
...
export default function MapperleyFamilyOrthodonticsPage() {
  const mapperleyOrthoFAQs = [
    {
      question: "How affordable are braces for working families from Mapperley?",
      answer: "We believe quality orthodontics should be accessible to Mapperley working families. Our affordable braces start from £2,200 with flexible payment plans available to spread costs over 24-36 months. We provide transparent pricing and family discounts for multiple children."
    },
    {
      question: "Can multiple family members get braces at the same time?",
      answer: "Absolutely! Many Mapperley working families choose to start orthodontic treatment for multiple children together. We offer family discounts and can coordinate appointments to save time and travel. Payment plans can cover the whole family treatment."
    },
    {
      question: "How do you fit orthodontic appointments around work schedules?",
      answer: "We understand working families in Mapperley have busy schedules. We offer early morning, evening, and Saturday appointments for orthodontic care. Regular adjustment appointments are typically quick (15-20 minutes) and can often be scheduled during lunch breaks."
    },
    {
      question: "What's the difference between affordable and expensive braces?",
      answer: "Our affordable braces use quality materials and proven techniques, just with simpler brackets and fewer aesthetic options. More expensive options offer faster treatment or near-invisible appearance. We explain all options honestly so Mapperley families can choose what fits their budget."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Quality braces from £2,200 with payment plans
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">👨‍👩‍👧‍👦 Affordable family orthodontics with payment plans for Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Family Orthodontics for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Mapperley working families want quality orthodontic treatment that fits their
            ...
            <div className="text-center bg-purple-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We believe every Mapperley family deserves access to quality orthodontic care. Our affordable options
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Affordable Orthodontic Options for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Age-Appropriate Orthodontics for Every Mapperley Family Member
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Making Orthodontics Affordable for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Family Orthodontic Results for Mapperley Families
            </h2>
            <p className="text-lg text-gray-600">
              See the amazing transformations achieved by Mapperley working families with our affordable orthodontic treatment
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley working family's transformation with payment plan"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Family Orthodontic Questions from Mapperley Families
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working families about affordable family orthodontic treatment
              </p>
            </div>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Affordable Family Orthodontics - Quick Drive from Mapperley
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Give Your Family the Gift of Straight Teeth from Mapperley
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Affordable braces • Payment plans available • Family discounts • Quick drive from Mapperley
              </p>
            </div>
