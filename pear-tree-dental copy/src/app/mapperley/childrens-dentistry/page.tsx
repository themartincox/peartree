...
export const metadata: Metadata = {
  title: "Children's Dentistry in Mapperley - Convenient Care for Working Parents | Pear Tree Dental",
  description: "Children's dentistry for Mapperley working families. Convenient appointments, gentle care, and prevention focus. Child-friendly environment. Quick drive from Mapperley NG3.",
  keywords: [
    "children's dentistry Mapperley",
    "kids dentist Mapperley NG3",
    "child dental care Mapperley",
    "family dentist Mapperley",
    "working parents dentist Mapperley",
    "convenient children dentist Mapperley",
    "child dental check ups Mapperley"
  ],
  openGraph: {
    title: "Children's Dentistry in Mapperley - Convenient Care for Working Parents | Pear Tree Dental",
    description: "Children's dentistry for Mapperley working families. Convenient appointments and gentle, child-friendly care.",
...
export default function MapperleyChildrensDentistryPage() {
  const mapperleyChildrensFAQs = [
    {
      question: "How convenient is children's dental care from Mapperley for working parents?",
      answer: "We understand working parents in Mapperley have packed schedules. We offer early morning, after-school, and Saturday appointments for children. Being just a quick drive from Mapperley, we can often fit urgent appointments into busy work schedules."
    },
    {
      question: "What age should children start visiting the dentist?",
      answer: "We recommend children visit by their first birthday or within 6 months of their first tooth appearing. Early visits help children become comfortable with dental care and allow us to monitor development and provide preventive guidance to Mapperley parents."
    },
    {
      question: "How do you help anxious children feel comfortable?",
      answer: "Our gentle, child-friendly approach includes explaining procedures in age-appropriate language, using distraction techniques, and allowing children to see and touch instruments. We work at the child's pace and praise positive behavior to build confidence."
    },
    {
      question: "What preventive care do you offer children from Mapperley?",
      answer: "We provide comprehensive preventive care including fluoride applications, dental sealants, oral hygiene instruction, and dietary advice. Our focus on prevention helps Mapperley working families avoid costly problems and emergency dental visits."
    },
    {
      question: "How do you coordinate appointments for working family schedules?",
      answer: "We can often schedule multiple children together or coordinate with parent appointments to save time. We offer flexible scheduling including school holiday appointments and can provide appointment reminders to help busy Mapperley families stay organized."
    }
  ];
  ...
  const workingParentsBenefits = [
    {
      ...
      description: "Early morning, after-school, and weekend appointments available",
    ...
    },
    {
      ...
      description: "Emphasis on preventing problems that could cause urgent visits",
      value: "Fewer emergency situations",
      icon: Shield
    },
    {
      benefit: "Family Coordination",
      description: "Can schedule multiple children or coordinate with parent visits",
  ...
  const ageAppropriateServices = [
    {
      ...
      focusAreas: "Gentle introduction, development monitoring, habit counseling",
      keyServices: ["First dental visit", "Oral health guidance", "Feeding advice", "Thumbsucking guidance"],
      parentBenefits: "Early prevention saves money and prevents future problems",
      typicalFrequency: "Every 6 months once teeth appear"
    },
    {
      ageGroup: "Preschoolers (3-5 years)",
      focusAreas: "Building confidence, cavity prevention, oral hygiene training",
      keyServices: ["Gentle cleaning", "Fluoride application", "Oral hygiene education", "Early orthodontic screening"],
      parentBenefits: "Establishes good habits and prevents school dental problems",
      typicalFrequency: "Every 6 months"
    },
    {
      ageGroup: "School Age (6-12 years)",
      focusAreas: "Permanent tooth care, sealant protection, orthodontic monitoring",
      keyServices: ["Dental sealants", "Comprehensive cleaning", "Cavity treatment", "Development tracking"],
      parentBenefits: "Protects new permanent teeth during critical development",
      typicalFrequency: "Every 6 months, more if high risk"
    },
    {
      ageGroup: "Teenagers (13-18 years)",
      focusAreas: "Independence building, wisdom tooth monitoring, cosmetic concerns",
      keyServices: ["Comprehensive care", "Wisdom tooth assessment", "Orthodontic consultation", "Sports mouthguards"],
      parentBenefits: "Builds responsibility while maintaining oral health through critical years",
  ...
  const preventionStrategies = [
    {
      ...
      longTermValue: "Children with early dental visits have fewer cavities throughout childhood"
    },
    {
      ...
      longTermValue: "Saves hundreds of pounds in future filling and crown costs"
    },
    {
      strategy: "Fluoride Application",
      approach: "Professional fluoride treatments to strengthen developing teeth",
    ...
    },
    {
      ...
      longTermValue: "Earlier intervention often means simpler, less expensive treatment"
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "medicalSpecialty": "Pediatric Dentistry - Child-Friendly Dental Care",
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": 52.97335,
              "longitude": -1.04211
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Gentle, child-friendly care with flexible scheduling
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">👶 Gentle, convenient children's dental care for busy Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Convenient Children's Dental Care for Mapperley Working Parents
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that working parents in Mapperley need children's dental care that fits busy schedules.
                Our child-friendly approach and flexible appointment times make quality pediatric dental care achievable.
              </p>
            </div>
            ...
            <div className="text-center bg-green-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Child-Friendly Care Built for Busy Families</h3>
              <p className="text-lg text-gray-600 mb-6">
                We know that Mapperley working parents need children's dental care that's convenient, gentle, and effective.
                Our child-friendly environment and flexible scheduling ensure positive dental experiences for the whole family.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">After-school times</div>
                  <p className="text-gray-600">Convenient 3:30pm+ appointments</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600 mb-2">Gentle approach</div>
                  <p className="text-gray-600">Child-friendly, anxiety-free care</p>
                </div>
                <div className="text-center">
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Comprehensive Children's Dental Services for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From first dental visits to teenage care, we provide gentle, age-appropriate
                dental services that help children develop healthy teeth and positive attitudes toward dental care.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each stage of childhood has different dental needs and considerations.
                Our age-specific approach ensures optimal care for children at every development stage.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="grid md:grid-cols-3 gap-6">
                      <div>
                        ...
                        <p className="text-gray-600 text-sm mb-3">{group.focusAreas}</p>
                        <div className="bg-green-50 rounded-lg p-3">
                          <h4 className="font-semibold text-green-700 text-sm mb-1">Visit Frequency:</h4>
                          <p className="text-sm text-green-700">{group.typicalFrequency}</p>
                        </div>
                      </div>
                      ...
                      <div>
                        <h4 className="font-semibold text-green-600 text-sm mb-2">Parent Benefits:</h4>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Convenient Features for Mapperley Working Parents
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our children's dental practice is designed around the needs of working families,
                providing convenient, efficient, and comprehensive pediatric dental care.
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Prevention-Focused Strategies for Mapperley Children
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our prevention-focused approach helps Mapperley working families avoid
                costly dental problems and emergency visits that disrupt busy schedules.
              </p>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="space-y-3">
                          ...
                          <div>
                            <h4 className="font-semibold text-green-600 text-sm mb-1">Immediate Benefit:</h4>
                            <p className="text-sm text-gray-700">{strategy.benefit}</p>
                          </div>
                          <div className="bg-green-50 rounded-lg p-3">
                            <h4 className="font-semibold text-green-700 text-sm mb-1">Long-Term Value:</h4>
                            <p className="text-sm text-green-700">{strategy.longTermValue}</p>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                What Mapperley Parents Say About Our Children's Dental Care
              </h2>
            </div>

            <TestimonialBanner
              text="As working parents with two young children, finding convenient dental care seemed impossible until we found Pear Tree Dental. Being just a quick drive from Mapperley has been a lifesaver. They offer 4pm appointments which is perfect after school pickup, and the team is incredible with the kids. My daughter used to cry at dentist visits, but now she actually looks forward to going! They've done sealants for both kids and really focus on prevention. The scheduling is so flexible - they even saw us on a Saturday when our son had a dental emergency. Perfect for busy working families!"
              author="Jenny and Paul M. from Mapperley, NG3"
              className="mb-8"
            />

            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-green-600 mb-2">4pm appointments</div>
                <p className="text-gray-600">Perfect after-school timing</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-green-600 mb-2">Child-friendly</div>
                <p className="text-gray-600">Kids actually look forward to visits</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-green-600 mb-2">Saturday emergency</div>
                <p className="text-gray-600">Flexible when families need it most</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Children's Dental Care Results for Mapperley Families
            </h2>
            <p className="text-lg text-gray-600">
              See how our gentle, prevention-focused approach keeps Mapperley children healthy and smiling
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley child's transformation through preventive dental care"
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Children's Dental Questions from Mapperley Parents
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working parents about convenient children's dental care
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Convenient Children's Dental Care - Quick Drive from Mapperley
            </h2>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-green-50 rounded-lg p-6">
                    <Baby className="w-12 h-12 text-green-600 mx-auto mb-4" />
                    <h4 className="font-bold text-green-700 mb-2">Children's Dental Care</h4>
                    <p className="text-gray-600">Gentle, convenient care for all ages</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Give Your Children the Best Start with Convenient Dental Care from Mapperley
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Don't let busy schedules prevent your children from getting quality dental care.
              Book convenient, child-friendly appointments that work around work and school commitments.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Gentle, child-friendly care • Flexible scheduling • Prevention focus • Quick drive from Mapperley
              </p>
            </div>
