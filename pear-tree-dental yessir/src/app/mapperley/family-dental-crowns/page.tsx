...
export const metadata: Metadata = {
  title: "Family Dental Crowns in Mapperley - Age-Appropriate Restorations | Pear Tree Dental",
  description: "Family dental crowns for affluent Mapperley families. Age-appropriate crown solutions, premium materials, and coordinated family care just down the road from Mapperley.",
  keywords: [
  ...
  openGraph: {
    title: "Family Dental Crowns in Mapperley - Age-Appropriate Restorations | Pear Tree Dental",
    description: "Family dental crowns for affluent Mapperley families. Age-appropriate crown solutions and premium materials just down the road.",
  ...
  const mapperleyCrownsFAQs = [
    {
      ...
      answer: "Pear Tree Dental is literally just down the road from Mapperley. We're specialists in family crown treatments, providing age-appropriate solutions with premium materials and coordinated care for all family members."
    },
    {
      question: "What crown options work best for different family members?",
      answer: "We offer ceramic crowns for aesthetic areas, gold crowns for durability, and age-appropriate options. Children might need stainless steel crowns, teens prefer ceramic, adults choose between ceramic and gold, and seniors focus on comfort and function."
    },
    {
      question: "Can you coordinate crown treatments for multiple family members?",
      answer: "Absolutely! We excel at family coordination, scheduling multiple crown appointments, managing different treatment timelines, and ensuring everyone's needs are met efficiently and effectively."
    },
    {
      question: "What makes your crown service special for affluent Mapperley families?",
      answer: "We combine premium crown materials, same-day CEREC technology, expert craftsmanship, family coordination, and convenient location. Our focus on quality and excellence aligns with Mapperley families' expectations."
    },
    {
      question: "Do you offer same-day crowns for busy Mapperley families?",
      answer: "Yes! Our CEREC same-day crown technology means many crowns can be completed in a single visit, perfect for busy Mapperley families who value efficiency and convenience."
    }
  ];
  ...
  const crownTypes = [
    {
      ...
      benefits: ["Indistinguishable from natural teeth", "Stain resistant", "Biocompatible", "Long-lasting"],
    ...
    },
    {
      ...
      benefits: ["Exceptional durability", "Kind to opposing teeth", "Precise fit", "Time-tested"],
    ...
    },
    {
      ...
      benefits: ["Same-day completion", "Perfect digital fit", "No temporary crown", "Convenient"],
    ...
    },
    {
      ...
      benefits: ["Gentle procedures", "Durable materials", "Tooth-colored options", "Child-appropriate"],
  ...
  const familyBenefits = [
    {
      ...
      description: "Crown options tailored to each family member's age and needs",
  ...
  const generationalNeeds = [
    {
      ...
      crownOptions: ["Stainless steel crowns", "Tooth-colored pediatric crowns", "Space maintainers"],
      considerations: ["Gentle procedures", "Quick appointments", "Future tooth development", "Parent comfort"],
    ...
    },
    {
      ...
      crownOptions: ["Ceramic crowns for aesthetics", "Gold for back teeth", "Same-day CEREC"],
      considerations: ["Aesthetic concerns", "School schedules", "Sports activities", "Social confidence"],
    ...
    },
    {
      ...
      crownOptions: ["Premium ceramic", "Gold crowns", "Same-day CEREC", "Full mouth rehabilitation"],
      considerations: ["Professional appearance", "Time constraints", "Long-term investment", "Family coordination"],
    ...
    },
    {
      ...
      crownOptions: ["Comfortable ceramic", "Durable gold", "Implant crowns", "Full rehabilitation"],
      considerations: ["Comfort priority", "Eating function", "Speech clarity", "Health considerations"],
  ...
  const crownTechnologies = [
    {
      ...
      description: "Computer-aided design and manufacturing for precise, immediate results",
      advantages: ["Complete in one visit", "Perfect digital fit", "No impressions needed", "Immediate function"],
      familyBenefit: "Perfect for busy Mapperley families"
    },
    {
      technology: "Digital Impressions",
      description: "Comfortable, accurate digital scans replace messy impressions",
      advantages: ["More comfortable", "Highly accurate", "Faster process", "Better patient experience"],
    ...
    },
    {
      ...
      advantages: ["See before treatment", "Perfect aesthetic planning", "Predictable results", "Patient confidence"],
    ...
    },
    {
      ...
      advantages: ["Superior durability", "Natural appearance", "Biocompatible", "Long-lasting"],
  ...
  const treatmentProcess = [
    {
      ...
      description: "Comprehensive assessment for all family members needing crowns",
      duration: "60-90 minutes",
      activities: ["Digital scans", "Treatment planning", "Material selection", "Scheduling coordination"]
    },
    {
      step: "Preparation",
      description: "Gentle tooth preparation with comfort-focused techniques",
      duration: "45-60 minutes per crown",
      activities: ["Local anesthesia", "Tooth reshaping", "Digital impressions", "Temporary placement"]
    },
    {
      step: "Fabrication",
      description: "Expert laboratory crafting or same-day CEREC creation",
      duration: "Same day or 1-2 weeks",
      activities: ["Precise manufacturing", "Color matching", "Quality testing", "Final adjustments"]
    },
    {
      step: "Placement",
      description: "Careful crown placement and bite adjustment",
      duration: "30-45 minutes",
      activities: ["Crown fitting", "Bite adjustment", "Final polishing", "Care instructions"]
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/family-dental-crowns-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/family-dental-crowns",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Family Dental Crowns in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Just down the road from Mapperley — Premium crowns & same-day options
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">👑 Premium crown solutions for every family member!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Affluent Mapperley families appreciate quality craftsmanship and precision. Our family crown
                approach ensures each member receives the perfect restoration for their age, lifestyle, and aesthetic needs.
              </p>
            </div>
            ...
            <div className="text-center bg-amber-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Premium Family Crown Solutions</h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley families value quality, precision, and efficiency. Our crown
                solutions combine the finest materials with expert craftsmanship and family-focused coordination.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-600 mb-2">Premium materials</div>
                  <p className="text-gray-600">Ceramic, gold, and advanced options</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-600 mb-2">Same-day options</div>
                  <p className="text-gray-600">CEREC technology available</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-amber-600 mb-2">Down the road</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From children's protective crowns to adults' aesthetic restorations, we provide
                the perfect crown solution for each family member's unique needs and preferences.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {crownTypes.map((crown, index) => {
                ...
                return (
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-amber-400 relative">
                    {crown.highlight && (
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                        <Badge className="bg-amber-600 text-white">{crown.highlight}</Badge>
                      </div>
                    )}
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-lg text-pear-primary">{crown.crownType}</CardTitle>
                    ...
                    <CardContent className="space-y-4">
                      <div className="text-center">
                        ...
                        <div className="flex flex-col gap-1 mb-2">
                          <Badge variant="outline" className="text-xs">{crown.bestFor}</Badge>
                          <span className="text-xs text-gray-600">{crown.durability}</span>
                        </div>
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each generation has unique crown requirements based on age, lifestyle, and dental needs.
                We customize our approach to ensure optimal outcomes for every family member.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="text-center mb-4">
                        ...
                        <p className="text-gray-600 text-sm">{group.commonNeeds}</p>
                      </div>

                      <div className="space-y-3">
                        <div>
                          <h4 className="font-semibold text-amber-600 text-sm mb-1">Crown Options:</h4>
                        ...
                        <div>
                          <h4 className="font-semibold text-amber-600 text-sm mb-1">Considerations:</h4>
                          <ul className="space-y-1">
                            {group.considerations.map((consideration, idx) => (
                              <li key={idx} className="text-xs text-gray-600 flex items-center gap-1">
                        ...
                        <div className="bg-amber-50 rounded-lg p-3">
                          <p className="text-sm text-amber-700 font-medium">{group.specialFeatures}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We invest in cutting-edge technology to provide Mapperley families with the most
                precise, comfortable, and efficient crown treatments available.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="bg-amber-50 rounded-lg p-3">
                          <p className="text-sm text-amber-700 font-medium">{tech.familyBenefit}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                members, minimizing appointments while maximizing comfort and results.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-amber-600 mb-2">Premium quality</div>
                <p className="text-gray-600">Ceramic, gold, and advanced materials</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-amber-600 mb-2">Same-day options</div>
                <p className="text-gray-600">CEREC technology available</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-amber-600 mb-2">Family coordination</div>
                <p className="text-gray-600">Multiple treatments scheduled efficiently</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the beautiful crown transformations achieved by affluent Mapperley families
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from affluent Mapperley families about family dental crown treatments
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-amber-50 rounded-lg p-6">
                    <Crown className="w-12 h-12 text-amber-600 mx-auto mb-4" />
                    <h4 className="font-bold text-amber-700 mb-2">Premium Crown Care</h4>
                    <p className="text-gray-600">Age-appropriate family crown solutions</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Restore Your Family's Smiles with Premium Dental Crowns from Mapperley
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Give your family the gift of beautiful, functional smiles with premium crown solutions.
              Book your family crown consultation from Mapperley with age-appropriate options and expert care.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Premium materials • Same-day options • Age-appropriate solutions • Just down the road
              </p>
            </div>
