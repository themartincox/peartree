...
const encryptedSortCode = 'REPLACE_WITH_ENCRYPTED_SORT_CODE'; // e.g., 'iv:authTag:encrypted'
const encryptedAccountNumber = 'REPLACE_WITH_ENCRYPTED_ACCOUNT_NUMBER'; // e.g., 'iv:authTag:encrypted'
