...
export const metadata: Metadata = {
  title: "Dental Veneers | Ultra-Thin, Porcelain & Composite Options | Pear Tree Dental",
  description: "Transform your smile with dental veneers in Burton Joyce. Choose from ultra-thin contact lens, traditional porcelain, or same-day composite veneers. Expert cosmetic dentistry.",
  keywords: [
  ...
  openGraph: {
    ...
    type: "website",
    url: "https://peartreedental.co.uk/veneers"
  }
};
  ...
  const veneerTypes = [
    {
      ...
      description: "The most conservative approach to smile transformation with minimal tooth preparation required",
      price: "From £450",
      duration: "2-3 visits",
    ...
    },
    {
      ...
      description: "Premium porcelain veneers offering superior durability and comprehensive smile transformations",
      price: "From £650",
      duration: "2-3 visits",
    ...
    },
    {
      ...
      description: "Affordable, immediate smile enhancement completed in a single appointment",
      price: "From £180",
      duration: "Same day",
      lifespan: "5-7 years",
      color: "dental-green",
  ...
  const commonBenefits = [
    {
      ...
      description: "Transform your smile and boost your self-confidence with natural-looking results"
    },
    {
      icon: Shield,
      title: "Stain Resistant",
      description: "Maintain your bright, white smile with materials that resist everyday staining"
    },
    {
      icon: Heart,
      title: "Natural Appearance",
      description: "Custom-designed to complement your facial features and look completely natural"
    },
    {
      icon: Target,
      title: "Precise Fit",
      description: "Each veneer is carefully crafted for perfect fit, comfort, and optimal function"
    }
  ];
  ...
  const treatmentProcess = [
    {
      ...
      description: "Comprehensive evaluation of your smile goals and oral health to determine the best veneer option for you"
    },
    {
      step: 2,
      title: "Treatment Planning",
      description: "Digital smile design and treatment planning with preview of your expected results"
    },
    {
      step: 3,
      title: "Preparation & Fabrication",
      description: "Tooth preparation (if needed) and custom veneer creation using advanced materials and techniques"
    },
    {
      step: 4,
      title: "Placement & Finishing",
      description: "Precise placement, bonding, and final adjustments for perfect fit and beautiful results"
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "The best veneer type depends on your specific needs, budget, and goals. Ultra-thin veneers are ideal for minor corrections with minimal preparation, porcelain veneers offer maximum durability for major transformations, and composite veneers provide immediate, affordable results. We'll assess your situation during consultation to recommend the best option."
    },
    {
      question: "How long do veneers last?",
      answer: "Lifespan varies by type: composite veneers last 5-7 years, ultra-thin veneers last 10-15 years, and traditional porcelain veneers can last 10-20 years with proper care. Regular dental visits and good oral hygiene help maximize their longevity."
    },
    {
      question: "Are veneers painful to get?",
      answer: "Most patients experience minimal discomfort during veneer placement. Local anesthesia is used when tooth preparation is needed. Ultra-thin and composite veneers often require little to no anesthesia due to minimal preparation required."
    },
    {
      question: "Can veneers be whitened?",
      answer: "Veneers don't respond to traditional whitening treatments. However, they're designed to resist staining and maintain their color. If you want whiter veneers, new ones would need to be made in a lighter shade."
    },
    {
      question: "How much do veneers cost?",
      answer: "Costs vary by type: composite veneers from £180, ultra-thin veneers from £450, and porcelain veneers from £650 per tooth. We offer financing options and will provide a detailed cost estimate during your consultation."
    }
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Discover the perfect veneer solution for your smile. Choose from ultra-thin contact lens veneers, traditional porcelain, or same-day composite options.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Each veneer type offers unique advantages. Find the perfect match for your smile goals, budget, and timeline.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-12">
            {veneerTypes.map((veneer, index) => {
              ...
              return (
                <Card key={veneer.id} className={`relative overflow-hidden hover:shadow-xl transition-shadow duration-300 ${index === 1 ? 'scale-105 border-2 border-pear-gold' : ''}`}>
                  {veneer.badge && (
                    <Badge className={`absolute top-4 right-4 ${veneer.color === 'pear-gold' ? 'bg-pear-gold text-white' : veneer.color === 'soft-pink' ? 'bg-soft-pink text-pear-primary' : 'bg-dental-green text-white'}`}>
                      {veneer.badge}
                    </Badge>
                  )}

                  <CardHeader className="text-center pb-4">
                    <div className={`w-16 h-16 rounded-full ${colorClasses[veneer.color as keyof typeof colorClasses]} flex items-center justify-center mx-auto mb-4`}>
                      <IconComponent className="w-8 h-8 text-white" />
                    </div>
                    <CardTitle className="text-xl font-bold text-pear-primary">{veneer.name}</CardTitle>
                    <CardDescription className="text-sm font-medium text-gray-500">{veneer.tagline}</CardDescription>
                  </CardHeader>

                  <CardContent className="space-y-6">
                    <p className="text-gray-600 text-center">{veneer.description}</p>

                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="font-semibold text-pear-primary">{veneer.price}</div>
                        <div className="text-xs text-gray-500">per tooth</div>
                      </div>
                      <div>
                        <div className="font-semibold text-pear-primary">{veneer.duration}</div>
                        <div className="text-xs text-gray-500">treatment</div>
                      </div>
                      <div>
                        <div className="font-semibold text-pear-primary">{veneer.lifespan}</div>
                        <div className="text-xs text-gray-500">lifespan</div>
                      </div>
                    </div>

                    <div>
                      <h4 className="font-semibold text-pear-primary mb-3">Key Features:</h4>
                    ...
                    <div>
                      <h4 className="font-semibold text-pear-primary mb-3">Ideal For:</h4>
                      <ul className="space-y-2">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Side-by-side comparison to help you make the best choice for your smile
            </p>
          </div>
            ...
            <table className="w-full border-collapse bg-white rounded-lg shadow-lg overflow-hidden">
              <thead>
                <tr className="bg-pear-primary text-white">
                  ...
                  <th className="text-center p-4 font-semibold bg-soft-pink/20">Ultra-Thin</th>
                  <th className="text-center p-4 font-semibold bg-pear-gold/20">Porcelain</th>
                  <th className="text-center p-4 font-semibold bg-dental-green/20">Composite</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr className="hover:bg-gray-50">
                  ...
                  <td className="p-4 text-center text-sm">Conservative corrections</td>
                  <td className="p-4 text-center text-sm">Major transformations</td>
                  <td className="p-4 text-center text-sm">Immediate, budget-friendly</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-pear-primary to-dental-green text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Book a consultation to discover which veneer option is perfect for your smile goals and budget
          </p>
