...
export const metadata: Metadata = {
  title: 'Dentist in Gedling NG4 - Pear Tree Dental | Your Next-Door Dental Team',
  description:
    'Pear Tree Dental is the closest private dentist to Gedling — just minutes away in Burton Joyce. Flexible membership plans, same-day appointments, and modern family dentistry for Gedling residents.',
  keywords: [
    'dentist Gedling',
    ...
    'private dentist Gedling',
    'family dentist Gedling'
  ],
  openGraph: {
    title: 'Dentist in Gedling NG4 - Pear Tree Dental | Your Next-Door Dental Team',
    description:
      'Modern private dentistry for Gedling residents just across the border in Burton Joyce. Membership plans from £10.95/month and rapid access for local families.',
...
export default function GedlingPage() {
  return (
    <div className="min-h-screen bg-dental-navy text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Modern dental practice serving Gedling residents with comprehensive dental care and membership plans just moments away in Burton Joyce.",
            "address": {
              "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              Your Next-Door Dentist
              <span className="text-pear-gold block">Moments from Gedling</span>
            </h1>

            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Gedling residents come to Pear Tree Dental because we are the very next suburb along —
              a fast, traffic-light free hop to Burton Joyce. Enjoy full-service private dentistry,
              flexible payment plans, and same-day support without travelling into Nottingham city.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">Typical drive from Gedling Village to our Burton Joyce practice</p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-dental-green mb-2">3.4 miles</p>
                  <p className="text-gray-600">Follow A612 straight from Gedling to Burton Joyce</p>
                </CardContent>
              </Card>
      ...
      {/* Why Gedling neighbours choose us */}
      <section className="py-16 bg-dental-navy/80 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Why Gedling neighbours choose Pear Tree Dental</h2>
              <p className="text-lg text-gray-200 max-w-3xl mx-auto">
                Living next door to Burton Joyce means Gedling residents can enjoy the calm of a village
                practice without compromising on technology, expertise, or availability.
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[{
                title: 'Next-suburb convenience',
                description: 'Beat city traffic and parking queues. Our practice is on the same A612 corridor Gedling residents use daily.'
              },
              {
                title: 'Same-day response',
                description: 'Emergency slots are held for local NG4 patients. Call before 10am and we will always try to see you the same day.'
              },
              {
                title: 'Family-friendly plans',
                description: 'Bundle check-ups, hygiene visits, and children's care with membership from £10.95/month and save on every visit.'
              },
              {
                title: 'Hospital-grade tech',
                description: 'Digital scanners, microscopes, and 3D planning normally reserved for city clinics — available minutes from home.'
              }].map((item, index) => (
            ...
            <div className="mt-12 max-w-4xl mx-auto">
              <TestimonialBanner
                text="We moved from a city centre dentist to Pear Tree because it's literally next door to Gedling. Parking is easy, appointments run on time and the team feel like neighbours."
                author="Rachel • Gedling Village"
              />
            </div>
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <h3 className="font-semibold mb-4 text-dental-green">Quick Route (7 minutes)</h3>
                  <ol className="space-y-2 text-gray-700">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Leave Gedling via Arnold Lane and join the A612 toward Burton Joyce</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Stay on the A612 for 3 miles — no roundabouts or traffic lights</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      ...
                      <span>As you enter Burton Joyce, pass the riverside shops and continue straight</span>
                    </li>
                    <li className="flex items-start space-x-2">
                      ...
                      <span>Turn right onto Main Street — Pear Tree Dental is 150 metres on your left</span>
                    </li>
                  </ol>
                  <div className="mt-4 p-3 bg-dental-green/10 rounded">
                    <p className="text-sm text-dental-navy">
                      <strong>Tip:</strong> Most Gedling families arrive in under 7 minutes — it's the same road you take to Carlton or Colwick each day.
                    </p>
                  </div>
                </div>
              </div>
