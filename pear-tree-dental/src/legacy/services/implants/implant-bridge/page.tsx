...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Replace multiple teeth with implant-supported bridge in Burton Joyce",
    type: "website",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Cost-effective solution using 2-4 implants to support multiple connected crowns.
              Strong, stable, and natural-looking replacement for adjacent missing teeth.
            </p>
