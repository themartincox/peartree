...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Digital Smile Design - Preview Your Perfect Smile | Pear Tree Dental",
    description: "See your perfect smile before treatment begins with our advanced digital smile design technology",
    type: "website",
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-600 leading-relaxed mb-8">
                  Discover what your dream smile could look like with our revolutionary digital smile design technology.
                  See your transformation before any treatment begins – completely FREE.
                </p>
              </div>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-4 shadow-lg border border-pear-gold/20">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-semibold text-pear-primary">See Before You Decide</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our comprehensive consultation gives you everything you need to make an informed decision about your smile
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "High-resolution photos and 3D scanning to capture every detail of your current smile",
                value: "Worth £50"
              },
              {
                icon: Eye,
                title: "Virtual Smile Preview",
                description: "See exactly how your new smile will look using advanced digital design technology",
                value: "Worth £75"
              },
              {
                icon: Crown,
              ...
              },
              {
                ...
                description: "60 minutes with our experienced cosmetic dentist discussing your goals",
                value: "Included"
              },
              {
                icon: Zap,
                title: "Instant Results",
                description: "Walk away with your smile design on the same day - no waiting required",
                value: "Included"
              },
              {
                icon: Heart,
              ...
              return (
                <Card key={index} className="p-6 border-2 border-pear-gold/20 hover:border-pear-gold/40 transition-colors">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h3 className="font-bold text-lg text-pear-primary mb-2">{item.title}</h3>
                      <p className="text-gray-600 text-sm mb-3">{item.description}</p>
                      <Badge variant="outline" className="border-pear-gold text-pear-gold">
                        {item.value}
                      </Badge>
                    </div>
                  </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-pear-gold/10 to-pear-gold/5 rounded-2xl p-8 max-w-2xl mx-auto border border-pear-gold/20">
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Total Value: £150</h3>
              <p className="text-lg text-pear-gold font-semibold mb-4">Your Price: FREE</p>
              <p className="text-gray-600">Limited time offer - book your consultation today</p>
            </div>
          </div>
        </div>
      </section>
                ...
                {[
                  {
                    ...
                    description: "High-resolution images capture every detail of your current smile from multiple angles."
                  },
                  {
                    step: "2",
                    title: "3D Smile Modeling",
                    description: "Advanced software creates a precise 3D model of your teeth and facial structure."
                  },
                  {
                    step: "3",
                    title: "Design & Preview",
                    description: "We digitally design your new smile and show you the transformation instantly."
                  },
                  {
                    step: "4",
                    title: "Treatment Planning",
            ...
            <div className="relative">
              <Card className="overflow-hidden shadow-xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                  <div className="text-center">
                    <h3 className="text-lg font-bold text-gray-700 mb-2">DIGITAL TECHNOLOGY IMAGE</h3>
                    <p className="text-gray-600">Computer screen showing smile design software</p>
                  </div>
                </div>
              </Card>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              During your consultation, we'll discuss which treatments could give you your perfect smile
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              {
                title: "Invisalign",
                description: "Invisible aligners that straighten teeth discreetly",
              ...
              },
              {
                ...
                description: "Tooth-colored resin to reshape and perfect teeth",
                timeframe: "1 visit",
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-gray-700">{treatment.timeframe}</span>
                    </div>
                    <div className="text-pear-gold font-semibold">{treatment.price}</div>
                  </div>
                </div>
              </Card>
            ))}
            ...
            {[
              {
                ...
                quote: "The digital preview showed me exactly what to expect. My new smile exceeded even those expectations!",
                result: "6 veneers, confidence transformed"
              },
              {
                name: "James T.",
                treatment: "Invisalign",
                quote: "Seeing my future smile before starting treatment gave me the confidence to go ahead. Best decision ever.",
              ...
              <Card key={index} className="p-6 bg-white shadow-lg">
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="font-semibold text-pear-primary">{story.name}</div>
                    <div className="text-sm text-gray-600">{story.treatment}</div>
                    <div className="text-sm text-pear-gold font-medium mt-1">{story.result}</div>
                  </div>
                </div>
              </Card>
            ))}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-white/90">
              Book your FREE smile design consultation today. No obligations, no pressure –
              just discover what's possible for your smile.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              ...
              <Button size="lg" variant="outline" className="border-white text-pear-gold hover:bg-white hover:text-pear-gold">
                <Phone className="w-5 h-5 mr-2" />
                Call 0115 931 2935
              </Button>
            </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-pear-primary mb-4">Frequently Asked Questions</h2>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  answer: "The consultation takes approximately 60 minutes. This includes digital photography, smile analysis, design preview, and discussion of your treatment options."
                },
                {
                  question: "Will I see results on the same day?",
                  answer: "Yes! We'll show you a digital preview of your potential new smile during your appointment. You'll walk away with images showing exactly how different treatments could transform your smile."
                },
                {
                  question: "Am I obligated to have treatment?",
                  answer: "Not at all. This is a no-obligation consultation designed to help you understand your options. You're free to take time to consider or seek other opinions."
                },
                {
