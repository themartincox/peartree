          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="inline-flex items-center bg-dental-teal border border-dental-teal rounded-full px-6 py-3">
                ...
                <span className="text-sm font-semibold text-white">Over 1,000 successful denture fittings</span>
              </div>
          ...
          <Card className="bg-gradient-to-r from-amber-500 to-orange-500 text-white overflow-hidden">
            <CardContent className="p-12 text-center relative">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                ...
                <Button size="lg" variant="outline" className="border-white text-amber-600 hover:bg-white hover:text-amber-600">
                  Call 0115 931 2935
                </Button>
              </div>
