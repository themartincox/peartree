          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative group">
              <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl">
                <picture>
                  <source media="(min-width: 768px)" srcSet="/images/heroes/restorative/neers.webp" type="image/webp" />
                  <source media="(min-width: 480px)" srcSet="/images/heroes/restorative/veneers.webp" type="image/webp" />
                  <source srcSet="/images/heroes/restorative/demo-veneers.png" type="image/webp" />
                  <img
