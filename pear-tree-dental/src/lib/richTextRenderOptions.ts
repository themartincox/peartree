...
export const richTextRenderOptions: Options = {
  renderMark: {
    [MARKS.BOLD]: (text) => React.createElement('strong', null, text),
    [MARKS.ITALIC]: (text) => React.createElement('em', null, text),
  ...
  renderNode: {
    ...
    [BLOCKS.EMBEDDED_ASSET]: (node) => {
      ...
      return React.createElement('figure', { className: "my-6" }, [
