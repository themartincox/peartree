...
export const metadata: Metadata = {
  title: "Family Preventive Care in Mapperley - Long-Term Health Focus for Working Families | Pear Tree Dental",
  description: "Family preventive care for Mapperley working families. Long-term dental health focus, family health plans, and convenient preventive services. Quick drive from Mapperley NG3.",
  keywords: [
    "family preventive care Mapperley",
    "preventive dentistry Mapperley NG3",
    "family dental health Mapperley",
    "long term dental care Mapperley",
    "working families preventive dentist Mapperley",
    "family health plans Mapperley",
    "comprehensive preventive care Mapperley"
  ],
  openGraph: {
    title: "Family Preventive Care in Mapperley - Long-Term Health Focus for Working Families | Pear Tree Dental",
    description: "Family preventive care for Mapperley working families. Long-term dental health focus with convenient family health plans.",
    url: "https://peartree.dental/mapperley/family-preventive-care"
  },
  alternates: {
    canonical: "https://peartree.dental/mapperley/family-preventive-care"
  }
};

export default function MapperleyFamilyPreventiveCare() {
  const mapperleyPreventiveFAQs = [
    {
      question: "How does preventive care save money for working families from Mapperley?",
      answer: "Preventive care is the most cost-effective approach to dental health. Regular check-ups and cleanings prevent expensive problems like root canals, crowns, and extractions. For a typical Mapperley family, preventive care costs around £400-600 annually but can prevent thousands in future treatment costs."
    },
    {
    ...
    },
    {
      ...
      answer: "We offer flexible scheduling including early morning, evening, and weekend appointments. We can coordinate multiple family members' appointments together and provide reminder systems. Being just a quick drive from Mapperley makes regular visits manageable even with busy work schedules."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "name": "Pear Tree Dental - Family Preventive Care in Mapperley",
            "image": "https://peartree.dental/images/family-preventive-care-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/family-preventive-care",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Family Preventive Care in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Comprehensive family health plans from £400 annually
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">💚 Long-term family health investment with convenient care for Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Long-Term Family Health Investment for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Mapperley working families need dental care that focuses on long-term health and
            ...
            <div className="text-center bg-green-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley working families make careful decisions about health investments.
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Comprehensive Preventive Services for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Age-Specific Preventive Care for Every Mapperley Family Member
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Prevention Investment Returns for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Comprehensive Family Health Strategies for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                What Mapperley Families Say About Our Long-Term Health Focus
              </h2>
            </div>

            <TestimonialBanner
              text="We started bringing our whole family to Pear Tree Dental three years ago when we moved to Mapperley. Being just a quick drive away made it easy to keep up with everyone's check-ups. What I love most is how they focus on prevention - they caught early signs of gum disease in my husband and helped our daughter avoid cavities with sealants. Over three years, we've spent about £1,800 on preventive care for our family of four, but we haven't had a single emergency or major treatment needed. Compare that to our previous experience where we were constantly dealing with problems and spending thousands on treatments. The investment in prevention has been incredible for our family's health and our budget!"
              author="Susan and Mark F. from Mapperley, NG3"
              className="mb-8"
            />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Long-Term Family Health Results for Mapperley Families
            </h2>
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley working family's health maintained through preventive care"
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Family Preventive Care Questions from Mapperley Families
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working families about long-term family health investment
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Long-Term Family Health Care - Quick Drive from Mapperley
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Invest in Your Family's Long-Term Health from Mapperley Today
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Long-term focus • Family coordination • Cost-effective care • Quick drive from Mapperley
              </p>
            </div>
