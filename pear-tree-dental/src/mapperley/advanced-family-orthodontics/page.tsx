...
export const metadata: Metadata = {
  title: "Advanced Family Orthodontics in Mapperley - Specialist Bite Correction | Pear Tree Dental",
  description: "Advanced family orthodontics for Mapperley households. Complex bite correction, aligners, and specialist appliances minutes from home in Burton Joyce.",
  keywords: [
