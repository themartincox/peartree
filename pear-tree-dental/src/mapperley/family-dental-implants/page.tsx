...
export const metadata: Metadata = {
  ...
  description: "Family dental implants for Mapperley working families. Practical tooth replacement solutions, flexible payment plans, and family-focused care. Quick drive from Mapperley NG3.",
  keywords: [
    "family dental implants Mapperley",
    "dental implants Mapperley NG3",
    "tooth replacement Mapperley",
    "affordable implants Mapperley",
    "working families dental implants Mapperley",
    "family tooth replacement Mapperley",
    "practical dental implants Mapperley"
  ],
  openGraph: {
    title: "Family Dental Implants in Mapperley - Practical Tooth Replacement for Working Families | Pear Tree Dental",
    description: "Family dental implants for Mapperley working families. Practical tooth replacement solutions with flexible payment plans.",
...
export default function MapperleyFamilyDentalImplantsPage() {
  const mapperleyImplantsFAQs = [
    {
      question: "How practical are dental implants for working families from Mapperley?",
      answer: "Dental implants are actually very practical for working families. While the initial investment is higher, they last 20-30 years and don't require special maintenance like dentures. We offer flexible payment plans from £150/month to make implants accessible to Mapperley working families."
    },
    {
    ...
    {
      question: "What's the time commitment for implant treatment from Mapperley?",
      answer: "Initial consultation and implant placement typically takes 1-2 hours. The implant heals for 3-6 months, then the crown is fitted in another 1-hour appointment. Being just a quick drive from Mapperley makes these appointments very manageable."
    },
    {
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Mapperley — Permanent tooth replacement from £2,400 with payment plans
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">🦷 Practical, long-lasting tooth replacement with payment plans for Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Practical Dental Implants for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Mapperley working families need tooth replacement solutions that offer excellent
            ...
            <div className="text-center bg-blue-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley working families make careful decisions about major investments.
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Family Dental Implant Solutions for Mapperley Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                helps Mapperley families make informed decisions about tooth replacement.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                Mapperley working families choose the most practical tooth replacement solution.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                ...
                of convenience, longevity, and functionality for busy Mapperley families.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Smart Investment Strategies for Mapperley Working Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Family Dental Implant Results for Mapperley Families
            </h2>
            <p className="text-lg text-gray-600">
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Mapperley working professional's implant transformation"
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
                Family Dental Implant Questions from Mapperley Families
              </h2>
              <p className="text-lg text-gray-600">
                Common questions from Mapperley working families about practical dental implant solutions
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Practical Dental Implants - Quick Drive from Mapperley
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Invest in Permanent Tooth Replacement That Works for Your Family from Mapperley
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Practical solutions • Payment plans available • 20-30 year lifespan • Quick drive from Mapperley
              </p>
            </div>
