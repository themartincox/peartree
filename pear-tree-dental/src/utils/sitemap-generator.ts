...
const ROUTE_CONFIGS: RouteConfig[] = [
  ...
  {
    pattern: "/arnold/emergency-dentist",
    priority: 0.95,
    changefreq: "weekly",
  },

  // Arnold Level 2 pages
  { pattern: "/arnold/porcelain-veneers", priority: 0.9, changefreq: "weekly" },
  {
    pattern: "/arnold/complete-smile-makeover",
    priority: 0.9,
    changefreq: "weekly",
  },
  { pattern: "/arnold/dentures", priority: 0.9, changefreq: "weekly" },
  { pattern: "/arnold/composite-bonding", priority: 0.9, changefreq: "weekly" },

  // Arnold Level 3 pages
  { pattern: "/arnold/dental-crowns", priority: 0.85, changefreq: "weekly" },
  {
    pattern: "/arnold/root-canal-treatment",
    priority: 0.85,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/mapperley/emergency-dentist",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/childrens-dentistry",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/family-orthodontics",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/teeth-whitening",
    priority: 0.95,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/mapperley/family-dental-implants",
    priority: 0.9,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/childrens-preventive-care",
    priority: 0.9,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/family-dental-crowns",
    priority: 0.9,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/teen-cosmetic-dentistry",
    priority: 0.9,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/mapperley/family-smile-makeovers",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/advanced-family-orthodontics",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/family-cosmetic-surgery",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/mapperley/multi-generational-rehabilitation",
    priority: 0.85,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/gedling/emergency-dentist",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/family-dentistry",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/affordable-teeth-whitening",
    priority: 0.95,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/nhs-private-dentistry",
    priority: 0.95,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/gedling/family-orthodontics",
    priority: 0.9,
    changefreq: "weekly",
  },
  { pattern: "/gedling/dental-crowns", priority: 0.9, changefreq: "weekly" },
  {
    pattern: "/gedling/childrens-dentistry",
    priority: 0.9,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/composite-bonding",
    priority: 0.9,
    changefreq: "weekly",
  },
  ...
  {
    pattern: "/gedling/family-dental-implants",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/complete-smile-makeovers",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/family-preventive-care",
    priority: 0.85,
    changefreq: "weekly",
  },
  {
    pattern: "/gedling/flexible-payment-dentistry",
    priority: 0.85,
    changefreq: "weekly",
  },
...
export async function updateSitemapIfChanged(
  ...
  try {
    ...
    const existingNormalized = existingSitemapContent
      ? normalizeXML(existingSitemapContent)
      : "";
