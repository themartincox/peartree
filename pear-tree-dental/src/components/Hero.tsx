      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 lg:pt-36 pb-8 sm:pb-12 lg:pb-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-end">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-4 sm:p-6 lg:p-8 border border-pear-primary/10 min-h-[100px] sm:h-32 flex items-center space-x-4 sm:space-x-6">
          ...
          <div className="relative mt-8 lg:mt-0 hero-image-container">
            {/* Main Hero Image */}
