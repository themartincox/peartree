...
const membershipPlans = {
  planA: {
    ...
    savings: "116",
    description:
      "Our most affordable plan with essential dental care and comprehensive coverage.",
    keyFeatures: [
  ...
  child: {
    ...
    savings: "180",
    description:
      "Specialised dental care for children under 18. FREE when joining with an adult plan.",
    keyFeatures: [
  ...
  family: {
    ...
    savings: "400+",
    description:
      "Complete coverage for 2 adults and up to 3 children with significant family savings.",
    keyFeatures: [
      ...
      <CardContent className="p-8">
        <div className="text-center mb-6">
          ...
          <h3 className="text-2xl font-bold text-pear-primary mb-2">
            Why Nottingham Patients Love Our Membership
          </h3>
          <p className="text-gray-600">
            Exclusive advantages that make the 15-minute journey from Nottingham
            well worth it
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Save £15+ per visit compared to city centre practices
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              6pm slots available for city workers
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Immediate appointments vs 6+ month NHS waits
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600">
              Same dentist every visit, not corporate rotation
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-dental-green p-6 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <div className="text-2xl font-bold text-dental-green mb-1">
                £180
              </div>
              <div className="text-sm text-gray-600">Parking savings</div>
              <div className="text-xs text-gray-500 mt-1">
                12 visits × £15 city center parking
              </div>
            </div>
            <div>
              <div className="text-2xl font-bold text-dental-green mb-1">
        ...
        <div className="bg-gradient-to-r from-pear-gold to-dental-green rounded-lg p-6 border border-pear-gold">
          <div className="flex items-start space-x-4">
            ...
            <div>
              <h5 className="font-semibold text-pear-primary mb-2">
                Why Nottingham Patients Make the Switch
              </h5>
              <ul className="text-sm text-gray-700 space-y-1">
                <li>• Avoid city center traffic and parking stress</li>
                <li>
                  • 15-minute journey vs 45+ minutes to central Nottingham
                  practices
                </li>
                <li>• Personal care vs corporate dental chains</li>
                <li>
                  • Same-day emergency appointments vs NHS emergency queues
                </li>
...
//    Handle plan selection with tracking
  const handlePlanSelect = (planKey: string) => {
    ...
    trackMembershipPlanSelect(
      plan.name,
      Number.parseFloat(plan.price.replace("£", "")),
    );
  };
      ...
      return (
        <button
          ...
          className={`w-full text-left p-3 sm:p-4 rounded-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-pear-primary ${
            isActive
              ? key === "planA"
                ? "bg-white text-dental-green shadow-lg transform scale-105"
                : key === "child"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            Predictable monthly costs, free child coverage, and worldwide
            protection.
          </p>
        </div>
              ...
              <div className="space-y-6 sm:space-y-8">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                  <div className="flex items-center space-x-3 sm:space-x-4">
                    ...
                    <div>
                      <h3 className="text-2xl sm:text-3xl font-bold text-pear-primary">
                        {currentPlan.name}
                      </h3>
                      <div className="flex items-baseline space-x-2">
                        <span className="text-3xl sm:text-4xl font-bold text-pear-primary">
                          {currentPlan.price}
                        </span>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="items-center">
                      ...
                      <p className="text-gray-600 text-sm">
                        Save up to £400+ per year compared to pay-as-you-go
                        treatments
                      </p>
                    </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                  ...
                  >
                    <Link href="/membership#plans">Compare All Plans</Link>
                  </Button>
                </div>
              </div>
            </div>
        ...
        <div className="text-center">
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Join thousands of satisfied patients who've made the switch from NHS
            waiting lists to immediate dental care..
          </p>
