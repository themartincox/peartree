        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h3 className="font-semibold text-blue-800 mb-2">Originator's Identification Number</h3>
            ...
            {/* Instructions */}
            <div>
              <h3 className="font-semibold text-lg mb-3">Instructions to your Bank or Building Society</h3>
              <p className="text-gray-700 leading-relaxed">
                Please pay Membership Plans Limited Direct Debits from account detailed in this instruction
                subject to the safeguards assumed by the Direct Debit Guarantee. I understand that this
                instruction may remain with Membership Plans Limited and, if so, details will be passed
            ...
            {/* DD15 Guarantee */}
            <div>
              <h3 className="font-semibold text-lg mb-4 text-blue-800">DD15 The Direct Debit Guarantee</h3>
              <ul className="space-y-4 text-gray-700">
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                  <span>
                    If there are any changes to the amount, date or frequency of your Direct Debit, Membership Plans Limited
                    will notify you 10 working days in advance of your account being debited or as otherwise agreed. If you
                    request Membership Plans Limited to collect a payment, confirmation of the amount and date will be given
                    at the time of the request.
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                  <span>
                    If an error is made in the payment of your Direct Debit by Membership Plans Limited or your Bank or
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    ...
                    Written confirmation may be required. Please notify us.
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <p className="text-sm text-gray-600">
                Membership Plans Ltd trading as Lloyd & Whyte Flexiplan is registered in England No 06322047. <br />
                Registered Office: Affinity House, Bindon Road, Taunton, TA2 6AA.
              </p>
            </div>
          </div>
        </CardContent>
