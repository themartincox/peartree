        ...
        <div className="relative z-10 h-full flex flex-col">
          ...
          <CardContent>
            <div className="space-y-4 sm:space-y-6">
              ...
              <div
                className={`space-y-2 ${isExpanded ? "block" : "hidden sm:block"}`}
              >
  ...
  const services: Service[] = [
    {
      ...
      description:
        "Comprehensive dental care for your daily life. Preventive treatments and routine care to keep your smile healthy.",
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Transform your smile with our aesthetic treatments. Professional whitening and smile makeovers.",
      icon: Sparkles,
    ...
    },
    {
      ...
      description:
        "Repair and restore your teeth to optimal health and function with modern techniques. Be proud of your smile again.",
      icon: ShieldCheck,
      theme: "medical" as const,
    ...
    },
    {
      ...
      description:
        "Permanent tooth replacement solutions that look, feel, and function like natural teeth. We can find the right outcomes for you.",
      icon: Zap,
      theme: "cosmetic" as const,
      treatments: [
        "Single Implants",
    ...
    },
    {
      ...
      title: "Orthodontics",
      description:
        "Straighten your teeth discreetly with modern clear aligner technology. Choose from the market leading options.",
      icon: Smile,
      theme: "cosmetic" as const,
      treatments: [
        "Invisalign",
    ...
    },
    {
      ...
      description:
        "Urgent dental care when you need it most. Same-day appointments available for dental emergencies.",
      icon: AlertTriangle,
      theme: "medical" as const,
      treatments: [
        "Dental Pain Relief",
    ...
    <>
      ...
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          ...
          complete dental care using the latest technology and techniques. All
          treatments available with our membership plans.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-8">
        ...
        {[services[1], services[0], services[2]].map(
