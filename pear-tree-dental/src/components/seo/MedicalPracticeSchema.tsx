...
export default function MedicalPracticeSchema({
  ...
  const medicalPracticeSchema = {
    ...
    "description": "Comprehensive medical dental practice serving Nottinghamshire with specialized dental care, emergency services, and advanced treatment options.",
    ...
    "availableService": [
      ...
      },
      {
        ...
        "preparation": "Digital smile design and comprehensive treatment planning",
