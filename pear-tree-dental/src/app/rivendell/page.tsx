    ...
    <div className="min-h-screen bg-dental-navy text-white">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-pear-gold font-medium">Welcome to Rivendell</span>
            </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className={`flex items-center space-x-3 p-3 rounded-lg ${
                        ...
                        <span className={`${item.highlight ? 'font-semibold text-pear-gold' : 'text-gray-700'}`}>
                          {item.task}
                        </span>
                        {item.highlight && (
              ...
              <div className="space-y-6">
                <Card className="p-6 border border-dental-green/20">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2">Just 6 Minutes Away</h3>
                      <p className="text-gray-700 mb-2">
                        Quick and easy journey from Rivendell to our Burton Joyce practice
                      </p>
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Family Dental Care for Rivendell Residents</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">What Your Rivendell Neighbors Say</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Hear from fellow Rivendell families about their dental care experience
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-dental-green/10 to-pear-gold/5 rounded-2xl p-8 max-w-2xl mx-auto">
                ...
                <p className="text-gray-700 font-semibold">Based on 25+ reviews from Rivendell families</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-8">Easy Journey from Rivendell</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
              ...
              <div>
                <h2 className="text-3xl font-bold mb-8">Quick Route from Rivendell</h2>
