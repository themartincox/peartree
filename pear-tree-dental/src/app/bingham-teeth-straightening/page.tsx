...
export const metadata: Metadata = {
  title:
    "Teeth Straightening Bingham - Invisalign & Clear Aligners | Pear Tree Dental",
  description:
    "Family teeth straightening in Bingham. Invisalign, clear aligners, and orthodontics for children and adults. Gentle, effective treatment just 8 minutes from Bingham.",
  keywords: [
  ...
  openGraph: {
    title:
      "Family Teeth Straightening in Bingham - Invisalign & Clear Aligners",
    description:
      "Gentle teeth straightening for Bingham families. Modern orthodontics with invisible aligners for all ages.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Family teeth straightening treatments including Invisalign and clear aligners for Bingham residents of all ages.",
            provider: {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Gentle teeth straightening for the whole family with Invisalign
              and clear aligners. Perfect for children, teens, and adults in
              Bingham who want straighter teeth without traditional braces.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Modern Teeth Straightening for Bingham Families
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Choose from our range of gentle orthodontic treatments designed
                for all ages, from children to adults in Bingham.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 border border-dental-green/20 bg-gradient-to-br from-white to-dental-green/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Gentle treatment for growing smiles
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
              ...
              <Card className="p-6 border border-pear-primary/20 bg-gradient-to-br from-white to-pear-primary/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Fast correction for minor alignment issues
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-8">
                  Why Bingham Families Choose Clear Aligners
                </h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Clear aligners are nearly invisible, allowing children
                        and adults to straighten their teeth discreetly without
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        cleaning. Perfect for active Bingham families with busy
                        schedules.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Modern aligner technology provides gentle, controlled
                        movement that's comfortable for patients of all ages,
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Your Family's Teeth Straightening Journey
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A simple, family-friendly process designed to fit around busy
                Bingham family life
              </p>
            </div>
                ...
                [
                  {
                    ...
                    description:
                      "Assessment for all family members considering treatment",
                    icon: Users,
                    time: "45 minutes",
                  },
                  {
                    ...
                    description:
                      "3D scans to create personalized treatment plans",
                    icon: Sparkles,
                    time: "30 minutes",
                  },
                  {
                    ...
                    description:
                      "Receive your custom aligners with full instructions",
                    icon: CheckCircle,
                    time: "20 minutes",
                  },
                  {
                    ...
                    description:
                      "Regular family-friendly check-ups to monitor progress",
                    icon: Award,
                    time: "15 minutes",
                  },
                ] || []
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Convenient Family Treatment from Bingham
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Family orthodontic care without the hassle. Easy A52 access and
                flexible scheduling for busy Bingham families.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <p className="text-gray-700 mb-4">
                  Just 8 minutes from Bingham with free parking and easy
                  countryside route perfect for family visits.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-gold/20">
                ...
                <p className="text-gray-700 mb-4">
                  Flexible appointments including after school, weekends, and
              ...
              <Card className="p-6 border border-pear-primary/20">
                ...
                <p className="text-gray-700 mb-4">
                  Experienced orthodontic team with expertise in treating
                  patients of all ages in a family-friendly environment.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Join Bingham families who've chosen gentle, effective clear
              aligners for straighter smiles. Book your family consultation and
              discover modern orthodontics.
            </p>
