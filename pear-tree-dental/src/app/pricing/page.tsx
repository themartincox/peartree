...
export const metadata: Metadata = {
  ...
  description:
    "Transparent dental pricing in Burton Joyce. View our competitive treatment costs, membership plans, and payment options. No hidden fees, clear pricing.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Transparent dental pricing with competitive treatment costs and flexible payment options",
    type: "website",
...
export default function PricingPage() {
  ...
  const formattedRestorativeTreatments = restorativeTreatments.map(
    (treatment) => ({
      name: treatment.name,
      price: treatment.price,
    }),
  ...
  const formattedOrthodonticTreatments = orthodonticTreatments.map(
    (treatment) => ({
      name: treatment.name,
      price: treatment.price,
    }),
      ...
      <section className="bg-gradient-to-br from-pear-background via-white to-pear-background py-16 sm:py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <Badge className="mb-4 sm:mb-6 bg-pear-gold text-white">
              Transparent Pricing
            </Badge>
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-6 sm:mb-8">
              No hidden fees, no surprises. Our transparent pricing helps you
              make informed decisions about your dental care with confidence.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join our membership plan for significant savings and priority
              access to appointments
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {(membershipPlans || []).map((plan, _index) => (
              <Card
                key={plan.name}
                className={`relative ${plan.popular ? "border-2 border-pear-gold" : ""}`}
              >
                {plan.popular && (
                ...
                <CardHeader className="text-center">
                  ...
                  <div className="text-3xl font-bold text-pear-gold">
                    {plan.price}
                  </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Competitive pricing for all dental treatments with flexible
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {(formattedGeneralTreatments || []).map(
                    (treatment, index) => (
                      <div
                        key={index}
                      ...
                      >
                        ...
                        <span className="font-semibold text-pear-primary">
                          {treatment.price}
                        </span>
                      </div>
                    ),
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {(formattedCosmeticTreatments || []).map(
                    (treatment, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0"
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {(formattedRestorativeTreatments || []).map(
                    (treatment, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0"
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {(formattedImplantTreatments || []).map(
                    (treatment, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center py-2 border-b border-gray-100 last:border-0"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We offer various payment methods to make dental care affordable
              for everyone
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600">
                  Spread the cost of treatment with our flexible payment plans
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600">
                  We accept most dental insurance plans and can help with claims
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                ...
                <p className="text-sm text-gray-600">
                  Save 10% on treatments with our membership plans
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/book">
              <Button
                size="lg"
                className="bg-white text-pear-primary hover:bg-gray-100 font-semibold"
              >
                <CalendarDays className="w-5 h-5 mr-2" />
                Book Consultation
              </Button>
            ...
            <a href="tel:01159312935">
              <Button
                size="lg"
                variant="outline"
                className="border-white text-white hover:bg-white hover:text-pear-primary font-semibold bg-transparent"
              >
                <Phone className="w-5 h-5 mr-2" />
                Call 0115 931 2935
              </Button>
