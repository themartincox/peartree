...
export const metadata: Metadata = {
  title:
    "Our Practice | Pear Tree Dental - State-of-the-Art Dental Facilities in Burton Joyce",
  description:
    "Discover our modern dental practice in Burton Joyce, Nottingham. State-of-the-art facilities, advanced technology, and a patient-centered approach to dental care.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "State-of-the-art dental facilities with a patient-centered approach in Burton Joyce, Nottingham.",
    type: "website",
...
const facilities = [
  {
    ...
    description:
      "Hospital-grade sterilisation protocols ensuring the highest levels of safety and hygiene for all patients.",
  },
  {
    icon: Sparkles,
    title: "Digital Technology",
    description:
      "Latest digital imaging, intraoral cameras, and CAD/CAM technology for precise diagnosis and treatment.",
  },
  {
    icon: Heart,
    title: "Patient Comfort",
    description:
      "Comfortable treatment rooms with modern amenities designed to reduce anxiety and enhance your experience.",
  },
  {
    icon: Award,
    title: "Quality Standards",
    description:
      "Accredited practice maintaining the highest standards of care with regular quality assessments and training.",
  },
];
...
const amenities = [
  ...
  },
  {
    ...
    title: "Free WiFi",
    description:
      "Complimentary wireless internet access throughout the practice",
  },
  {
    icon: Clock,
...
const values = [
  {
    ...
    description:
      "Every treatment plan is tailored to your individual needs, preferences, and budget. We believe in involving you in every decision about your oral health.",
    icon: "🎯",
  },
  {
    title: "Continuous Learning",
    description:
      "Our team regularly attends training courses and conferences to stay updated with the latest techniques and technologies in dentistry.",
    icon: "📚",
  },
  {
    title: "Preventive Approach",
    description:
      "We focus on preventing dental problems before they occur, helping you maintain optimal oral health for life.",
    icon: "🛡️",
  },
  {
    title: "Transparent Communication",
    description:
      "We explain all treatment options clearly, including costs, so you can make informed decisions about your dental care.",
    icon: "💬",
  },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-lg leading-relaxed opacity-80 max-w-3xl mx-auto">
              Located in the heart of Burton Joyce, our practice combines
              cutting-edge dental technology with a warm, welcoming environment
              to provide exceptional dental care for the whole family.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="heading-serif text-xl font-semibold mb-2 text-gray-800">
                      Address
                    </h3>
                  ...
                  <div>
                    ...
                    <div className="space-y-1 text-gray-600">
                      ...
                      <p className="text-sm text-pear-primary mt-2">
                      ...
                      <div className="aspect-video bg-gradient-to-br from-green-100 via-blue-50 to-green-50 relative overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm rounded-lg px-3 py-2 shadow-lg border border-gray-200">
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-medium text-pear-primary">
                              View on Google Maps
                            </span>
                          </div>
                        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our practice is equipped with the latest technology and designed
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We've designed our practice to make your visit as comfortable and
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              ...
              our patients receive the most effective, comfortable, and precise
              treatments available. From digital X-rays that reduce radiation
              exposure to CAD/CAM technology for same-day crowns, we're
              committed to staying at the forefront of dental innovation.
            </p>
            <div className="grid sm:grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-pear-primary mb-2">
                  25+
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your appointment today and discover the difference that
              advanced technology and personalized care can make to your dental
              health
            </p>
