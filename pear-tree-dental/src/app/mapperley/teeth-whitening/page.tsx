...
export const metadata: Metadata = {
  title: "Family Teeth Whitening in Mapperley - Safe Whitening for All Ages | Pear Tree Dental",
  description: "Family teeth whitening for Mapperley families. Safe whitening for teens and adults, family packages, and gentle treatments just 15 minutes away. Transform your family's smiles.",
  keywords: [
  ...
  openGraph: {
    title: "Family Teeth Whitening in Mapperley - Safe Whitening for All Ages | Pear Tree Dental",
    description: "Family teeth whitening for Mapperley families. Safe whitening for teens and adults with family packages just 15 minutes away.",
  ...
  const mapperleyWhiteningFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Mapperley via the A6097. We're family whitening specialists providing safe, effective treatments for teens, parents, and the whole family."
    },
    {
      question: "Is teeth whitening safe for teenagers from Mapperley?",
      answer: "Yes! We offer age-appropriate whitening for teens 16+ with fully developed teeth. Our gentle methods are perfectly safe and specially designed for younger patients."
    },
    {
      question: "Can families get whitening treatments together?",
      answer: "Absolutely! We love treating families together. Family whitening packages, coordinated appointments, and bulk discounts make it affordable for multiple family members."
    },
    {
      question: "What whitening options work best for Mapperley families?",
      answer: "We offer professional in-chair whitening, take-home kits, and combination treatments. Each family member gets the best option for their lifestyle, sensitivity, and desired results."
    },
    {
      question: "What makes your whitening service special for Mapperley families?",
      answer: "We combine family-safe formulations, age-appropriate treatments, family packages, convenient Mapperley access, and gentle techniques perfect for all family members."
    }
  ];
  ...
  const whiteningOptions = [
    {
      ...
      features: ["1-hour appointment", "Immediate results", "Professional strength", "Custom protection"],
    ...
    },
    {
      ...
      features: ["Custom-fitted trays", "Professional gel", "Gradual whitening", "Family supervision"],
    ...
    },
    {
      ...
      features: ["Age-appropriate strength", "Extra sensitivity care", "Parental guidance", "Gradual approach"],
    ...
    },
    {
      ...
      features: ["Best of both methods", "Long-lasting results", "Family coordination", "Maximum value"],
  ...
  const familyBenefits = [
    {
      ...
      description: "Special pricing when multiple family members whiten together",
    ...
    },
    {
      ...
      description: "Age-appropriate whitening for teenagers with parental approval",
  ...
  const familyConsiderations = [
    {
      ...
      whiteningTips: ["Avoid staining foods", "Use whitening toothpaste", "Regular dental checkups"],
      bestOptions: ["Teen-safe whitening", "Take-home kits with supervision"],
      icon: GraduationCap
    },
    {
      ageGroup: "Young Adults (18-30)",
      considerations: "Lifestyle factors like coffee, wine, smoking affect results",
      whiteningTips: ["Minimize staining habits", "Use a straw for drinks", "Rinse after eating"],
      bestOptions: ["Professional in-chair", "Combination treatments"],
      icon: Coffee
    },
    {
      ageGroup: "Parents (30-50)",
      considerations: "Busy schedules need convenient options, may have sensitivity",
      whiteningTips: ["Take-home convenience", "Gradual improvement", "Manage sensitivity"],
      bestOptions: ["Take-home kits", "Family combination packages"],
      icon: Users
    },
    {
      ageGroup: "Older Adults (50+)",
      considerations: "May have more sensitivity, dental work affects whitening",
      whiteningTips: ["Professional assessment first", "Gentle formulations", "Realistic expectations"],
      bestOptions: ["Professional consultation", "Custom sensitivity management"],
      icon: Heart
    }
  ];
  ...
  const whiteningTips = [
    {
      ...
      tips: ["Professional dental cleaning", "Address any sensitivity", "Remove surface stains", "Set realistic expectations"],
      icon: Target
    },
    {
      category: "During Treatment",
      tips: ["Follow instructions carefully", "Use custom trays properly", "Monitor sensitivity levels", "Maintain oral hygiene"],
      icon: Shield
    },
    {
      category: "After Whitening",
      tips: ["Avoid staining foods 48 hours", "Use whitening toothpaste", "Regular dental visits", "Touch-up as needed"],
      icon: Sparkles
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/family-teeth-whitening-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/teeth-whitening",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Family Teeth Whitening in <span className="text-white">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Only 15 mins from Mapperley — Family packages & teen-safe options
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book">
                <Button size="lg" className="bg-white hover:bg-gray-100 text-orange-600 px-8 py-4 text-lg font-semibold rounded-full">
                  <Sparkles className="w-5 h-5 mr-2" />
                  Book Family Whitening
                </Button>
              </Link>
              <a href="tel:01159312935">
                <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-orange-600 px-8 py-4 text-lg font-semibold rounded-full">
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">✨ Safe whitening for the whole family - teens to grandparents!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                When families whiten together, everyone benefits from coordinated care,
                special pricing, and shared motivation for maintaining beautiful smiles.
              </p>
            </div>
                ...
                return (
                  <Card key={index} className="text-center hover:shadow-lg transition-shadow border-2 border-yellow-200">
                    <CardContent className="p-6">
                      ...
                      <Badge className="bg-yellow-100 text-yellow-700">{benefit.savings}</Badge>
                    </CardContent>
                  </Card>
                );
              })}
            ...
            <div className="text-center bg-yellow-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Family Whitening Coordination</h3>
              <p className="text-lg text-gray-600 mb-6">
                We coordinate family whitening treatments to ensure everyone achieves their
                best results safely and conveniently from one Mapperley location.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600 mb-2">Same day</div>
                  <p className="text-gray-600">Family appointments</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-yellow-600 mb-2">Teen-safe</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From teenagers to parents to grandparents, we have safe, effective whitening
                options tailored to each family member's age, sensitivity, and lifestyle needs.
              </p>
            </div>
                ...
                return (
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-yellow-400 relative">
                    ...
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-lg text-pear-primary">{option.treatment}</CardTitle>
                      <p className="text-gray-600 text-sm">{option.description}</p>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-pear-primary mb-1">{option.price}</p>
                        <p className="text-sm text-gray-600 mb-2">{option.results}</p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each family member has unique whitening needs based on their age, lifestyle, and dental health.
                We customize treatments for safe, optimal results at every life stage.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="text-center mb-4">
                        ...
                        <p className="text-gray-600 text-sm">{group.considerations}</p>
                      </div>
              ...
              {(whiteningTips || []).map((tipCategory, index) => {
                ...
                return (
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardHeader className="text-center pb-4">
                      <IconComponent className="w-12 h-12 text-yellow-600 mx-auto mb-2" />
                      <CardTitle className="text-lg text-pear-primary">{tipCategory.category}</CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-yellow-600 mb-2">All ages</div>
                <p className="text-gray-600">Safe family whitening</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-yellow-600 mb-2">8+ shades</div>
                <p className="text-gray-600">Brighter smiles achieved</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-yellow-600 mb-2">Family packages</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the beautiful whitening transformations achieved by Mapperley families
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Mapperley families about safe teeth whitening for all ages
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-yellow-50 rounded-lg p-6">
                    <Sparkles className="w-12 h-12 text-yellow-600 mx-auto mb-4" />
                    <h4 className="font-bold text-yellow-700 mb-2">Family Whitening</h4>
                    <p className="text-gray-600">Safe treatments for the whole family</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Give your family the gift of confident, bright smiles. Book your family whitening consultation
              from Mapperley with teen-safe options, family packages, and gentle treatments for all ages.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Teen-safe options • Family packages save £100 • Same-day appointments • Professional results
              </p>
            </div>
