...
export const metadata: Metadata = {
  title: "Children's Preventive Care in Mapperley - Comprehensive Family Prevention | Pear Tree Dental",
  description: "Children's preventive care for affluent Mapperley families. Comprehensive prevention, early intervention, and family education just down the road from Mapperley.",
  keywords: [
  ...
  openGraph: {
    title: "Children's Preventive Care in Mapperley - Comprehensive Family Prevention | Pear Tree Dental",
    description: "Children's preventive care for affluent Mapperley families. Comprehensive prevention and education just down the road.",
  ...
  const mapperleyPreventiveFAQs = [
    {
      ...
      answer: "Pear Tree Dental is literally just down the road from Mapperley. We're specialists in comprehensive family prevention, providing early intervention and education that affluent families value for long-term investment in their children's health."
    },
    {
      question: "What makes your preventive approach special for Mapperley families?",
      answer: "We combine cutting-edge prevention technology, comprehensive family education, early intervention expertise, and convenient location. Our approach aligns with affluent families' focus on proactive health investment and excellence."
    },
    {
      question: "How early should we start preventive care for our Mapperley children?",
      answer: "We recommend starting by age 1 or within 6 months of first tooth emergence. Early prevention establishes lifelong healthy habits and prevents problems before they develop - a smart investment approach."
    },
    {
      question: "Do you provide preventive education for the whole family?",
      answer: "Absolutely! We believe parents are partners in prevention. We provide comprehensive education on nutrition, hygiene, habits, and home care to ensure your family maintains optimal oral health between visits."
    },
    {
      question: "What preventive services do you offer for Mapperley children?",
      answer: "We offer fluoride treatments, fissure sealants, hygiene education, dietary counseling, habit guidance, early orthodontic assessment, and comprehensive monitoring - all designed to prevent problems proactively."
    }
  ];
  ...
  const preventiveServices = [
    {
      ...
      description: "Professional fluoride applications to strengthen developing teeth",
      benefits: ["Strengthens tooth enamel", "Prevents early decay", "Reduces sensitivity", "Long-lasting protection"],
    ...
    },
    {
      ...
      benefits: ["Prevents cavity formation", "Protects deep grooves", "Painless application", "Excellent investment"],
      ageRange: "Ages 6-14",
    ...
    },
    {
      ...
      benefits: ["Proper technique training", "Habit establishment", "Motivation building", "Family involvement"],
      ageRange: "All children",
    ...
    },
    {
      ...
      benefits: ["Healthy eating habits", "Reduced decay risk", "Growth support", "Family education"],
      ageRange: "All children",
      frequency: "As needed",
  ...
  const familyBenefits = [
    {
      ...
      description: "Multi-faceted approach addressing all aspects of children's oral health",
      value: "Long-term health investment",
      icon: Shield
    },
    {
      benefit: "Family Education Focus",
      description: "Extensive education for parents and children on optimal oral health",
      value: "Lifelong healthy habits",
      icon: BookOpen
    },
    {
      benefit: "Early Intervention",
      description: "Identifying and addressing issues before they become major problems",
  ...
  const ageBasedPrevention = [
    {
      ...
      preventiveActions: ["First dental visits", "Teething guidance", "Bottle/cup transition", "Thumb sucking assessment"],
      familyEducation: ["Cleaning baby teeth", "Fluoride guidance", "Nutrition advice", "Habit prevention"],
    ...
    },
    {
      ...
      preventiveActions: ["Regular cleanings", "Fluoride treatments", "Decay prevention", "Habit monitoring"],
      familyEducation: ["Proper brushing", "Healthy snacking", "Dental anxiety prevention", "Preparation for procedures"],
    ...
    },
    {
      ...
      preventiveActions: ["Fissure sealants", "Orthodontic monitoring", "Permanent tooth guidance", "Sports protection"],
      familyEducation: ["Independence building", "Nutritional choices", "Orthodontic preparation", "Injury prevention"],
    ...
    },
    {
      ...
      preventiveActions: ["Wisdom tooth monitoring", "Whitening guidance", "Orthodontic support", "Lifestyle counseling"],
      familyEducation: ["Independent care", "Lifestyle impact", "Aesthetic choices", "Long-term planning"],
  ...
  const preventionTechnologies = [
    {
      ...
      benefits: ["Catches problems early", "Minimally invasive", "Accurate diagnosis", "Better outcomes"],
    ...
    },
    {
      ...
      benefits: ["Visual education", "Better understanding", "Motivation building", "Documentation"],
    ...
    },
    {
      ...
      benefits: ["Superior protection", "Easy application", "Excellent tolerance", "Proven effectiveness"],
    ...
    },
    {
      ...
      benefits: ["Comfortable experience", "Thorough cleaning", "Stain removal", "Motivation building"],
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/childrens-preventive-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/childrens-preventive-care",
            ...
            "medicalSpecialty": "Pediatric Preventive Dentistry - Comprehensive Family Prevention",
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": 52.97335,
              "longitude": -1.04211
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Children's Preventive Care in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Just down the road from Mapperley — Premium prevention & education
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">🌟 Investing in your children's lifelong oral health from day one!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Affluent Mapperley families understand that prevention is the smartest investment in their
                children's health. Our comprehensive approach ensures optimal oral health from infancy through adolescence.
              </p>
            </div>
            ...
            <div className="text-center bg-blue-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Smart Prevention Investment</h3>
              <p className="text-lg text-gray-600 mb-6">
                Mapperley families appreciate that comprehensive prevention today saves significant
                time, money, and discomfort tomorrow. Our approach focuses on education and early intervention.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-2">Prevention focus</div>
                  <p className="text-gray-600">Problems prevented, not treated</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-2">Family education</div>
                  <p className="text-gray-600">Knowledge for lifelong health</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600 mb-2">Down the road</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our prevention program combines the latest technology with proven techniques
                to ensure your children develop and maintain optimal oral health throughout their lives.
              </p>
            </div>
                ...
                return (
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-blue-400 relative">
                    ...
                    <CardContent className="space-y-4">
                      <div className="text-center">
                        <p className="text-xl font-bold text-pear-primary mb-1">{service.investment}</p>
                        <div className="flex flex-col gap-1 mb-2">
                          <Badge variant="outline" className="text-xs">{service.ageRange}</Badge>
                          <span className="text-xs text-gray-600">{service.frequency}</span>
                        </div>
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each stage of childhood requires specific preventive approaches. We tailor our care
                to ensure optimal outcomes at every developmental milestone.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="text-center mb-4">
                        ...
                        <h3 className="font-bold text-pear-primary">{group.ageGroup}</h3>
                        <p className="text-gray-600 text-sm">{group.keyFocus}</p>
                      </div>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-blue-50 rounded-lg p-3">
                          <p className="text-sm text-blue-700 font-medium">{group.outcomes}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We invest in the latest prevention technology to provide Mapperley children
                with the most effective, comfortable, and comprehensive preventive care available.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="bg-blue-50 rounded-lg p-3">
                          <p className="text-sm text-blue-700 font-medium">{tech.familyValue}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-blue-600 mb-2">Prevention first</div>
                <p className="text-gray-600">Problems prevented, not treated</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-blue-600 mb-2">Family education</div>
                <p className="text-gray-600">Knowledge for lifelong health</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-blue-600 mb-2">Down the road</div>
                <p className="text-gray-600">Ultimate convenience</p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See how comprehensive prevention creates healthy, confident smiles for Mapperley children
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from affluent Mapperley families about comprehensive children's preventive care
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-blue-50 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-blue-700 mb-2">Prevention Excellence</h4>
                    <p className="text-gray-600">Comprehensive family prevention programs</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Give your children the foundation for lifelong oral health with comprehensive preventive care.
              Book your family prevention consultation from Mapperley with expert education and early intervention.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Comprehensive prevention • Family education • Early intervention • Just down the road
              </p>
            </div>
