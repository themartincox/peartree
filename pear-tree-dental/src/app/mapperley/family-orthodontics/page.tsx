...
export const metadata: Metadata = {
  title: "Family Orthodontics in Mapperley - Teens & Adults Teeth Straightening | Pear Tree Dental",
  description: "Family orthodontics for Mapperley families. Teen and adult orthodontics, sibling treatments, and multi-generational care just 15 minutes away. Family payment plans available.",
  keywords: [
  ...
  openGraph: {
    title: "Family Orthodontics in Mapperley - Teens & Adults Teeth Straightening | Pear Tree Dental",
    description: "Family orthodontics for Mapperley families. Teen and adult teeth straightening with family-focused care just 15 minutes away.",
  ...
  const mapperleyOrthodonticsFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Mapperley via the A6097. We're family orthodontic specialists providing comprehensive teeth straightening for teens, adults, and whole families."
    },
    {
      question: "Can you treat multiple family members for orthodontics?",
      answer: "Absolutely! We love treating families together. Sibling discounts, coordinated appointments, and family payment plans make orthodontic treatment affordable and convenient for Mapperley families."
    },
    {
      question: "What orthodontic options work best for Mapperley families?",
      answer: "We offer Invisalign for adults and teens, clear aligners, ceramic braces, and traditional braces. Each family member gets the best option for their age, lifestyle, and treatment goals."
    },
    {
      question: "Do you offer family payment plans for orthodontics?",
      answer: "Yes! We understand orthodontic treatment is a significant family investment. We offer 0% interest payment plans, sibling discounts, and flexible family payment options."
    },
    {
      question: "What makes your orthodontic service special for Mapperley families?",
      answer: "We combine family-focused care, sibling coordination, flexible scheduling, convenient Mapperley access, and comprehensive options for all ages. We treat generations, not just individuals."
    }
  ];
  ...
  const familyOptions = [
    {
      ...
      features: ["Virtually invisible", "Removable for sports", "Compliance indicators", "Teen-friendly features"],
    ...
    },
    {
      ...
      features: ["Discreet treatment", "Professional confidence", "Removable convenience", "Predictable results"],
    ...
    },
    {
      ...
      features: ["Less visible than metal", "Effective for all cases", "Comfortable fit", "Excellent value"],
    ...
    },
    {
      ...
      features: ["Maximum effectiveness", "Handles all problems", "Most affordable option", "Fastest results"],
  ...
  const familyBenefits = [
    {
      ...
      description: "Save money when multiple children need orthodontic treatment",
  ...
  const ageGroups = [
    {
      ...
      familyConsiderations: ["Coordinate with siblings", "School schedule friendly", "Sports accommodations"],
      duration: "12-18 months",
      icon: GraduationCap
    },
    {
      ...
      familyConsiderations: ["Discreet options important", "College preparation", "Independence building"],
    ...
    },
    {
      ...
      familyConsiderations: ["Professional appearance", "Minimal appointments", "Leading by example"],
      duration: "6-18 months",
      icon: Users
    },
    {
      ...
      familyConsiderations: ["Comfort priority", "Health benefits", "Multi-generational coordination"],
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/family-orthodontics-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/family-orthodontics",
            ...
            "medicalSpecialty": "Family Orthodontics - Multi-Generational Teeth Straightening",
            "geo": {
              "@type": "GeoCoordinates",
              "latitude": 52.97335,
              "longitude": -1.04211
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Family Orthodontics in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Only 15 mins from Mapperley — Family appointments & sibling discounts
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">👨‍👩‍👧‍👦 Treating Mapperley families with sibling discounts & payment plans!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                When multiple family members need orthodontic treatment, we make it convenient,
                affordable, and coordinated. Families save time, money, and achieve better results together.
              </p>
            </div>
                ...
                return (
                  <Card key={index} className="text-center hover:shadow-lg transition-shadow border-2 border-purple-200">
                    <CardContent className="p-6">
                      ...
                      <Badge className="bg-purple-100 text-purple-700">{benefit.savings}</Badge>
                    </CardContent>
                  </Card>
                );
              })}
            ...
            <div className="text-center bg-purple-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Family Treatment Coordination</h3>
              <p className="text-lg text-gray-600 mb-6">
                We plan treatments to optimize timing, reduce total appointments, and ensure
                the best outcomes for every family member from Mapperley.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">Same day</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From teens to parents to grandparents, we have the perfect orthodontic solution
                for every family member's age, lifestyle, and treatment needs.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-purple-400 relative">
                    {option.highlight && (
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                        <Badge className="bg-purple-600 text-white">{option.highlight}</Badge>
                      </div>
                    )}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Each family member has unique orthodontic needs based on their age, lifestyle, and goals.
                We customize treatment approaches for optimal results at every life stage.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-lg transition-shadow">
                    <CardContent className="p-6">
                      <div className="text-center mb-4">
                        ...
                        <h3 className="font-bold text-pear-primary">{group.ageRange}</h3>
                        <p className="text-gray-600 text-sm">{group.characteristics}</p>
                      </div>

                      <div className="space-y-3">
                        <div>
                          <h4 className="font-semibold text-purple-600 text-sm mb-1">Recommended:</h4>
                          <p className="text-sm text-gray-700">{group.recommendedTreatment}</p>
                        </div>
                        ...
                        <div className="flex items-center gap-2 pt-2">
                          ...
                          <span className="text-sm text-purple-600 font-medium">{group.duration}</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">Whole families</div>
                <p className="text-gray-600">Multi-generational treatment</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">20% off</div>
                <p className="text-gray-600">Sibling discounts</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">Coordinated</div>
                <p className="text-gray-600">Family appointments</p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the stunning orthodontic transformations achieved by Mapperley families
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Mapperley families about family orthodontic treatment and coordination
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-purple-50 rounded-lg p-6">
                    <Users className="w-12 h-12 text-purple-600 mx-auto mb-4" />
                    <h4 className="font-bold text-purple-700 mb-2">Family Coordination</h4>
                    <p className="text-gray-600">Multiple family appointments on the same day</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Transform Your Family's Smiles with Coordinated Orthodontic Care from Mapperley
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              When multiple family members need orthodontic treatment, make it convenient and affordable.
              Book your family orthodontic consultation from Mapperley with sibling discounts and coordinated care.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Sibling discounts up to 20% • Family appointments • Payment plans • All ages welcome
              </p>
            </div>
