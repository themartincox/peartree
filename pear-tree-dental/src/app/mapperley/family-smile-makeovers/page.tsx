...
export const metadata: Metadata = {
  title: "Family Smile Makeovers in Mapperley - Complete Aesthetic Transformations | Pear Tree Dental",
  description: "Family smile makeovers for affluent Mapperley families. Complete aesthetic transformations, coordinated family treatments, and investment-level results just down the road.",
  keywords: [
  ...
  openGraph: {
    title: "Family Smile Makeovers in Mapperley - Complete Aesthetic Transformations | Pear Tree Dental",
    description: "Family smile makeovers for affluent Mapperley families. Complete transformations and coordinated care just down the road.",
  ...
  const mapperleyMakeoverFAQs = [
    {
      ...
      answer: "Pear Tree Dental is literally just down the road from Mapperley. We're specialists in coordinated family smile makeovers, providing complete aesthetic transformations with investment-level results and family-centered planning."
    },
    {
      question: "Can you coordinate smile makeovers for multiple family members?",
      answer: "Absolutely! We excel at family smile makeover coordination, planning comprehensive transformations for multiple family members, timing treatments optimally, and ensuring cohesive aesthetic outcomes that complement each family member."
    },
    {
      question: "What's included in a complete family smile makeover?",
      answer: "Comprehensive assessment, digital smile design, combination treatments (veneers, crowns, whitening, orthodontics), family coordination, phased treatment planning, and ongoing aesthetic maintenance for optimal long-term results."
    },
    {
      question: "What makes your smile makeovers special for affluent Mapperley families?",
      answer: "We combine cutting-edge technology, premium materials, artistic expertise, family coordination, and convenient location. Our investment-level approach ensures exceptional results that reflect Mapperley families' quality expectations."
    },
    {
      question: "How do you ensure natural-looking results for family makeovers?",
      answer: "We use advanced digital smile design, consider facial harmony, age-appropriate aesthetics, family coordination, and natural-looking materials to ensure each family member achieves beautiful, authentic-looking results."
    }
  ];
  ...
  const makeoverTypes = [
    {
      ...
      treatments: ["Digital smile design", "Porcelain veneers", "Crown combinations", "Whitening coordination"],
    ...
    },
    {
      ...
      treatments: ["Premium veneers", "Gum contouring", "Professional whitening", "Aesthetic crowns"],
      timeline: "3-6 months",
    ...
    },
    {
      ...
      treatments: ["Orthodontic correction", "Composite bonding", "Safe whitening", "Confidence building"],
    ...
    },
    {
      ...
      treatments: ["Age-appropriate solutions", "Family coordination", "Phased treatments", "Comprehensive care"],
  ...
  const familyBenefits = [
    {
      ...
      description: "Comprehensive aesthetic makeovers that address all smile concerns",
      value: "Life-changing results",
      icon: Sparkles
    },
    {
      benefit: "Family Coordination",
      description: "Synchronized treatments and aesthetics across family members",
  ...
  const makeoverComponents = [
    {
      ...
      benefits: ["See results before treatment", "Perfect aesthetic planning", "Family coordination", "Predictable outcomes"],
    ...
    },
    {
      ...
      benefits: ["Natural translucency", "Stain resistance", "Perfect fit", "Lifetime aesthetics"],
    ...
    },
    {
      ...
      benefits: ["Complete restoration", "Natural appearance", "Optimal function", "Long-term durability"],
    ...
    },
    {
      ...
      benefits: ["Improved proportions", "Enhanced aesthetics", "Perfect symmetry", "Confident smiling"],
    ...
    },
    {
      ...
      benefits: ["Consistent results", "Family coordination", "Safe application", "Long-lasting brightness"],
    ...
    },
    {
      ...
      benefits: ["Perfect positioning", "Aesthetic improvement", "Function optimization", "Treatment coordination"],
  ...
  const familyTimeline = [
    {
      ...
      description: "Detailed evaluation and digital planning for all family members",
      duration: "2-3 appointments",
      activities: ["Individual assessments", "Digital smile design", "Family coordination planning", "Investment consultation"]
    },
    {
      phase: "Treatment Preparation",
      description: "Coordinated preparation phase for optimal results",
      duration: "2-4 weeks",
      activities: ["Orthodontic planning", "Gum health optimization", "Color coordination", "Timeline scheduling"]
    },
    {
      phase: "Active Transformation",
      description: "Coordinated treatment implementation across family",
      duration: "3-12 months",
      activities: ["Phased treatments", "Family coordination", "Progress monitoring", "Aesthetic refinement"]
    },
    {
      phase: "Final Aesthetic Refinement",
      description: "Perfect finishing and family coordination",
      duration: "2-4 weeks",
      activities: ["Final adjustments", "Aesthetic perfection", "Family photo sessions", "Maintenance planning"]
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/family-smile-makeovers-mapperley.jpg",
            "url": "https://peartree.dental/mapperley/family-smile-makeovers",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Family Smile Makeovers in <span className="text-yellow-300">Mapperley</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Just down the road from Mapperley — Investment-level smile transformations
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">✨ Complete aesthetic transformations for discerning Mapperley families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Affluent Mapperley families understand that a smile makeover is a significant investment in confidence,
                success, and quality of life. Our comprehensive approach delivers exceptional, life-changing results.
              </p>
            </div>
            ...
            <div className="text-center bg-purple-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">Complete Family Aesthetic Excellence</h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand that Mapperley families seek excellence in every aspect of life. Our smile makeovers
                combine cutting-edge technology, artistic expertise, and premium materials for investment-level results.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">Digital design</div>
                  <p className="text-gray-600">See results before treatment</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">Family coordination</div>
                  <p className="text-gray-600">Harmonious family aesthetics</p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">Down the road</div>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Comprehensive Makeover Solutions for Every Mapperley Family Member
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From individual transformations to complete family makeovers, we provide
                investment-level solutions tailored to each family member's needs and aesthetic goals.
              </p>
            </div>
                  ...
                  <Card key={index} className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-purple-400 relative">
                    {makeover.highlight && (
                      <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                        <Badge className="bg-purple-600 text-white">{makeover.highlight}</Badge>
                      </div>
                    )}
                    <CardHeader className="text-center pb-4">
                      ...
                      <CardTitle className="text-lg text-pear-primary">{makeover.makeoverType}</CardTitle>
                      <p className="text-gray-600 text-sm">{makeover.description}</p>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <div className="text-center">
                        <p className="text-2xl font-bold text-pear-primary mb-1">{makeover.investment}</p>
                        <Badge variant="outline" className="mb-4">{makeover.timeline}</Badge>
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our comprehensive makeovers combine the finest treatments and technologies
                to deliver exceptional, natural-looking results that exceed expectations.
              </p>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="bg-purple-50 rounded-lg p-3">
                          <p className="text-sm text-purple-700 font-medium">{component.investmentLevel}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our systematic approach ensures coordinated family makeovers with optimal
                timing, minimal disruption, and exceptional aesthetic outcomes for all family members.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">Investment level</div>
                <p className="text-gray-600">Exceptional quality and results</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">Family coordination</div>
                <p className="text-gray-600">Harmonious aesthetic outcomes</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-purple-600 mb-2">Life-changing</div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the stunning smile transformations achieved by affluent Mapperley families
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from affluent Mapperley families about comprehensive smile makeovers
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-purple-50 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-purple-700 mb-2">Smile Makeover Excellence</h4>
                    <p className="text-gray-600">Complete family aesthetic transformations</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Transform Your Family's Smiles with Investment-Level Makeovers from Mapperley
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Invest in your family's confidence and success with comprehensive smile makeovers.
              Book your family transformation consultation from Mapperley with complete aesthetic solutions.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Complete transformations • Family coordination • Investment-level quality • Just down the road
              </p>
            </div>
