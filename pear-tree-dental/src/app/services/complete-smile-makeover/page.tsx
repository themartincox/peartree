  ...
  const smileMakeoverFAQs = [
    {
      ...
      answer: "A complete smile makeover is a comprehensive treatment plan that combines multiple cosmetic and restorative procedures to transform your entire smile. This may include teeth whitening, veneers, crowns, orthodontics, gum contouring, and dental implants as needed."
    },
    {
      question: "How much does a complete smile makeover cost?",
      answer: "Complete smile makeovers start from £2,500 but vary significantly based on your individual needs. The final cost depends on which treatments are included in your personalized plan. We offer detailed quotes after your consultation and assessment."
    },
    {
      question: "How long does a complete smile makeover take?",
      answer: "The timeline varies from 2-12 months depending on the complexity of your case. Simple makeovers with whitening and bonding may take 2-4 weeks, while comprehensive cases requiring orthodontics and multiple procedures may take 6-12 months."
    },
    {
      question: "Is a smile makeover painful?",
      answer: "Most smile makeover procedures are comfortable with modern anesthetics and techniques. Any discomfort is typically mild and temporary. We use advanced pain management techniques and sedation options to ensure your comfort throughout treatment."
    },
    {
      question: "How long do smile makeover results last?",
      answer: "With proper care, smile makeover results can last 10-20 years or more. Porcelain veneers typically last 15-20 years, crowns 10-15 years, and whitening results 2-3 years with touch-ups. Good oral hygiene and regular check-ups maximize longevity."
    },
    {
      question: "Can I see what my new smile will look like before treatment?",
      answer: "Yes! We use advanced smile design technology and digital mock-ups to show you exactly how your new smile will look before we begin treatment. This allows you to make informed decisions and ensures you'll love your results."
    }
  ];
  ...
  const treatmentOptions = [
    {
      ...
      description: "Ultra-thin porcelain or composite shells to perfect tooth shape, size, and color",
      price: "From £750 per tooth",
      icon: Crown,
      benefits: ["Perfect tooth shape", "Natural appearance", "Stain resistant", "Long-lasting results"]
    },
    {
      title: "Professional Whitening",
      description: "Advanced whitening systems for dramatically brighter, whiter teeth",
      price: "From £400",
      icon: Sparkles,
      benefits: ["Up to 8 shades whiter", "Safe and effective", "Quick results", "Lasting brightness"]
    },
    {
      title: "Clear Aligners",
      description: "Invisible orthodontic treatment to straighten and align your teeth",
      price: "From £2,000",
      icon: Eye,
      benefits: ["Nearly invisible", "Removable", "Comfortable", "Predictable results"]
    },
    {
      title: "Dental Crowns",
      description: "Full coverage restorations for damaged or severely discolored teeth",
      price: "From £750",
      icon: Diamond,
      benefits: ["Complete coverage", "Natural appearance", "Strong and durable", "Perfect fit"]
    },
    {
      title: "Dental Implants",
      description: "Permanent tooth replacement for missing teeth in your smile",
      price: "From £3,000",
      icon: Target,
      benefits: ["Permanent solution", "Natural feel", "Preserves jawbone", "No diet restrictions"]
    },
    {
      ...
      icon: Palette,
      benefits: ["Perfect proportions", "Enhanced tooth appearance", "Minimal discomfort", "Quick healing"]
    }
  ];
  ...
  const makeoverPackages = [
    {
      ...
      treatments: ["Professional whitening", "Composite bonding", "Polish and contouring"],
      description: "Perfect for enhancing your natural smile with subtle improvements"
    },
    {
      ...
      treatments: ["Whitening", "4-6 veneers", "Gum contouring", "Minor orthodontics"],
      description: "Comprehensive improvement addressing multiple aesthetic concerns"
    },
    {
      ...
      treatments: ["Full mouth veneers", "Orthodontics", "Crowns", "Gum reshaping"],
  ...
  const process = [
    {
      ...
      description: "Detailed assessment of your oral health, aesthetic concerns, and smile goals",
      duration: "90 minutes",
      includes: ["Digital photography", "3D scanning", "Bite analysis", "Treatment planning"]
    },
    {
      step: "2",
      title: "Smile Design & Planning",
      description: "Create your personalized smile design using advanced digital technology",
      duration: "1-2 weeks",
      includes: ["Digital smile design", "Treatment timeline", "Cost breakdown", "Preview mockup"]
    },
    {
      step: "3",
      ...
      includes: ["Progressive treatments", "Regular monitoring", "Comfort management", "Progress updates"]
    },
    {
      step: "4",
      ...
      duration: "Ongoing",
      includes: ["Final adjustments", "Professional photography", "Maintenance plan", "Follow-up care"]
    }
  ];
      ...
      <section className="pt-24 pb-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-rose-600 font-medium">Complete Smile Makeover</span>
          </nav>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A comprehensive approach to smile transformation addresses all aspects of your smile
              for optimal aesthetics, function, and long-lasting results.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-rose-50 to-amber-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive smile makeovers combine the best cosmetic and restorative
              treatments to create your perfect smile.
            </p>
          </div>
                ...
                <Card key={treatment.title} className="hover:shadow-lg transition-shadow border-2 border-rose-200 hover:border-rose-400">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <CardTitle className="text-lg text-pear-primary">{treatment.title}</CardTitle>
                        <div className="text-sm font-semibold text-rose-600">{treatment.price}</div>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              ...
              packages tailored to your specific needs and goals.
            </p>
          </div>
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <div className="text-2xl font-bold text-rose-600 mt-2">{pkg.price}</div>
                  ...
                  <CardDescription className="font-medium text-gray-700">{pkg.ideal}</CardDescription>
                </CardHeader>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our systematic approach ensures comprehensive planning and flawless execution
              for outstanding smile transformation results.
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-rose-50 to-amber-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Flexible payment options and membership discounts make your dream smile
          ...
          <div className="mt-12 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              ...
              <Card className="p-6 border border-rose-200">
                ...
                <p className="text-sm text-gray-600">Spread costs over 12-36 months with affordable monthly payments</p>
              </Card>
              <Card className="p-6 border border-rose-200">
                <h4 className="font-semibold text-rose-600 mb-2">Insurance Coverage</h4>
                <p className="text-sm text-gray-600">Some treatments may be partially covered by dental insurance</p>
              </Card>
            </div>
          </div>
        </div>
          ...
          <Card className="bg-gradient-to-r from-rose-600 to-amber-600 text-white overflow-hidden">
            <CardContent className="p-12 text-center relative">
              ...
              <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
                Take the first step toward your dream smile. Book your comprehensive consultation
                and discover how a complete smile makeover can transform your confidence and life.
              </p>
