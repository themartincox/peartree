...
export const metadata: Metadata = {
  title: "Dental Abscess Emergency Treatment | Severe Toothache Relief Burton Joyce - Pear Tree Dental",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceStructuredData
        serviceName="Dental Abscess Emergency Treatment"
        description="Emergency dental abscess treatment for severe toothache, facial swelling, and infection. Immediate pain relief and professional care available."
        provider={{
          "@type": "Dentist",
        ...
        availableChannel={{
          "@type": "ServiceChannel",
          "serviceUrl": "https://peartree.dental/services/emergency/abscess",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <Card className="overflow-hidden shadow-2xl border-2 border-red-200">
                <div className="aspect-[4/3] bg-gradient-to-br from-red-100 to-pink-100 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-pear-primary mb-2">INFECTION SPECIALIST</h3>
              ...
              <div className="absolute -top-4 -right-4 bg-red-600 text-white rounded-full px-4 py-2 shadow-lg">
                <div className="text-center">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <Badge variant="outline" className="border-red-600 text-red-600">{stage.duration}</Badge>
                    </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {antibioticInfo.map((med, index) => (
              <Card key={index} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <h3 className="font-semibold text-lg text-pear-primary">{med.antibiotic}</h3>
