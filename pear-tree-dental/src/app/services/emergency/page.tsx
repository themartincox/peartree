...
export const metadata: Metadata = {
  title:
    "Emergency Dentist Burton Joyce | Urgent Dental Emergency Care | Pear Tree Dental",
  description:
    "Emergency dentist in Burton Joyce, Nottinghamshire. Dental pain relief, broken teeth, lost fillings. Often same-day emergency appointments. Call 0115 931 2935 now.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Emergency dentist in Burton Joyce. Often same-day appointments for dental emergencies. Call now 0115 931 2935",
    type: "website",
  ...
  const emergencyServices = [
    {
      ...
      description:
        "Immediate pain relief for severe toothaches and dental infections",
      icon: AlertTriangle,
      timeframe: "Rapid",
    },
    {
      ...
      description:
        "Emergency repair for damaged teeth from accidents or trauma",
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Quick replacement of lost dental work to prevent further damage",
      icon: Heart,
      timeframe: "Often Same Day",
    },
    {
      ...
      <section className="py-16 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            Dental emergencies don't wait for convenient times. Our experienced
            team provides immediate relief for urgent dental problems aiming for
          ...
          <div className="bg-amber-100 border border-amber-300 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
            <div className="flex items-center">
              ...
              <p className="text-amber-800 font-medium">
                <strong>Serious Trauma:</strong> In cases of severe facial
                injury or life-threatening emergencies, call 999 immediately
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We handle all types of dental emergencies with quick, professional
              care
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Use cold compress and over-the-counter pain relief
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Call our emergency line for urgent care
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-red-100">
              Our emergency dental team is ready to provide immediate relief and
