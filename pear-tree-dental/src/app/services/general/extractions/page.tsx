...
export const metadata: Metadata = {
  ...
  description: "Gentle, pain-free tooth extractions in Burton Joyce. Expert removal techniques with minimal discomfort. Wisdom teeth, damaged teeth, emergency extractions from £180.",
  keywords: [
    "tooth extraction Burton Joyce",
    "wisdom tooth removal",
    "gentle tooth extraction",
    "painless tooth removal",
    "emergency tooth extraction",
    "dental surgery Burton Joyce"
  ],
};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceStructuredData
        serviceName="Gentle Tooth Extractions"
        description="Gentle, pain-free tooth extractions with minimal discomfort and optimal healing. Expert removal techniques for simple and complex extractions."
        provider={{
          "@type": "Dentist",
        ...
        availableChannel={{
          "@type": "ServiceChannel",
          "serviceUrl": "https://peartree.dental/services/general/extractions",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="bg-pear-background border border-dental-green/20 rounded-lg p-4 mb-8">
                <div className="flex items-center space-x-3">
                  <Heart className="w-6 h-6 text-dental-green" />
                  <div>
                    <div className="font-bold text-pear-primary">GENTLE APPROACH</div>
                    <div className="text-gray-600 text-sm">Minimally invasive techniques for comfortable healing</div>
                  </div>
                </div>
              </div>
              ...
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-dental-green/20 to-soft-blue/20 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-pear-primary mb-2">GENTLE EXTRACTIONS</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {extractionTypes.map((extraction, index) => (
              <Card key={index} className="border-l-4 border-dental-green bg-dental-green/5">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="bg-white p-3 rounded border border-dental-green/20">
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <Badge variant="outline" className="border-dental-green text-dental-green">{stage.duration}</Badge>
                    </div>
