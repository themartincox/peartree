...
export default function EmergencyRepairsPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* SEO Schema */}
      <MedicalOrganizationSchema page="services" serviceType="Emergency Dental Repairs" />
      ...
      <section className="py-16 bg-gradient-to-br from-red-50 to-orange-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
            Don't let a broken crown, lost filling, or damaged denture ruin your day.
            We provide immediate emergency repairs to get you smiling again.
          </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Quick, efficient, and designed to get you back to normal as soon as possible
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">Contact our emergency line for immediate advice and appointment scheduling</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Professional repair or temporary solution to restore function and comfort</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-red-100">
              Every minute counts when you have a dental emergency.
              Our team is ready to help restore your smile.
            </p>
