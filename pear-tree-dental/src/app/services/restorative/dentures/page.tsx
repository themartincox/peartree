...
export const metadata: Metadata = {
  ...
  description:
    "Expert denture services in Burton Joyce. Complete dentures, partial dentures, Valplast, Cobalt Chrome, and Hybrid options. Restore your smile with comfortable, natural-looking dentures.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Restore your smile with our comprehensive range of denture options. Expert fitting and premium materials.",
    type: "website",
...
export default function DenturesPage() {
  const denturesFAQs = [
    {
      ...
      answer:
        "We offer complete dentures, partial dentures, Valplast flexible dentures, Cobalt Chrome precision dentures, and advanced Hybrid dentures. Each type has specific advantages depending on your needs and preferences.",
    },
    {
      question: "How long do dentures last?",
      answer:
        "Denture lifespan varies by type: acrylic dentures (5-7 years), Valplast (5-8 years), Cobalt Chrome (10-15 years), and Hybrid dentures (10-20 years). Proper care and regular check-ups help maximize their lifespan.",
    },
    {
      question: "Will my dentures look natural?",
      answer:
        "Yes! Modern dentures are designed to look very natural. We carefully match tooth color, shape, and size to complement your facial features. Premium options like Hybrid dentures offer the most natural appearance.",
    },
    {
      question: "How long does it take to get dentures?",
      answer:
        "The process typically takes 2-6 weeks depending on the type of denture. Complete dentures may take longer than partials, and premium options like Cobalt Chrome require additional time for precision manufacturing.",
    },
    {
      question: "Will I be able to eat normally with dentures?",
      answer:
        "With proper fitting and an adjustment period, most patients can eat comfortably with dentures. Start with soft foods and gradually progress. Premium dentures often provide better chewing efficiency and stability.",
    },
  ...
  const dentureTypes = [
    {
      ...
      description:
        "Full replacement of all teeth in upper or lower jaw for complete restoration",
    ...
    },
    {
      ...
      description:
        "Replace multiple missing teeth while preserving your remaining natural teeth",
    ...
    },
    {
      ...
      description:
        "Flexible, metal-free partial dentures with invisible clasps for superior comfort",
    ...
    },
    {
      ...
      description:
        "Precision-cast metal framework dentures for maximum strength and accuracy",
    ...
    },
    {
      ...
      description:
        "Advanced multi-material construction combining the best of all denture technologies",
  ...
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Enjoy your favorite foods again with proper chewing ability",
    },
    {
      icon: Users,
      title: "Social Confidence",
      description:
        "Feel comfortable in social situations without worrying about your teeth",
    },
    {
      icon: Award,
      title: "Facial Support",
      description:
        "Maintain proper facial structure and prevent the sunken appearance",
    },
  ];
  ...
  const process = [
    {
      ...
      title: "Consultation",
      description:
        "Comprehensive examination and discussion of your denture options",
    },
    {
      step: "2",
      title: "Treatment Planning",
      description:
        "Custom treatment plan based on your needs, preferences, and budget",
    },
    {
      step: "3",
      title: "Impressions & Fitting",
      description:
        "Precise impressions and trial fittings to ensure perfect fit",
    },
    {
      step: "4",
      title: "Delivery & Care",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50/30 via-white to-orange-50/30">
      ...
      <ServiceFAQSchema serviceName="Dentures" faqs={denturesFAQs} />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <Link
              ...
              className="hover:text-pear-primary"
            >
              Restorative
            </Link>
            <span>/</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Rediscover the joy of eating, speaking, and smiling with
                confidence. Our comprehensive range of denture solutions
              ...
              <div className="inline-flex items-center bg-dental-teal border border-dental-teal rounded-full px-6 py-3">
                ...
                <span className="text-sm font-semibold text-white">
                  Over 1,000 successful denture fittings
                </span>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold group"
                >
              ...
              <Card className="bg-gradient-to-br from-amber-100 to-orange-100 p-8 h-96">
                <div className="space-y-6">
                  ...
                  <p className="text-gray-600">
                    ...
                    we have the perfect option to restore your smile and
                    confidence.
                  </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From traditional to cutting-edge, we offer a complete range of
              denture options to match your needs, lifestyle, and budget.
            </p>
          </div>
                  ...
                  <CardHeader className={denture.popular ? "pt-12" : "pt-6"}>
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        ...
                        <Badge
                          variant="outline"
                          className="text-amber-600 border-amber-600 mt-1"
                        >
                          {denture.price}
                        </Badge>
                      </div>
      ...
      <section className="py-16 bg-gradient-to-r from-amber-50 to-orange-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Well-fitted dentures do more than replace missing teeth - they
              restore your ability to live life to the fullest.
            </p>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our proven 4-step process ensures your dentures fit perfectly and
