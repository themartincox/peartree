...
export const metadata: Metadata = {
  title:
    "Buccal Corridor Correction - Unlock the Full Beauty of Your Smile | Pear Tree Dental",
  description:
    "Transform your smile with buccal corridor correction in Nottingham. Get the Hollywood smile, boost confidence, and discover a fuller, more radiant smile. From £2,500. Life-changing results.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Get the Hollywood Smile by eliminating dark spaces at the corners. Expert buccal corridor correction from £2,500.",
    type: "website",
  ...
  const buccalCorridorFAQs = [
    {
      ...
      answer:
        "Every journey is unique, but most orthodontic approaches take 12-24 months to complete, whilst cosmetic solutions can often be achieved in just a few visits. We'll give you a clear timeline during your consultation.",
    },
    {
      question: "Will I be comfortable during treatment?",
      answer:
        "Absolutely. Any mild discomfort from orthodontic movement is temporary and manageable, whilst cosmetic procedures are performed with local anaesthesia to ensure your complete comfort.",
    },
    {
      question: "What about the investment?",
      answer:
        "We believe everyone deserves to love their smile, which is why we offer various payment options and will help you explore any insurance benefits you may have.",
    },
    {
      question: "How long will my beautiful results last?",
      answer:
        "With proper care and the retainers we'll provide, your orthodontic results can last a lifetime. Cosmetic restorations typically maintain their beauty for 15-20 years or more with good care.",
    },
    {
      question: "How do I know if buccal corridor correction could help me?",
      answer:
        "You might benefit if you notice prominent dark spaces that make your smile appear narrow, feel self-conscious about showing your teeth, or find that your smile doesn't reflect the vibrant person you are.",
    },
  ];
  ...
  const treatmentOptions = [
    {
      ...
      description:
        "Using modern clear aligners or carefully planned traditional braces, we can gradually encourage your upper arch to widen naturally",
      features: [
        "Clear aligner technology",
        "Natural arch widening",
    ...
    },
    {
      ...
      description:
        "For more comprehensive changes, we can work with the structure of your upper jaw itself, creating lasting improvements",
      features: [
        "Structural jaw changes",
        "Enhanced breathing",
    ...
    },
    {
      ...
      description:
        "Through expertly crafted porcelain veneers or crowns, we can create the visual harmony you're looking for",
      features: [
    ...
    },
    {
      ...
      description:
        "Often, the most beautiful results come from combining different techniques for your perfect smile",
      features: [
  ...
  const benefits = [
    {
      ...
      description:
        "Your new, fuller smile will reflect the confident, joyful person you are inside. You'll find yourself smiling more freely and feeling completely at ease in every photo",
    },
    {
      icon: Heart,
      title: "Confidence That Radiates",
      description:
        "There's something transformative about loving your smile. It affects how you present yourself to the world and how you feel about yourself every single day",
    },
    {
      icon: Gauge,
      title: "Functional Improvements You'll Notice",
      description:
        "Many patients are surprised to discover that their treatment also improves their breathing, speech clarity, and overall oral comfort",
    },
    {
      icon: Eye,
      title: "Life-Changing Transformation",
      description:
        "It's wonderful when looking better also means feeling better. Your smile transformation affects every aspect of how you interact with the world",
    },
  ];
  ...
  const process = [
    {
      ...
      description:
        "Your first visit is all about you. We'll listen to your concerns, understand your hopes for your smile, and conduct a thorough evaluation using the latest digital imaging technology",
    },
    {
      step: "2",
      title: "Seeing Your Future Smile",
      description:
        "Using sophisticated planning software, we'll create a detailed preview of your results. Watching our patients see their transformed smile for the first time is one of the most rewarding parts of what we do",
    },
    {
      step: "3",
      title: "Your Comfortable Treatment Experience",
      description:
        "Whether your journey involves wearing aligners, traditional braces, or preparing for beautiful cosmetic restorations, we'll be with you every step of the way",
    },
    {
      step: "4",
      title: "Protecting Your Investment",
      description:
        "Once you've achieved your dream smile, we'll provide you with everything you need to maintain those stunning results for years to come",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              At Pear Tree Dental, we understand how much your smile means to
              you, and we're here to help you discover the life-changing
              transformation that comes with buccal corridor correction.
            </p>
            <p className="text-lg text-gray-600 leading-relaxed">
              Perhaps you've noticed that the smile people see doesn't match the
              joy you feel. Maybe you find yourself covering your mouth when you
              laugh, or avoiding photos because your smile doesn't look quite
              right. These feelings are more common than you might think, and
                ...
                <div className="space-y-6">
                  <div>
                    <p className="text-gray-600 leading-relaxed mb-6">
                      Buccal corridors are the dark spaces that appear between
                      your back teeth and the corners of your mouth when you
                      smile. While some space is natural, too much can make your
                      smile appear narrow or aged.
                    </p>
                    <p className="text-gray-600 leading-relaxed">
                      These spaces often develop when your upper arch is
                      naturally narrow, after tooth extractions, or simply as
                      part of the ageing process. The good news? There's so much
                      we can do to help.
                    </p>
                  </div>
                  ...
                  <div>
                    <h4 className="font-semibold text-pear-primary mb-3">
                      You might benefit from treatment if you experience:
                    </h4>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-pear-gold mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-600">
                          Prominent dark spaces that make your smile appear
                          narrow
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-pear-gold mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-600">
                          Feeling self-conscious about showing your teeth in
                          social situations
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-pear-gold mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-600">
                          Photos where your smile seems smaller than your
                          personality
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-5 h-5 text-pear-gold mr-3 mt-0.5 flex-shrink-0" />
                        <span className="text-gray-600">
                          A sense that your smile doesn't reflect the person you
                          are
                        </span>
                      </li>
                    </ul>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer personalised treatment approaches designed to give you
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        ...
                        <div className="font-medium text-pear-primary">
                          {option.duration}
                        </div>
                      </div>
                      <div>
      ...
      <section className="py-16 bg-gradient-to-r from-soft-pink to-soft-lavender">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              When you love your smile, it transforms not just how you look, but
              how you feel about yourself every day
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              See the remarkable transformation achieved through our buccal
              corridor correction treatment. Slide to compare the before and
              after results.
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto mb-8">
            <BeforeAfterSliderPair
              primarySlider={{
                ...
                beforeAlt:
                  "Patient's smile before buccal corridor correction showing narrow smile with visible dark spaces on the sides",
                afterAlt:
                  "Patient's smile after buccal corridor correction showing wider, fuller smile with eliminated dark spaces",
                title: "Buccal Corridor Correction Transformation",
                description:
                  "Complete smile enhancement eliminating dark buccal corridors for a wider, more confident smile",
              ...
              secondarySlider={{
                ...
                afterImage: "/images/before-after/BCC-after.png",
                beforeAlt:
                  "Before treatment showing severe buccal corridor shadows affecting smile width",
                afterAlt:
                  "After treatment with dramatically improved smile width and natural appearance",
                title: "Advanced BCC Treatment",
                description:
                  "Comprehensive approach combining orthodontics and cosmetic dentistry for optimal results",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">
                  3-18 months depending on approach
                </p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-soft-pink rounded-full flex items-center justify-center mx-auto mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            <div className="space-y-6">
              <div className="flex space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-pear-primary mb-2">
                    We See Your Vision Before You Do
                  </h4>
                  <p className="text-gray-600">
                    Our advanced 3D imaging technology allows us to show you
                    exactly how your transformed smile will look before we even
                    begin. There's something magical about seeing your future
              ...
              <div className="flex space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our team includes orthodontists and cosmetic dentists with a
                    special interest in creating life-changing smile
                    transformations. We work together, sharing decades of
                    combined experience.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Your journey should be as pleasant as your destination. From
                    our welcoming practice environment to our gentle treatment
                    techniques, we're committed to making every visit
              ...
              <div className="flex space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    No two smiles are alike, and neither are our treatment
                    plans. We take time to understand not just your dental
                    needs, but your lifestyle, your personality, and your dreams
                    for your smile.
                  </p>
                </div>
              </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From your first consultation to your beautiful results, we're with
              ...
              return (
                ...
                >
                  <CardContent className="p-6">
                    <div
                      className={`w-14 h-14 ${colorClasses[index]} rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-lg shadow-lg`}
                    >
                      {step.step}
                    </div>
                    <h3 className="font-semibold text-pear-primary mb-2">
              ...
              <Card className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Cutting-edge 3D imaging and smile design software show you
                      exactly how your corrected smile will look before
                      treatment begins.
                    </p>
                  </div>
                </div>
              ...
              <Card className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Our orthodontists and cosmetic dentists work
                      collaboratively, providing coordinated care under one roof
                      for optimal results.
                    </p>
                  </div>
                </div>
              ...
              <Card className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Modern, relaxing practice environment with gentle
                      treatment techniques prioritising your comfort throughout
                      the process.
                    </p>
                  </div>
                </div>
              ...
              <Card className="p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Every smile is unique. We develop customised treatment
                      plans based on your specific anatomy, lifestyle, and
                      goals.
                    </p>
                  </div>
                </div>
