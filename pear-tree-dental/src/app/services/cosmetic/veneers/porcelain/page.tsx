...
export const metadata: Metadata = {
  ...
  description:
    "Premium traditional porcelain veneers lasting 10-20 years. Gold standard cosmetic dentistry with superior durability and natural appearance in Burton Joyce.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Premium traditional porcelain veneers lasting 10-20 years. Gold standard cosmetic dentistry with superior durability.",
    type: "website",
  ...
  const benefits = [
    {
      ...
      description:
        "Made from high-grade dental porcelain, these veneers are incredibly strong and resistant to chipping, cracking, and wear - lasting 10-20 years.",
    },
    {
      icon: Sparkles,
      title: "Natural Appearance",
      description:
        "The translucent quality of porcelain perfectly mimics natural tooth enamel, creating results that are virtually indistinguishable from natural teeth.",
    },
    {
      icon: ShieldCheck,
      title: "Stain Resistance",
      description:
        "Porcelain's non-porous surface resists staining from coffee, wine, and other foods, keeping your smile bright for years to come.",
    },
    {
      icon: Target,
      title: "Comprehensive Correction",
      description:
        "Ideal for addressing major cosmetic issues including severe discoloration, significant gaps, worn teeth, and shape irregularities.",
    },
    {
      icon: Crown,
      title: "Precision Crafted",
      description:
        "Each veneer is individually designed and fabricated by master ceramists using advanced materials and techniques for perfect fit and function.",
    },
    {
      icon: Palette,
      title: "Versatile Solutions",
      description:
        "Suitable for single tooth corrections or complete smile makeovers, addressing multiple aesthetic concerns simultaneously.",
    },
  ];
  ...
  const keyBenefits = [
    {
      ...
      description:
        "Dramatic smile improvements achieved in just 2-3 appointments, addressing multiple concerns simultaneously.",
    },
    {
      icon: Palette,
      title: "Customizable Aesthetics",
      description:
        "Shape, size, and color can be precisely tailored to complement your facial features and personal preferences.",
    },
    {
      icon: Heart,
      title: "Conservative Treatment",
      description:
        "Preserves more tooth structure than crowns while providing comprehensive aesthetic correction.",
    },
    {
      icon: Hammer,
      title: "Strengthens Teeth",
      description:
        "Bonded porcelain can actually strengthen weakened or worn teeth while improving their appearance.",
    },
  ];
  ...
  const treatmentSteps = [
    {
      ...
      description:
        "Detailed assessment of your smile goals, oral health evaluation, and treatment planning with digital smile preview.",
    },
    {
      step: 2,
      title: "Tooth Preparation",
      description:
        "Careful removal of a thin layer of enamel (0.5-0.7mm) to accommodate the veneer thickness and ensure proper fit.",
    },
    {
      step: 3,
      title: "Precision Impressions",
      description:
        "Digital or traditional impressions capture exact tooth dimensions. Temporary veneers protect teeth during fabrication.",
    },
    {
      step: 4,
      title: "Custom Fabrication",
      description:
        "Master ceramists handcraft your veneers using premium porcelain, matching color, translucency, and surface texture.",
    },
    {
      step: 5,
      title: "Bonding & Finishing",
      description:
        "Precise placement, bonding with advanced adhesives, and final adjustments ensure perfect fit, function, and aesthetics.",
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Traditional porcelain veneers typically last 10-20 years with proper care. Their longevity depends on oral hygiene, regular dental visits, and avoiding habits like teeth grinding or using teeth as tools.",
    },
    {
      question: "Is the procedure painful?",
      answer:
        "Most patients experience minimal discomfort. Local anesthesia is used during tooth preparation, and any sensitivity after treatment is typically mild and temporary. We provide detailed aftercare instructions for your comfort.",
    },
    {
      question: "Will my veneers look natural?",
      answer:
        "Yes! High-quality porcelain has optical properties very similar to natural tooth enamel. Our ceramists carefully match color, translucency, and surface texture to create results that look completely natural.",
    },
    {
      question: "How much tooth structure is removed?",
      answer:
        "Typically, 0.5-0.7mm of enamel is carefully removed from the front surface of teeth. This is a conservative amount that maintains tooth strength while allowing space for the veneer.",
    },
    {
      question: "Can veneers be whitened if they stain?",
      answer:
        "Porcelain veneers are highly stain-resistant and don't respond to traditional whitening. However, professional cleaning can maintain their brightness. If replacement is needed, new veneers can be made in a lighter shade.",
    },
    {
      question: "What happens if a veneer breaks?",
      answer:
        "While porcelain veneers are very strong, if one breaks it will need to be replaced. We keep detailed records of your veneer specifications to ensure perfect color and shape matching for any replacements.",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              The gold standard in cosmetic dentistry - durable, natural-looking
              transformations lasting 10-20 years
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Traditional porcelain veneers are the gold standard in cosmetic
              dentistry, offering unparalleled durability, aesthetics, and
              longevity. These custom-crafted porcelain shells provide
              comprehensive solutions for significant smile makeovers.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <Card className="text-center p-8 bg-gradient-to-br from-pear-gold to-dental-green border-pear-gold">
              ...
              <p className="text-gray-600">
                Years of beautiful, lasting results with proper care and
                maintenance
              </p>
            </Card>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience the premium benefits of the gold standard in cosmetic
              dentistry
            </p>
          </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Get answers to common questions about traditional porcelain
              veneers
            </p>
          </div>
      ...
      <section className="py-16 bg-gradient-to-r from-pear-primary to-dental-green text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Experience the gold standard in cosmetic dentistry with a
            consultation at Pear Tree Dental
          </p>
