...
export const metadata: Metadata = {
  ...
  description:
    "Affordable composite veneers with same-day results. Budget-friendly smile transformation with minimal preparation. Instantly improve your smile in Burton Joyce.",
  keywords: [
  ...
  openGraph: {
    title:
      "Composite Veneers | Same-Day Smile Transformation | Pear Tree Dental",
    description:
      "Affordable composite veneers with same-day results. Budget-friendly smile transformation with minimal preparation.",
    type: "website",
  ...
  const benefits = [
    {
      ...
      description:
        "Complete treatment in a single visit - walk in with concerns and leave with a transformed smile the same day.",
    },
    {
      icon: DollarSign,
      title: "Budget-Friendly",
      description:
        "Significantly more affordable than porcelain alternatives while still delivering excellent aesthetic improvements.",
    },
    {
      icon: Wrench,
      title: "Easily Repairable",
      description:
        "If damaged, composite veneers can often be repaired chair-side without full replacement, saving time and money.",
    },
    {
      icon: Heart,
      title: "Minimal Preparation",
      description:
        "Requires little to no removal of natural tooth structure, preserving your original teeth.",
    },
    {
      icon: Paintbrush2,
      title: "Artistic Customization",
      description:
        "Sculpted directly on your teeth, allowing for real-time adjustments and personalized shaping.",
    },
    {
      icon: RotateCcw,
      title: "Reversible Treatment",
      description:
        "Can be removed if desired, returning teeth to their original state - perfect for trying cosmetic changes.",
    },
  ];
  ...
  const keyAdvantages = [
    {
      ...
      description:
        "Fraction of the cost of porcelain veneers while still providing significant aesthetic improvement",
    },
    {
      icon: Zap,
      title: "Instant Gratification",
      description:
        "See your new smile immediately - no waiting weeks for lab fabrication",
    },
    {
      icon: Hammer,
      title: "Easy Maintenance",
      description:
        "Simple repairs and touch-ups can be done in the office without replacement",
    },
    {
      icon: Repeat,
      title: "Adjustable",
      description:
        "Can be modified, reshaped, or adjusted even after placement",
    },
  ];
  ...
  const considerations = [
    {
      ...
      description:
        "Typically last 5-7 years compared to 10-20 years for porcelain veneers",
    },
    {
      icon: Coffee,
      title: "Stain Susceptibility",
      description:
        "More prone to staining from coffee, wine, and other pigmented foods",
    },
    {
      icon: Star,
      title: "Less Natural Translucency",
      description:
        "May not achieve the same light-reflecting properties as high-end porcelain",
    },
    {
      icon: Wrench,
      title: "More Maintenance",
      description:
        "May require more frequent polishing and touch-ups to maintain appearance",
    },
  ];
  ...
  const treatmentSteps = [
    {
      ...
      description:
        "Discuss your goals, examine your teeth, and select the perfect shade to match or enhance your natural teeth.",
    },
    {
      step: 2,
      title: "Minimal Preparation",
      description:
        "Light surface preparation of teeth to ensure optimal bonding - typically no anesthesia required.",
    },
    {
      step: 3,
      title: "Composite Application",
      description:
        "High-quality composite resin applied in layers and carefully sculpted to create your ideal tooth shape.",
    },
    {
      step: 4,
      title: "Shaping & Polishing",
      description:
        "Precise contouring and high-gloss polishing create natural-looking texture and shine.",
    },
    {
      step: 5,
      title: "Final Adjustments",
      description:
        "Bite check and final refinements ensure comfort and perfect fit with your natural bite pattern.",
    },
  ];
  ...
  const careInstructions = [
    {
      title: "Daily Care",
      description:
        "Brush twice daily with a soft toothbrush and non-abrasive toothpaste. Floss gently around veneer edges.",
      icon: Heart,
    },
    {
      title: "Stain Prevention",
      description:
        "Limit coffee, tea, red wine, and tobacco. Rinse with water after consuming staining substances.",
      icon: Shield,
    },
    {
      title: "Regular Check-ups",
      description:
        "Professional cleanings every 6 months help maintain appearance and identify any needed touch-ups.",
      icon: CalendarDays,
    },
    {
      title: "Protective Habits",
      description:
        "Avoid biting hard objects, nail biting, and teeth grinding. Use a night guard if recommended.",
      icon: ShieldCheck,
    },
  ];
  ...
  const faqs = [
    {
      ...
      answer:
        "Composite veneers typically last 5-7 years with proper care. Their lifespan depends on oral hygiene, eating habits, and lifestyle factors. Regular maintenance and touch-ups can extend their appearance.",
    },
    {
      question: "Can composite veneers be repaired if damaged?",
      answer:
        "Yes! One of the major advantages of composite veneers is that they can often be repaired directly in the dental chair if chipped or damaged, without needing complete replacement.",
    },
    {
      question: "Do composite veneers require special care?",
      answer:
        "They require the same basic care as natural teeth - regular brushing, flossing, and dental visits. However, avoiding staining substances and hard foods will help maintain their appearance longer.",
    },
    {
      question: "How much do composite veneers cost compared to porcelain?",
      answer:
        "Composite veneers are significantly more affordable than porcelain veneers, typically costing 3-5 times less. This makes them an excellent option for budget-conscious patients wanting smile improvements.",
    },
    {
      question: "Can I get composite veneers on just one tooth?",
      answer:
        "Absolutely! Composite veneers are perfect for single tooth corrections, such as repairing a chipped tooth or closing a small gap. The color can be precisely matched to your surrounding teeth.",
    },
    {
      question: "Will composite veneers stain over time?",
      answer:
        "Composite material is more porous than porcelain, so it can pick up stains from coffee, tea, wine, and tobacco over time. However, professional polishing can often restore much of their original brightness.",
    },
    {
      question: "Can I upgrade to porcelain veneers later?",
      answer:
        "Yes! Many patients start with composite veneers to trial their new smile, then upgrade to porcelain veneers later for increased durability and longevity. Your dentist can help plan this transition.",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-8">
              Affordable, same-day smile transformation with minimal preparation
              required
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Composite veneers offer an accessible, same-day solution for smile
              improvement. Using advanced tooth-colored resin materials, these
              veneers can address various cosmetic concerns in a single
              appointment without extensive preparation.
            </p>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Experience immediate smile improvement with budget-friendly,
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              See how your smile can be completely transformed in just one
              appointment
            </p>
          </div>
            ...
            {(sameDayProcess || []).map((step, index) => {
              ...
              return (
                <Card key={index} className="p-6 text-center">
                  ...
                  <div className="font-bold text-pear-primary mb-2">
                    {step.time}
                  </div>
      ...
      <section className="py-16 bg-gradient-to-r from-pear-primary to-dental-green text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Experience instant smile enhancement with affordable composite
            veneers at Pear Tree Dental
          </p>
