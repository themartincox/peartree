...
export const metadata: Metadata = {
  title:
    "NG4 Dentist - Pear Tree Dental | Convenient Dental Care for NG4 Residents",
  description:
    "Local dentist for NG4 postal area including Arnold, Gedling, and new developments. Modern dental care with easy access from all NG4 locations.",
  keywords: [
    "NG4 dentist",
    "dentist NG4",
    "Arnold dentist",
  ...
  openGraph: {
    title:
      "NG4 Dentist - Pear Tree Dental | Convenient Dental Care for NG4 Residents",
    description:
      "Convenient dental care for NG4 residents. Serving Arnold, Gedling, and new developments with modern treatments and family care.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Convenient dental practice serving the NG4 postal area including Arnold, Gedling, and new housing developments.",
            address: {
              "@type": "PostalAddress",
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Easy access dental care for NG4 residents! Serving Arnold,
              Gedling, Carlton, and all the growing communities in the NG4 area.
              Modern treatments, family care, just minutes away.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Easy Access from Across NG4
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Strategic location means quick, convenient journeys from all NG4
                areas. No city center traffic, easy parking, flexible
                appointment times.
              </p>
            </div>
                ...
                <CardContent className="text-center">
                  <div className="space-y-3 text-gray-700">
                    <div className="flex justify-between items-center">
                      <span>Arnold:</span>
                      <span className="font-bold text-dental-green">
                        15 mins
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
              ...
              <Card className="p-6 border border-pear-gold/20 bg-gradient-to-br from-white to-pear-gold/5">
                ...
                <CardContent className="text-center">
                  <p className="text-gray-700 mb-4">
                    Smart route planning means you avoid Nottingham city center
                    completely
                  </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2">
                        New NG4 Developments
                      </h3>
                      <p className="text-gray-700">
                        With new housing estates throughout NG4, we're perfectly
                        positioned to serve growing families and established
                        communities alike.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        We understand NG4 communities - from young families in
                        Arnold to professionals in Gedling. Dental care tailored
                        to your lifestyle.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        From children's first dental visits to family membership
                        plans, we make dental care accessible for every NG4
                        family.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="aspect-[4/3] bg-gradient-to-br from-dental-green/10 to-pear-gold/20 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-600 mb-4">
                        Strategic location for all NG4 communities
                      </p>
                      <div className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Comprehensive Care for NG4 Communities
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Modern dental treatments and services designed for busy NG4
            ...
            <div className="text-center mt-12">
              <div className="bg-gradient-to-r from-dental-green/10 to-pear-gold/10 rounded-2xl p-8 max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 mb-6">
                  <strong>15% off</strong> your first treatment when you
                  register as a new NG4 patient. Plus free dental health
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                What NG4 Residents Say
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real reviews from NG4 communities - Arnold, Gedling, Carlton,
                and beyond
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600">
                Based on 75+ reviews from NG4 area residents
              </p>
            </div>
          </div>
        </div>
