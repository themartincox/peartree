...
export const metadata: Metadata = {
  ...
  description:
    "Sign up for affordable dental membership plans in Burton Joyce. From £14.50/month. Skip NHS waiting lists, get premium care, immediate access to dental treatments.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Sign up for affordable dental membership plans and get immediate access to premium dental care",
    type: "website",
