...
export const metadata: Metadata = {
  title:
    "Teeth Whitening West Bridgford - Professional Whitening | Pear Tree Dental",
  description:
    "Professional teeth whitening for West Bridgford residents. Same-day whitening treatments, Zoom whitening, and take-home kits. Book your consultation today.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Transform your smile with professional teeth whitening in West Bridgford. Advanced whitening treatments with immediate results.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Professional teeth whitening treatments for West Bridgford residents using advanced whitening technology.",
            provider: {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              ...
              just 12 minutes from West Bridgford. Advanced whitening technology
              for immediate, lasting results that West Bridgford professionals
              trust.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Professional Whitening Options for West Bridgford
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Choose from our range of professional whitening treatments, all
                designed to deliver exceptional results for West Bridgford
                residents.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-8">
                  Why West Bridgford Residents Choose Professional Whitening
                </h2>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        optimal results while protecting your teeth and gums
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Convenient Access from West Bridgford
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Professional teeth whitening without the city center hassle.
                Easy journey, free parking, flexible appointment times.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green">
                ...
                <p className="text-gray-700 mb-4">
                  Direct route from West Bridgford via A52 and A612. Avoid city
                  center traffic completely.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-gold">
                ...
                <p className="text-gray-700 mb-4">
                  Evening and weekend appointments available to fit around your
              ...
              <Card className="p-6 border border-pear-primary">
                ...
                <p className="text-gray-700 mb-4">
                  Experienced dental team providing personalized care and
                  attention to detail.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real reviews from West Bridgford residents who've transformed
                their smiles with professional whitening
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white">
              ...
              that comes with a brighter, whiter smile. Book your professional
