...
export const metadata: Metadata = {
  ...
  description: 'Seeking an alternative to Market Street Dental Care Nottingham? Discover Pear Tree Dental in Burton Joyce - suburban tranquility, transparent pricing, stress-free parking.',
  keywords: [
    'Market Street Dental Care alternative',
    'alternative to Market Street Dental Care',
...
const reasonsToSwitch = [
  {
    ...
    description: "Escape the stress of Market Street's busy environment with a relaxed suburban dental experience",
    benefit: "Enjoy a calm, peaceful dental experience away from city center chaos"
  },
  {
    icon: Car,
    title: "Stress-Free Parking",
    description: "Free on-site parking eliminates Market Street parking challenges and costs",
    benefit: "Save money and time on every dental visit"
  },
  {
    icon: CreditCard,
    title: "Transparent Pricing",
    description: "Simple monthly membership eliminates surprise bills and per-treatment charges",
...
const switchingProcess = [
  ...
  },
  {
    ...
    description: "We'll request your records from Market Street Dental Care"
  },
  {
    step: "3",
...
const cityVsSuburban = [
  {
    aspect: "Environment",
    city: "Busy Market Street atmosphere",
    suburban: "Peaceful, relaxed setting",
    advantage: "suburban"
  },
  {
    aspect: "Parking",
    city: "City center parking fees",
    suburban: "Free on-site parking",
    advantage: "suburban"
  },
  {
    aspect: "Traffic Access",
...
const faqs = [
  {
    question: "Why would someone choose Pear Tree Dental as an alternative to Market Street Dental Care?",
    answer: "Common reasons include escaping city center stress, avoiding parking fees and congestion, seeking transparent pricing, and preferring a more relaxed, personalized dental experience in a suburban setting with modern facilities and free parking."
  },
  {
  ...
  {
    question: "Can I transfer my dental records from Market Street Dental Care?",
    answer: "Yes, we can request your dental records from Market Street Dental Care and continue any ongoing treatments. The transition is seamless, and you'll immediately benefit from our suburban environment and membership pricing."
  },
  {
...
export default function MarketStreetDentalCareAlternativePage() {
  return (
      ...
      <nav className="bg-secondary py-3" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li className="text-foreground font-medium">Market Street Dental Care Alternative</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="heading-serif text-4xl md:text-5xl font-bold mb-6 text-primary">
              Looking for an Alternative to Market Street Dental Care?
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Escape the hustle and bustle of Market Street with Pear Tree Dental in Burton Joyce.
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/market-street-dental-care-reviews-nottingham">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold mb-4 text-primary">
                Market Street vs Suburban Dental Experience
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Understanding the fundamental differences between busy city center
                and peaceful suburban dental care experiences.
              </p>
            </div>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-center py-3 px-4 heading-serif font-semibold text-muted-foreground">Market Street</th>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <Card className="bg-accent-gold/10 border-accent-gold/20">
                ...
                <CardContent className="text-center">
                  <p className="text-muted-foreground mb-4">
                    Escape the hustle and bustle of Market Street in our tranquil suburban setting.
                  </p>
              ...
              <Card className="bg-green-50 border-green-200">
                ...
                <CardContent className="text-center">
                  <p className="text-muted-foreground mb-4">
                    Free parking and easy suburban access without Market Street traffic and parking stress.
                  </p>
                  <ul className="text-sm space-y-2">
            ...
            <div className="mt-12 text-center">
              <Card className="bg-primary/5 border-primary/20 p-6">
                <h3 className="heading-serif text-xl font-semibold mb-4">
                  Ready to Escape Market Street Stress?
                </h3>
            ...
            <div className="mt-12 p-6 bg-muted rounded-lg">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Suburban tranquility, no Market Street stress</p>
                </div>
                <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              transparent pricing, and a genuinely relaxed environment away from Market Street chaos.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
