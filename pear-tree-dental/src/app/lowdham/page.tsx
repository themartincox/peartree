...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://peartreedental.co.uk/lowdham'
  }
};
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "LocalBusiness",
            "@id": "https://peartreedental.co.uk/lowdham",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-dental-green font-medium">Serving Lowdham</span>
            </div>

            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              Your Local Dentist
              <span className="text-dental-green block">Near Lowdham</span>
            </h1>
