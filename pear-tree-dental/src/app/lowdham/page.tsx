...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a dentist near Lowdham? Pear Tree Dental in Burton Joyce offers modern dental care, membership plans, and convenient access for Lowdham residents.",
  keywords: [
    "dentist Lowdham",
  ...
  openGraph: {
    title:
      "Dentist in Lowdham - Pear Tree Dental | Modern Dental Care Near You",
    description:
      "Modern dental care for Lowdham residents. Membership plans from £10.95/month. Same-day emergency appointments available.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Modern dental practice serving Lowdham residents with comprehensive dental care and membership plans.",
            address: {
              "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Modern dental care for Lowdham residents at Pear Tree Dental in
              nearby Burton Joyce. Just a short journey for comprehensive dental
              services with transparent membership pricing.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Average drive from Lowdham to our Burton Joyce practice
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Direct route via A612 from Lowdham to Burton Joyce
                  </p>
                </CardContent>
              </Card>
                ...
                [
                  {
                    ...
                    description:
                      "Routine check-ups, cleanings, and preventive care",
                    icon: CheckCircle,
                    features: [
                      "Regular check-ups",
                  ...
                  },
                  {
                    ...
                    description:
                      "Transform your smile with modern cosmetic treatments",
                    icon: Heart,
                    features: [
                      "Teeth whitening",
                      "Veneers",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600">
                Based on 50+ reviews from Lowdham area patients
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-12">
              Join hundreds of local patients who save money with our
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-8 bg-white text-dental-navy">
                <CardHeader className="text-center">
                  ...
                  <div className="text-4xl font-bold text-dental-green">
                    £8.99<span className="text-lg text-gray-600">/month</span>
                  </div>
                </CardHeader>
              ...
              <Card className="p-8 bg-dental-green text-dental-navy">
                <CardHeader className="text-center">
                  ...
                  <div className="text-4xl font-bold">
                    £19.99<span className="text-lg text-gray-700">/month</span>
                  </div>
                </CardHeader>
                <CardContent className="space-y-4">
                  <ul className="space-y-3">
            ...
            <div className="mt-12">
              <Button
                ...
                className="bg-dental-green hover:bg-dental-green/90 text-dental-navy font-semibold px-8 py-4"
              >
                <Link href="/membership">Choose Your Plan</Link>
              </Button>
            </div>
          </div>
        </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <ol className="space-y-2 text-gray-700">
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Head northeast on Main Street toward Nottingham Road
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                      <span className="bg-dental-green text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-semibold mt-0.5 flex-shrink-0">
                    ...
                    <li className="flex items-start space-x-2">
                      ...
                      <span>
                        Pear Tree Dental will be on your left with free parking
                      </span>
                    </li>
                  </ol>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join Lowdham residents who've made the switch to convenient,
