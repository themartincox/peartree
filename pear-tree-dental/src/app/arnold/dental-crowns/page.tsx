...
export const metadata: Metadata = {
  ...
  description:
    "Premium dental crowns for Arnold residents. Same-day CEREC crowns and traditional porcelain options just 15 minutes away. Expert restorative dentistry with 10-year guarantees.",
  keywords: [
  ...
  openGraph: {
    title: "Dental Crowns in Arnold - Same Day CEREC Crowns | Pear Tree Dental",
    description:
      "Premium dental crowns for Arnold residents. Same-day CEREC crowns and expert restorative dentistry just 15 minutes away.",
  ...
  const arnoldCrownsFAQs = [
    {
      ...
      answer:
        "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're one of Nottinghamshire's most advanced crown specialists with same-day CEREC technology and traditional options.",
    },
    {
      question:
        "What types of dental crowns are available for Arnold patients?",
      answer:
        "We offer same-day CEREC crowns, premium porcelain crowns, gold crowns, and zirconia crowns. Each option provides excellent durability and natural aesthetics with 10-year guarantees.",
    },
    {
      question: "Can I get same-day dental crowns near Arnold?",
      answer:
        "Yes! Our CEREC technology allows us to design, mill, and fit your crown in a single appointment. No temporary crowns needed - you leave with your permanent restoration.",
    },
    {
      question: "How long do dental crowns last for Arnold patients?",
      answer:
        "High-quality crowns typically last 10-15 years with proper care. We provide comprehensive aftercare and a 10-year guarantee on all premium crown treatments.",
    },
    {
      question: "What makes your crown service special for Arnold residents?",
      answer:
        "We combine CEREC same-day technology, expert craftsmanship, premium materials, and convenient Arnold access. Our crowns are virtually indistinguishable from natural teeth.",
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        "Return full chewing power and bite strength to damaged teeth",
    },
    {
      icon: Sparkles,
      title: "Natural Aesthetics",
      description:
        "Crowns that perfectly match your natural teeth in color and shape",
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description:
        "Smile with confidence knowing your teeth look and feel natural",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                For Arnold residents needing crown treatment, technology and
                expertise matter. Our advanced dental practice in Burton Joyce
                offers both same-day CEREC crowns and traditional premium
                options with 10-year guarantees, just 15 minutes from Arnold
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From revolutionary same-day CEREC crowns to traditional premium
                porcelain, we offer the complete range of crown solutions for
                every Arnold patient's needs.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the incredible transformations achieved with our advanced
              crown technology
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about advanced crown
                treatments
              </p>
            </div>
                ...
                <div className="text-center">
                  <div className="bg-pear-primary/10 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      State-of-the-art CEREC technology for same-day crowns
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your crown consultation from Arnold — same-day CEREC
              technology, 10-year guarantees, and expert craftsmanship just 15
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free crown consultation worth £150 • Same-day CEREC available •
