...
export const metadata: Metadata = {
  title: "Composite Bonding in Arnold - Affordable Smile Enhancement | Pear Tree Dental",
  description: "Composite bonding for Arnold residents. Affordable same-day smile improvements, gap closure, and tooth reshaping just 15 minutes away. Natural-looking results guaranteed.",
  keywords: [
  ...
  openGraph: {
    title: "Composite Bonding in Arnold - Affordable Smile Enhancement | Pear Tree Dental",
    description: "Composite bonding for Arnold residents. Affordable same-day smile improvements just 15 minutes away with natural-looking results.",
...
export default function ArnoldCompositeBondingPage() {
  const arnoldBondingFAQs = [
    {
      ...
      answer: "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're specialists in aesthetic composite bonding with same-day appointments and natural-looking results."
    },
    {
    ...
    },
    {
      ...
      answer: "High-quality composite bonding typically lasts 5-8 years with proper care. We use premium materials and provide comprehensive aftercare to maximize longevity."
    },
    {
    ...
    },
    {
      ...
      answer: "We combine artistic skill, premium composite materials, same-day treatment, and natural color matching. Our bonding is indistinguishable from natural teeth."
    }
  ];
  ...
  const bondingTreatments = [
    ...
    },
    {
      ...
      teeth: "4-6 teeth",
      price: "From £180",
      benefits: ["Perfect symmetry", "Customized shape", "Immediate improvement"],
      icon: Palette
    },
    {
      name: "Edge Bonding",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/composite-bonding-arnold.jpg",
            "url": "https://peartree.dental/arnold/composite-bonding",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Composite Bonding in <span className="text-pear-gold">Arnold</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Why Arnold Residents Choose Composite Bonding for Smile Enhancement
              </h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                For Arnold residents seeking affordable, immediate smile improvements, composite bonding offers
                the perfect solution. Our artistic composite bonding specialists in Burton Joyce provide
                same-day transformations that look completely natural, just 15 minutes from Arnold.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                treatments offer affordable, immediate improvements for every Arnold patient's needs.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                making it ideal for busy Arnold residents.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about composite bonding treatments
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your bonding consultation from Arnold — same-day results, natural appearance,
              and affordable smile enhancement just 15 minutes from your doorstep.
            </p>
