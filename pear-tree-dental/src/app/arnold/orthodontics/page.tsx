...
export const metadata: Metadata = {
  title:
    "Orthodontics in Arnold - Comprehensive Teeth Straightening | Pear Tree Dental",
  description:
    "Complete orthodontic treatment for Arnold residents. Invisalign, ClearCorrect, and traditional braces for all ages just 15 minutes away. Transform your smile affordably.",
  keywords: [
    "orthodontics Arnold",
  ...
  openGraph: {
    title:
      "Orthodontics in Arnold - Comprehensive Teeth Straightening | Pear Tree Dental",
    description:
      "Complete orthodontic treatment for Arnold residents. All teeth straightening options for adults and teens just 15 minutes away.",
  ...
  const arnoldOrthodonticsFAQs = [
    {
      ...
      answer:
        "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We're comprehensive orthodontic specialists offering all teeth straightening options for adults and teens.",
    },
    {
      question: "What orthodontic options are available for Arnold patients?",
      answer:
        "We offer Invisalign, ClearCorrect clear aligners, traditional braces, and ceramic braces. Each option suits different needs, budgets, and lifestyle preferences.",
    },
    {
      question: "Do you provide adult orthodontics near Arnold?",
      answer:
        "Absolutely! Over 50% of our orthodontic patients are adults. We specialize in discreet options like Invisalign and clear aligners perfect for working professionals.",
    },
    {
      question: "How long does orthodontic treatment take?",
      answer:
        "Treatment time varies: clear aligners 6-18 months, traditional braces 12-24 months. We'll provide an accurate timeline during your consultation based on your specific case.",
    },
    {
      question:
        "What makes your orthodontic service special for Arnold residents?",
      answer:
        "We combine all modern orthodontic options, flexible payment plans, expert treatment planning, and convenient Arnold access. Every smile is individually designed.",
    },
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            medicalSpecialty:
              "Orthodontics - Comprehensive Teeth Straightening",
            geo: {
              "@type": "GeoCoordinates",
              latitude: 52.97335,
              longitude: -1.04211,
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                For Arnold families seeking professional teeth straightening,
                having all options under one roof matters. Our comprehensive
                orthodontic practice in Burton Joyce offers every modern teeth
                straightening solution for children, teens, and adults, just 15
                minutes from Arnold with flexible payment plans.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                From invisible clear aligners to traditional braces, we offer
                every modern orthodontic solution to straighten teeth for
                patients of all ages from Arnold.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {(orthodonticOptions || []).map((option, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="hover:shadow-xl transition-shadow border-2 border-gray-200 hover:border-pear-primary relative"
                  >
                    {option.highlight && (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Whether you're 7 or 70, it's never too early or too late to
                achieve the smile you deserve. We provide age-appropriate
                orthodontic solutions for every stage of life.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the incredible smile transformations achieved with our
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about comprehensive
                ...
                <div className="text-center">
                  <div className="bg-pear-primary rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      Perfect for families with multiple treatment needs
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your orthodontic consultation from Arnold — all modern teeth
              straightening options, flexible payment plans, and expert care
              just 15 minutes from your doorstep.
            </p>
            ...
            <div className="bg-white rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free orthodontic consultation worth £200 • Family discounts
                available • 0% interest financing
              </p>
            </div>
