...
export const metadata: Metadata = {
  title:
    "Emergency Dentist in Arnold - Same Day Dental Pain Relief | Pear Tree Dental",
  description:
    "Emergency dentist for Arnold residents. Same-day appointments for dental pain, broken teeth, and urgent dental problems. Just 15 minutes away with immediate relief.",
  keywords: [
  ...
  openGraph: {
    title:
      "Emergency Dentist in Arnold - Same Day Dental Pain Relief | Pear Tree Dental",
    description:
      "Emergency dental care for Arnold residents. Same-day appointments for dental pain and urgent problems just 15 minutes away.",
  ...
  const arnoldEmergencyFAQs = [
    {
      ...
      answer:
        "We often have same-day emergency appointments available. Call us immediately on 0115 931 2935 and we'll do our best to see you the same day, just 15 minutes from Arnold.",
    },
    {
      question: "What dental emergencies do you treat for Arnold patients?",
      answer:
        "We treat all dental emergencies including severe toothache, broken teeth, knocked-out teeth, lost fillings, dental abscesses, and trauma. Pain relief is our immediate priority.",
    },
    {
      question: "Can I get emergency dental care at weekends from Arnold?",
      answer:
        "Yes, we provide emergency dental services including weekends and evenings. Call our emergency line and we'll arrange urgent care for Arnold patients experiencing dental pain.",
    },
    {
      question: "What should I do if I have a dental emergency in Arnold?",
      answer:
        "Call us immediately on 0115 931 2935. For severe pain, take over-the-counter painkillers as directed. For knocked-out teeth, place in milk and come immediately - we're just 15 minutes away.",
    },
    {
      question: "Do you accept NHS patients for emergency dental care?",
      answer:
        "Yes, we accept both NHS and private patients for emergency dental care. We'll treat your emergency first and discuss payment options during your visit.",
    },
  ];
  ...
  const emergencyTypes = [
    {
      ...
      description:
        "Immediate pain relief and treatment for dental pain that won't go away",
      urgency: "Immediate",
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Emergency replacement of lost dental work to prevent further damage",
    ...
    },
    {
      ...
      description:
        "Urgent treatment for abscesses and infected teeth with swelling",
      urgency: "Immediate",
    },
    {
      icon: Heart,
      ...
      description:
        "Emergency re-implantation - time critical, call immediately",
      urgency: "60 minutes",
    },
    {
      icon: PhoneCall,
      title: "Dental Trauma",
      description:
        "Comprehensive care for facial and dental injuries from accidents",
      urgency: "Immediate",
    },
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://peartree.dental/images/emergency-dentist-arnold.jpg",
            url: "https://peartree.dental/arnold/emergency-dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              ...
              <span className="text-yellow-300">Arnold</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  className="bg-yellow-400 hover:bg-yellow-300 text-red-800 px-8 py-4 text-lg font-bold rounded-full animate-pulse"
                >
            ...
            <div className="mt-8 text-yellow-200">
              ...
              <p className="text-sm opacity-90">
                Same-day appointments • Pain relief priority • Arnold patients
                welcome
              </p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                When dental emergencies strike in Arnold, you need immediate
                professional care. Our emergency dental service is just 15
                minutes away in Burton Joyce, offering same-day appointments,
                immediate pain relief, and comprehensive emergency treatment.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <Card className="text-center hover:shadow-lg transition-shadow border-l-4 border-red-500">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Emergency appointments available within hours, not days
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow border-l-4 border-pear-primary">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Immediate pain management while we treat the underlying
                    problem
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow border-l-4 border-dental-green">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Full emergency treatment to resolve problems permanently
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Don't suffer in silence. We provide immediate care for all types
                of dental emergencies, ensuring Arnold residents get the urgent
                treatment they need quickly and effectively.
              </p>
            </div>
            ...
            <div className="text-center bg-red-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Dental emergencies can worsen rapidly. The sooner you call, the
                better we can help relieve your pain and prevent further
                complications.
              </p>
              <a href="tel:01159312935">
                <Button
                ...
                <CardContent className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p>
                      ...
                      <strong>0115 931 2935</strong>
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-500 mt-1 flex-shrink-0" />
                    <p>
                      Take over-the-counter painkillers as directed on packaging
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-red-500 mt-1 flex-shrink-0" />
              ...
              <Card className="border-l-4 border-pear-primary">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-pear-primary mt-1 flex-shrink-0" />
                    <p>
                      Clear directions: 22 Nottingham Road, Burton Joyce, NG14
                      5AE
                    </p>
                  </div>
                  <div className="flex items-start gap-3">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about emergency dental
                care
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    <p>
                      ...
                      Take A6097 towards Lowdham
                    </p>
                    <p>
                      <span className="font-semibold text-red-600">2.</span>{" "}
                      Continue for 8 miles through Gedling
                    </p>
                    <p>
                      <span className="font-semibold text-red-600">3.</span>{" "}
                      Turn right into Burton Joyce
                    </p>
                    <p>
                      <span className="font-semibold text-red-600">4.</span>{" "}
                      We're at 22 Nottingham Road (NG14 5AE)
                    </p>
                    <p className="text-red-600 font-bold">
                      Emergency journey time: 15 minutes
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-red-50 rounded-lg p-6 border-2 border-red-200">
                    ...
                    <p className="text-gray-600">
                      Emergency patients seen immediately upon arrival
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Call our emergency line now for immediate dental care. Same-day
              appointments available for Arnold patients experiencing dental
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Immediate pain relief • Same-day appointments • NHS & private
                patients welcome
              </p>
            </div>
