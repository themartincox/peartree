...
export const metadata: Metadata = {
  title:
    "Teeth Whitening in Arnold - Professional Whitening Near You | Pear Tree Dental",
  description:
    "Professional teeth whitening for Arnold residents. Enlighten and boutique whitening just 15 minutes away in Burton Joyce. Guaranteed results with free parking.",
  keywords: [
  ...
  openGraph: {
    title:
      "Teeth Whitening in Arnold - Professional Whitening Near You | Pear Tree Dental",
    description:
      "Professional teeth whitening treatments for Arnold residents. Enlighten and boutique options available just 15 minutes away.",
...
export default function ArnoldTeethWhiteningPage() {
  const arnoldWhiteningFAQs = [
    {
      question:
        "How far is professional teeth whitening from Arnold town centre?",
      answer:
        "Pear Tree Dental is just 15 minutes from Arnold via the A6097. We offer professional Enlighten and boutique whitening systems with guaranteed results and free parking.",
    },
    {
      question:
        "What teeth whitening options are available for Arnold patients?",
      answer:
        "We offer two premium whitening systems: Enlighten (the only guaranteed whitening system) and Boutique whitening. Both are safe, effective, and perfect for Arnold's busy professionals.",
    },
    {
      question:
        "Can I get same-day teeth whitening consultation in Arnold area?",
      answer:
        "Yes! We often have same-day availability for whitening consultations. We can assess your teeth, discuss options, and often start treatment on the same visit.",
    },
    {
      question:
        "How long does professional teeth whitening take for Arnold patients?",
      answer:
        "Enlighten treatment takes 2 weeks with custom trays at home, followed by a 1-hour in-practice session. Boutique whitening can be completed in just 1-2 weeks at home.",
    },
    {
      question: "Is teeth whitening safe for sensitive teeth?",
      answer:
        "Absolutely. Both our Enlighten and Boutique systems are designed for sensitive teeth. We provide desensitising gel and adjust treatment to ensure your comfort throughout.",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Arnold's professionals know that a bright, confident smile makes
                all the difference. Our premium whitening treatments are perfect
                for busy Arnold lifestyles - just 15 minutes away in Burton
                Joyce with guaranteed results and free parking.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Enlighten system guarantees B1 shade - the whitest natural
                    tooth shade possible
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Complete treatment in just 2-3 weeks with minimal disruption
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600">
                    Professional-grade systems designed for sensitive teeth
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We offer two premium whitening systems perfect for Arnold's busy
                professionals who want guaranteed results without the hassle of
              ...
              <Card className="border-2 border-pear-gold hover:shadow-xl transition-shadow">
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Guaranteed to reach B1 shade or your money back
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Virtually no sensitivity with revolutionary formula
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <p className="text-sm text-gray-600">
                      Complete treatment including custom trays
                    </p>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Professional strength formula for dramatic whitening
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Day or night wear options to suit your schedule
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        Professional results at an accessible price
                      </p>
                    </div>
                  </div>
                  <div className="pt-4 border-t">
                    ...
                    <p className="text-sm text-gray-600">
                      Complete treatment with custom trays
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Whitest natural tooth shade guaranteed
                </p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-pear-primary mb-2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the dramatic transformations achieved with our professional
              whitening systems
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from our Arnold patients about professional
                whitening
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-pear-primary rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      No parking stress - dedicated spaces for all patients
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Book your professional whitening consultation from Arnold —
              guaranteed results, no sensitivity, and the whitest natural shade
            ...
            <div className="bg-white rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free whitening consultation worth £75 • 0% interest payment
                plans available
              </p>
            </div>
