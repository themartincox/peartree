...
export const metadata: Metadata = {
  title:
    "Family Dental Implants in Gedling - Practical Tooth Replacement for Working Families | Pear Tree Dental",
  description:
    "Family dental implants for Gedling working families. Practical tooth replacement solutions, flexible payment plans, and family-focused care. Quick drive from Gedling NG4.",
  keywords: [
  ...
  openGraph: {
    title:
      "Family Dental Implants in Gedling - Practical Tooth Replacement for Working Families | Pear Tree Dental",
    description:
      "Family dental implants for Gedling working families. Practical tooth replacement solutions with flexible payment plans.",
...
export default function GedlingFamilyDentalImplantsPage() {
  const gedlingImplantsFAQs = [
    {
      question:
        "How practical are dental implants for working families from Gedling?",
      answer:
        "Dental implants are actually very practical for working families. While the initial investment is higher, they last 20-30 years and don't require special maintenance like dentures. We offer flexible payment plans from £150/month to make implants accessible to Gedling working families.",
    },
    {
      question: "Can multiple family members get implants with payment plans?",
      answer:
        "Absolutely! We often help families coordinate implant treatment with staggered timing and combined payment plans. This allows families to spread the investment over time while ensuring everyone gets the tooth replacement they need.",
    },
    {
      question:
        "How do implants compare to other tooth replacement options for busy families?",
      answer:
        "Implants are the most convenient option for busy working families. Unlike dentures that need daily removal and cleaning, or bridges that require special flossing, implants are brushed and cared for just like natural teeth - perfect for hectic schedules.",
    },
    {
      question:
        "What's the time commitment for implant treatment from Gedling?",
      answer:
        "Initial consultation and implant placement typically takes 1-2 hours. The implant heals for 3-6 months, then the crown is fitted in another 1-hour appointment. Being just a quick drive from Gedling makes these appointments very manageable.",
    },
    {
      question:
        "Are dental implants worth the investment for working families?",
      answer:
        "Yes! When you consider implants last 20-30 years without replacement, they're often more cost-effective than bridges or dentures long-term. Plus, they preserve jawbone health and adjacent teeth, preventing costly problems later.",
    },
  ];
  ...
  const implantOptions = [
    ...
    },
    {
      ...
      description:
        "Replace 3-4 missing teeth with 2 implants supporting bridge",
  ...
  const practicalBenefits = [
    {
      ...
      description:
        "Implants last 20-30 years, making them cost-effective over time",
    ...
    },
    {
      ...
      description:
        "Brush and floss like natural teeth - perfect for busy families",
    ...
    },
    {
      ...
      description:
        "Spread investment over 18-24 months with affordable monthly payments",
  ...
  const familyScenarios = [
    {
      ...
      implantSolution:
        "Single implant restores full chewing function and prevents teeth moving",
      familyBenefit: "Can enjoy family meals again, no dietary restrictions",
      longTermValue:
        "Prevents need for costly orthodontics or further tooth loss",
    ...
    },
    {
      ...
      implantSolution:
        "Implant provides permanent, natural-looking replacement",
      familyBenefit:
        "Confident smile for school, social activities, and future career",
      longTermValue:
        "Investment lasts into adulthood, avoiding repeated treatments",
      practicalAspect: "No removable appliance affecting speech or eating",
    },
    {
      scenario: "Multiple Family Members Needing Treatment",
      challenge:
        "Several family members have different tooth replacement needs",
      implantSolution:
        "Coordinated treatment plan with staggered timing and combined financing",
      familyBenefit:
        "Whole family gets optimal treatment within manageable budget",
      longTermValue: "Family-wide investment in long-term oral health",
      practicalAspect:
        "Coordinated appointments minimize disruption to work schedules",
    },
    {
      scenario: "Working Parent's Denture Problems",
      challenge: "Ill-fitting dentures affecting work confidence and nutrition",
      implantSolution:
        "Implant-supported dentures or individual implants for stability",
      familyBenefit:
        "Parent regains eating ability and professional confidence",
      longTermValue: "No ongoing denture adjustments or replacements needed",
      practicalAspect:
        "Fixed teeth don't slip during important work presentations",
    },
  ];
  ...
  const investmentStrategies = [
    {
      ...
      approach:
        "Spread implant costs over 18-24 months with 0% interest options",
    ...
    },
    {
      ...
      value:
        "Avoids costs of bone grafts, orthodontics, or additional tooth loss",
    },
    {
      strategy: "Family Coordination Planning",
      approach:
        "Plan multiple family members' treatments for maximum efficiency",
    ...
    },
    {
      ...
      approach:
        "Coordinate treatment timing to maximize dental insurance benefits",
    ...
    },
    {
      ...
      approach:
        "Consider implants as investment in health, nutrition, and confidence",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://peartree.dental/images/family-dental-implants-gedling.jpg",
            url: "https://peartree.dental/gedling/family-dental-implants",
            ...
            medicalSpecialty:
              "Dental Implantology - Family Tooth Replacement Solutions",
            geo: {
              "@type": "GeoCoordinates",
              latitude: 52.97335,
              longitude: -1.04211,
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Gedling — Permanent tooth replacement from
                £2,400 with payment plans
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🦷 Practical, long-lasting tooth replacement with payment plans
                for Gedling families!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Gedling working families need tooth
                replacement solutions that offer excellent long-term value and
                convenience. Dental implants provide the most practical,
                permanent solution that fits busy lifestyles.
              </p>
            </div>
            ...
            <div className="text-center bg-blue-50 rounded-lg p-8">
              ...
              <h3 className="text-2xl font-bold text-pear-primary mb-4">
                Smart Investment in Permanent Tooth Replacement
              </h3>
              <p className="text-lg text-gray-600 mb-6">
                We understand that Gedling working families make careful
                decisions about major investments. Dental implants offer the
                best combination of longevity, convenience, and value for busy
                families.
              </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                permanent tooth replacement solutions that work for working
                family budgets and lifestyles.
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Real Family Situations Where Implants Provide Practical
                Solutions
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Understanding how dental implants solve real problems for
                working families helps Gedling families make informed decisions
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Implants vs Other Options: Practical Comparison for Working
                Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Understanding how implants compare to bridges and dentures helps
                Gedling working families choose the most practical tooth
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>Overall Winner for Working Families:</strong> Dental
                implants provide the best combination of convenience, longevity,
                and functionality for busy Gedling families.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Practical approaches to making dental implants affordable and
                accessible for working family budgets while maximizing long-term
                value.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Affordable 18-month payment plan
                </p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-blue-600 mb-2">
                ...
                <p className="text-gray-600">
                  Avoided expensive future treatments
                </p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-blue-600 mb-2">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the natural, long-lasting results achieved with our practical
              implant solutions
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Gedling working families about practical
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center">
                  <div className="bg-blue-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      Practical tooth replacement solutions
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Invest in Permanent Tooth Replacement That Works for Your Family
              from Gedling
            </h2>
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Don't let missing teeth affect your family's nutrition,
              confidence, and oral health. Book practical dental implant
              consultation with payment plans designed for working families.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Practical solutions • Payment plans available • 20-30 year
                lifespan • Quick drive from Gedling
              </p>
            </div>
