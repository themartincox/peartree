...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "professional whitening Gedling",
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                What Gedling Families Say About Our Affordable Whitening
              </h2>
            </div>

            <TestimonialBanner
              text="I'd been wanting whiter teeth for years but thought professional whitening was out of our budget. Being just a quick drive from Gedling made it convenient to pop in for a consultation. When they explained the payment plan options, it suddenly became affordable! The home whitening kit was so easy to use, and the results are amazing - my teeth are 5 shades whiter! It's given me so much more confidence at work and in photos. Best money I've spent in ages!"
              author="Lisa K. from Gedling, NG4"
              className="mb-8"
            />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              ...
              description="Gedling working family's amazing transformation with payment plan"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <FAQSection faqs={gedlingWhiteningFAQs} />
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Affordable Professional Whitening - Quick Drive from Gedling
            </h2>
