...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Children's Dentistry in Gedling - Convenient Care for Working Parents | Pear Tree Dental",
    description: "Children's dentistry for Gedling working families. Convenient appointments and gentle, child-friendly care.",
...
export default function GedlingChildrensDentistryPage() {
  const gedlingChildrensFAQs = [
    {
      question: "How convenient is children's dental care from Gedling for working parents?",
      answer: "We understand working parents in Gedling have packed schedules. We offer early morning, after-school, and Saturday appointments for children. Being just a quick drive from Gedling, we can often fit urgent appointments into busy work schedules."
    },
    {
      question: "What age should children start visiting the dentist?",
      answer: "We recommend children visit by their first birthday or within 6 months of their first tooth appearing. Early visits help children become comfortable with dental care and allow us to monitor development and provide preventive guidance to Gedling parents."
    },
    {
    ...
    },
    {
      ...
      answer: "We provide comprehensive preventive care including fluoride applications, dental sealants, oral hygiene instruction, and dietary advice. Our focus on prevention helps Gedling working families avoid costly problems and emergency dental visits."
    },
    {
      question: "How do you coordinate appointments for working family schedules?",
      answer: "We can often schedule multiple children together or coordinate with parent appointments to save time. We offer flexible scheduling including school holiday appointments and can provide appointment reminders to help busy Gedling families stay organized."
    }
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/childrens-dentistry-gedling.jpg",
            "url": "https://peartree.dental/gedling/childrens-dentistry",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Children's Dentistry in <span className="text-yellow-300">Gedling</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Gedling — Gentle, child-friendly care with flexible scheduling
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">👶 Gentle, convenient children's dental care for busy Gedling families!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that working parents in Gedling need children's dental care that fits busy schedules.
            ...
            <div className="text-center bg-green-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We know that Gedling working parents need children's dental care that's convenient, gentle, and effective.
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our prevention-focused approach helps Gedling working families avoid
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See how our gentle, prevention-focused approach keeps Gedling children healthy and smiling
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Gedling working parents about convenient children's dental care
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Give Your Children the Best Start with Convenient Dental Care from Gedling
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Gentle, child-friendly care • Flexible scheduling • Prevention focus • Quick drive from Gedling
              </p>
            </div>
