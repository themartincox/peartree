...
export const metadata: Metadata = {
  title:
    "Composite Bonding in Gedling - Affordable Smile Improvements for Working Families | Pear Tree Dental",
  description:
    "Composite bonding for Gedling working families. Affordable smile improvements, same-day treatment, and flexible payment options. Quick drive from Gedling NG4.",
  keywords: [
  ...
  openGraph: {
    title:
      "Composite Bonding in Gedling - Affordable Smile Improvements for Working Families | Pear Tree Dental",
    description:
      "Composite bonding for Gedling working families. Affordable smile improvements with same-day treatment and flexible payment options.",
...
export default function GedlingCompositeBondingPage() {
  const gedlingBondingFAQs = [
    {
      question:
        "How affordable is composite bonding from Gedling for working families?",
      answer:
        "Composite bonding is one of the most cost-effective cosmetic treatments available. Starting from £120 per tooth with payment plan options, it's accessible to Gedling working families. We provide transparent pricing and honest advice about what bonding can achieve for your smile.",
    },
    {
      question: "Can composite bonding be completed in one visit?",
      answer:
        "Yes! Most composite bonding treatments can be completed in a single visit lasting 1-2 hours. This makes it perfect for busy working families from Gedling who want smile improvements without multiple appointments disrupting their schedule.",
    },
    {
      question: "How long does composite bonding last?",
      answer:
        "With proper care, composite bonding typically lasts 5-8 years. We provide detailed aftercare instructions and can perform touch-ups if needed. The investment in bonding provides excellent value for improving your smile and confidence.",
    },
    {
      question: "What smile problems can composite bonding fix?",
      answer:
        "Bonding can address chipped teeth, gaps between teeth, discoloration, slightly crooked teeth, and worn edges. We assess each case honestly and explain what bonding can achieve versus other treatments, helping Gedling families choose the best option.",
    },
    {
      question: "Do you offer payment plans for composite bonding?",
      answer:
        "Yes! We understand working families need flexible payment options. We offer interest-free payment plans to spread bonding costs over 6-12 months, making smile improvements affordable for Gedling families on any budget.",
    },
  ];
  ...
  const affordableBenefits = [
    {
      ...
      description:
        "Most affordable cosmetic dental treatment for smile improvement",
    ...
    },
    {
      ...
      description:
        "Complete treatment in one visit with immediate transformation",
    ...
    },
    {
      ...
      description:
        "Minimal tooth preparation required, preserves natural teeth",
  ...
  const bondingApplications = [
    {
      ...
      bondingSolution:
        "Composite carefully matched and sculpted to restore tooth shape",
      appearance: "Natural-looking repair that blends seamlessly",
      durability: "5-8 years with proper care",
      workingFamilyBenefit:
        "Quick fix prevents embarrassment at work and social situations",
    },
    {
      issue: "Gap Between Front Teeth",
      bondingSolution:
        "Composite added to adjacent teeth to close gap completely",
      appearance:
        "Smooth, natural tooth contours without orthodontic treatment",
    ...
    },
    {
      ...
      workingFamilyBenefit:
        "Professional appearance improvement in single visit",
    },
    {
      issue: "Worn Tooth Edges",
      bondingSolution:
        "Composite rebuilds worn edges to restore natural tooth length",
      appearance: "Youthful tooth proportions and improved smile line",
      durability: "Protects teeth from further wear",
      workingFamilyBenefit:
        "Reverses aging effects for more confident professional image",
    },
  ];
  ...
  const affordabilityStrategies = [
    ...
    },
    {
      ...
      savings:
        "Bonding now can prevent need for crowns or veneers worth thousands",
    },
    {
      strategy: "Conservative Treatment Choice",
      approach:
        "Choose bonding over more expensive alternatives when appropriate",
    ...
    },
    {
      ...
      savings:
        "Good care extends lifespan, reducing need for early replacement",
    },
  ];
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            image:
              "https://peartree.dental/images/composite-bonding-gedling.jpg",
            url: "https://peartree.dental/gedling/composite-bonding",
            ...
            medicalSpecialty:
              "Cosmetic Dentistry - Affordable Composite Bonding",
            geo: {
              "@type": "GeoCoordinates",
              latitude: 52.97335,
              longitude: -1.04211,
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                ✨ Same-day smile improvements with affordable payment plans for
                Gedling families!
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Composite bonding offers the most cost-effective way to
                dramatically improve your smile. Perfect for Gedling working
                families who want beautiful results without the high costs of
                veneers or lengthy orthodontic treatment.
              </p>
            </div>
            ...
            <div className="text-center bg-pink-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                We understand that Gedling working families want smile
                improvements that fit their budget and busy schedule. Composite
                bonding delivers instant results in a single visit with
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-gray-600">
                    Most affordable cosmetic treatment
                  </p>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-pink-600 mb-2">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Choose from our range of composite bonding treatments designed
                to provide maximum smile improvement at prices that work for
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
              {(bondingOptions || []).map((option, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="hover:shadow-lg transition-shadow border-2 border-gray-200 hover:border-pink-400"
                  >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Composite bonding can address many common smile concerns that
                affect confidence and professional appearance for Gedling
                working families.
              </p>
            </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="bg-pink-50 rounded-lg p-3">
                        ...
                        <p className="text-sm text-pink-700">
                          {application.workingFamilyBenefit}
                        </p>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Understanding how bonding compares to other smile improvement
                options helps Gedling working families make the best choice for
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>Overall Winner for Working Families:</strong> Composite
                bonding provides the best combination of affordability, speed,
                and results for busy Gedling families seeking smile
                improvements.
              </p>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Making Smile Improvements Affordable for Gedling Working
                Families
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Smart strategies to get maximum smile improvement value that
                works within working family budgets and busy schedules.
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the dramatic smile improvements achieved with affordable
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Don't let budget concerns stop you from having the confident smile
              you deserve. Book same-day composite bonding with payment plans
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Same-day results • Payment plans available • Natural appearance
