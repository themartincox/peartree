...
export const metadata: Metadata = {
  ...
  description:
    "Looking for a dentist near Gedling? Pear Tree Dental in Burton Joyce offers modern dental care, membership plans, and convenient access for Gedling residents.",
  keywords: [
    "dentist Gedling",
  ...
  openGraph: {
    title:
      "Dentist in Gedling - Pear Tree Dental | Modern Dental Care Near You",
    description:
      "Modern dental care for Gedling residents. Membership plans from £10.95/month. Same-day emergency appointments available.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Modern dental practice serving Gedling residents with comprehensive dental care and membership plans.",
            address: {
              "@type": "PostalAddress",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Modern dental care for Gedling residents at Pear Tree Dental in
              nearby Burton Joyce. Just a 12-minute journey for comprehensive
              dental services with transparent membership pricing.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Average drive from Gedling to our Burton Joyce practice
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-dental-green/20">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Direct route via A612 from Gedling
                  </p>
                </CardContent>
              </Card>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mt-12 text-center">
              ...
              <p className="text-gray-600">
                Based on 25+ reviews from Gedling area patients
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  ...
                  <div className="mt-4 p-3 bg-dental-green/10 rounded">
                    <p className="text-sm text-dental-navy">
                      <strong>Tip:</strong> Straight shot on A612 from Gedling -
                      one of our easiest routes!
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Join Gedling residents who've made the switch to convenient,
