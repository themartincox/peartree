...
export const metadata: Metadata = {
  title: 'Smile Design West Bridgford - Complete Smile Makeovers | Pear Tree Dental',
  description: 'Comprehensive smile design for West Bridgford residents. Veneers, crowns, whitening, and smile makeovers. Transform your smile with expert cosmetic dentistry.',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Transform your smile with comprehensive smile design in West Bridgford. Expert cosmetic dentistry and smile makeovers.',
    ...
    <div className="min-h-screen bg-dental-navy text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Comprehensive smile design and makeover treatments for West Bridgford residents using advanced cosmetic dentistry techniques.",
            "provider": {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Transform your smile with comprehensive smile design and makeovers. Expert cosmetic dentistry
              combining veneers, crowns, whitening, and alignment for West Bridgford's discerning residents.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Comprehensive Smile Design for West Bridgford</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                From subtle enhancements to complete smile transformations, our expert team creates beautiful, natural-looking results.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 border border-dental-green/20 bg-gradient-to-br from-white to-dental-green/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">Comprehensive smile transformation package</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
              ...
              <Card className="p-6 border border-pear-primary/20 bg-gradient-to-br from-white to-pear-primary/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">Subtle improvements for natural enhancement</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Your Smile Design Journey</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A comprehensive process designed to create your perfect smile with precision and care
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Comprehensive assessment of your smile, facial features, and goals",
                  icon: Users,
                  time: "60 minutes"
                },
                {
                  ...
                  description: "3D modeling and digital preview of your new smile options",
                  icon: Camera,
                  time: "45 minutes"
                },
                {
                  ...
                  description: "Detailed treatment plan with timeline and investment options",
                  icon: CheckCircle,
                  time: "30 minutes"
                },
                {
                  ...
                  description: "Precise implementation of your personalized smile design",
                  icon: Crown,
                  time: "2-6 visits"
                }
              ].map((step, index) => {
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Smile Design Treatment Options</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Multiple treatment approaches to achieve your perfect smile, tailored to your needs and lifestyle
              </p>
            </div>
              ...
              {[
                {
                  ...
                  icon: Crown,
                  features: ["Natural appearance", "Stain resistant", "Long-lasting", "Minimal preparation"],
                ...
                },
                {
                  ...
                  icon: Palette,
                  features: ["Same-day treatment", "Conservative approach", "Reversible option", "Cost-effective"],
                ...
                },
                {
                  ...
                  icon: Shield,
                  features: ["Complete protection", "Natural strength", "Color matched", "Durable solution"],
                ...
                },
                {
                  ...
                  icon: Sparkles,
                  features: ["Immediate results", "Safe procedure", "Long-lasting", "Confidence boost"],
                  price: "From £395",
                ...
                },
                {
                  ...
                  icon: Heart,
                  features: ["Precise shaping", "Immediate results", "Comfortable procedure", "Enhanced proportions"],
                  price: "From £295",
                ...
                },
                {
                  ...
                  icon: Eye,
                  features: ["Nearly invisible", "Removable", "Predictable results", "Professional grade"],
                  price: "From £2,800",
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Expert Smile Design from West Bridgford</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                World-class cosmetic dentistry without the city center hassle. Convenient access and expert care for discerning West Bridgford residents.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <p className="text-gray-700 mb-4">
                  Just 12 minutes from West Bridgford with easy parking and countryside route.
                </p>
              ...
              <Card className="p-6 border border-pear-gold/20">
                ...
                <p className="text-gray-700 mb-4">
                  Highly experienced cosmetic dentists with extensive smile design expertise.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-primary/20">
                ...
                <p className="text-gray-700 mb-4">
                  Extended hours and weekend appointments to fit your professional schedule.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">West Bridgford Smile Transformations</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real stories from West Bridgford residents who've transformed their confidence with smile design
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Join West Bridgford residents who've discovered the confidence that comes with a perfectly designed smile.
              Book your comprehensive smile design consultation today.
            </p>
