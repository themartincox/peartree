...
export const metadata: Metadata = {
  title: 'Looking for an Alternative to Impressions Dental Care? Consider Pear Tree Dental',
  description: 'Seeking an alternative to Impressions Dental Care? Discover Pear Tree Dental in Burton Joyce - modern technology, transparent membership pricing, purpose-built facilities.',
  keywords: [
    'Impressions Dental Care alternative',
    'alternative to Impressions Dental Care',
    'modern dental practice Nottingham',
    'Burton Joyce dentist',
    'dental membership plans',
    'private dental alternative'
  ],
  openGraph: {
    title: 'Looking for an Alternative to Impressions Dental Care? Consider Pear Tree Dental',
    description: 'Upgrade to modern dental care with state-of-the-art technology and transparent membership pricing.',
    url: 'https://peartreedental.co.uk/impressions-dental-care-alternative-nottingham'
  },
  alternates: {
    canonical: 'https://peartreedental.co.uk/impressions-dental-care-alternative-nottingham'
  }
};
...
const reasonsToSwitch = [
  ...
  },
  {
    ...
    description: "Simple monthly membership eliminates unpredictable private fees and hidden charges",
    benefit: "Budget confidently with clear, predictable monthly expenses"
  },
  {
    icon: Star,
    title: "Exceptional Patient Experience",
    description: "Personalized care with longer appointment times and genuine attention to patient comfort",
    benefit: "Experience dental care that puts your needs and comfort first"
  }
];
...
const switchingProcess = [
  ...
  },
  {
    ...
    description: "We'll request your dental records from Impressions Dental Care"
  },
  {
    step: "3",
...
const privateVsMembership = [
  {
    aspect: "Technology",
    private: "Standard dental equipment",
    membership: "Latest digital technology",
    advantage: "membership"
  },
  {
    aspect: "Facilities",
    private: "Traditional practice setup",
    membership: "Purpose-built modern design",
    advantage: "membership"
  },
  {
    aspect: "Pricing Model",
    private: "Variable private charges",
    membership: "Transparent membership plans",
    advantage: "membership"
  },
  {
    aspect: "Accessibility",
    private: "Standard accessibility",
    membership: "Fully accessible design",
    advantage: "membership"
  },
  {
  ...
  {
    aspect: "Parking",
    private: "Limited parking options",
    membership: "Free on-site parking",
    advantage: "membership"
  }
];
...
const faqs = [
  {
    question: "Why would someone choose Pear Tree Dental as an alternative to Impressions Dental Care?",
    answer: "Common reasons include seeking modern digital technology, purpose-built facilities, transparent pricing, advanced equipment, better value with membership plans, and a practice designed specifically for contemporary dental care with comprehensive benefits."
  },
  {
    question: "How do modern dental facilities benefit patients compared to traditional private practices?",
  ...
  {
    question: "Can I transfer my dental records from Impressions Dental Care?",
    answer: "Yes, we can request your dental records from Impressions Dental Care and continue any ongoing treatments. Our team will create a seamless transition plan using our modern facilities and advanced technology."
  },
  {
    question: "What are the benefits of membership plans over traditional private fees?",
...
export default function ImpressionsDentalCareAlternativePage() {
  return (
    <div className="min-h-screen bg-pear-background">
      ...
      <nav className="bg-secondary py-3" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li className="text-foreground font-medium">Impressions Dental Care Alternative</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="heading-serif text-4xl md:text-5xl font-bold mb-6 text-primary">
              Looking for an Alternative to Impressions Dental Care?
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Upgrade to Pear Tree Dental in Burton Joyce - experience modern digital technology, purpose-built facilities,
              and transparent membership pricing designed for exceptional 21st-century dental care.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/impressions-dental-care-reviews-nottingham">
      ...
      {/* Private Practice vs Membership Comparison */}
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold mb-4 text-primary">
                Traditional Private Practice vs Modern Membership Care
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Understanding the fundamental differences between traditional private practice
                and modern, purpose-built membership-based dental care.
              </p>
            </div>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="border-b">
                        ...
                        <th className="text-center py-3 px-4 heading-serif font-semibold text-muted-foreground">Traditional Private</th>
                    ...
                    <tbody>
                      {privateVsMembership.map((item, index) => (
                        <tr key={index} className="border-b hover:bg-muted/50 transition-colors">
                          <td className="py-4 px-4 font-medium">{item.aspect}</td>
                          <td className="py-4 px-4 text-center text-muted-foreground">{item.private}</td>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <Card className="bg-primary/5 border-primary/20">
                ...
                <CardContent className="text-center">
                  <p className="text-muted-foreground mb-4">
                    Simple monthly membership from £8.99 with no surprise bills or hidden private fees.
                  </p>
                  <ul className="text-sm space-y-2">
              ...
              <Card className="bg-green-50 border-green-200">
                ...
                <CardContent className="text-center">
                  <p className="text-muted-foreground mb-4">
                    Modern practice designed specifically for contemporary dental care and exceptional patient experience.
                  </p>
                  <ul className="text-sm space-y-2">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 p-6 bg-muted rounded-lg">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  <h4 className="font-semibold mb-1">⭐ Exceptional Care</h4>
                  <p className="text-sm text-muted-foreground">Patient-focused experience</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              with transparent pricing and facilities designed for exceptional care and convenience.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <div className="mt-8 flex items-center justify-center space-x-6 text-sm opacity-80">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span>Exceptional patient care</span>
              </div>
            </div>
          </div>
        </div>
