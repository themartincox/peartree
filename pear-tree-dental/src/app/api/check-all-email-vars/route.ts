...
export async function GET() {
  try {
    ...
    const allEmailVars = {
      ...
      EMAIL_USER_EQUALS_SMTP_USER: process.env.EMAIL_USER === process.env.SMTP_USER,
      EMAIL_PASS_EQUALS_SMTP_PASS: process.env.EMAIL_PASS === process.env.SMTP_PASS,
      EMAIL_HOST_EQUALS_SMTP_HOST: process.env.EMAIL_HOST === process.env.SMTP_HOST
    };
