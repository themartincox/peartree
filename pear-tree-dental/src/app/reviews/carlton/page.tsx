...
export const metadata: Metadata = {
  title:
    "Carlton Dental Care: What Local Patients Really Value | Pear Tree Dental",
  description:
    "Explore what patients in Carlton say about local dental care – from parking and pricing to modern facilities and appointment access. Find the right practice for you.",
  keywords: [
    "Carlton dental care",
  ...
  openGraph: {
    title:
      "Carlton Dental Care: What Local Patients Really Value | Pear Tree Dental",
    description:
      "Explore what patients in Carlton say about local dental care – from parking and pricing to modern facilities.",
...
export default function CarltonDentalCarePatientFeedbackPage() {
  const patientFeedbackFAQs = [
    {
      question:
        "How does Pear Tree Dental compare to established practices in Carlton like Carlton Dental Surgery?",
      answer:
        "Patients often compare Carlton practices based on parking, appointment availability, and technology. Pear Tree offers modern facilities, free parking, and transparent pricing in a relaxing setting just minutes from NG4.",
    },
    {
      question:
        "What do patients say about parking at Carlton dental practices?",
      answer:
        "Parking is a major concern for Carlton patients. Many local practices have limited parking, while newer practices like Pear Tree Dental offer free, convenient parking that patients consistently praise in reviews.",
    },
    {
      question: "How do Carlton dental costs compare between practices?",
      answer:
        "Cost transparency varies significantly between Carlton practices. Patients appreciate clear pricing upfront, which is why practices with transparent fee structures tend to receive better feedback than those with hidden costs.",
    },
    {
      question:
        "What technology do Carlton patients expect from modern dental practices?",
      answer:
    ...
    {
      question:
        "How important is appointment availability to Carlton dental patients?",
      answer:
  ...
  const patientPriorities = [
    {
      ...
      patientFeedback:
        "Limited parking creates stress and affects appointment punctuality",
    ...
    },
    {
      ...
      patientFeedback:
        "Some practices don't cater well to families with children",
      peartreeAdvantage:
        "Family-focused care with patient approach to all ages",
      icon: Calendar,
    },
    {
  ...
  const commonConcerns = [
    {
      ...
      peartreeApproach:
        "Free parking directly outside our Burton Joyce practice - just 12 minutes from Carlton",
    },
    {
    ...
    },
    {
      ...
      peartreeApproach:
        "Same-day emergency appointments and family-friendly scheduling",
    },
    {
      ...
      peartreeApproach:
        "Welcoming environment designed for families and children",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🔍 Based on comprehensive analysis of Carlton dental patient
                feedback
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                and healthcare platforms to understand what Carlton residents
            ...
            <div className="mt-12 text-center bg-rose-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                community forums to understand what Carlton residents prioritize
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                discussions, these are the factors that matter most to Carlton
                dental patients.
              </p>
            </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Traditional vs Modern Dental Practices: What Carlton Patients
                Prefer
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                ...
                practices consistently receive better feedback for
                family-friendly service, technology, and patient experience.
              </p>
            </div>
          </div>
        </div>
                ...
                <div className="text-center">
                  <div className="bg-rose-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      Free parking for the whole family
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Free parking, modern technology, family-friendly service, and
              transparent pricing - all just 12 minutes from Carlton.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Family-friendly care • Free parking • Modern facilities • Quick
                drive from NG4
              </p>
            </div>
