...
export const metadata: Metadata = {
  title:
    "Arnold Dental Care: What Local Patients Really Value | Pear Tree Dental",
  description:
    "Explore what patients in Arnold say about local dental care – from parking and pricing to modern facilities and appointment access. Find the right practice for you.",
  keywords: [
    "Arnold dental care",
  ...
  openGraph: {
    title:
      "Arnold Dental Care: What Local Patients Really Value | Pear Tree Dental",
    description:
      "Explore what patients in Arnold say about local dental care – from parking and pricing to modern facilities.",
...
export default function ArnoldDentalCarePatientFeedbackPage() {
  const patientFeedbackFAQs = [
    {
      question:
        "How does Pear Tree Dental compare to established practices in Arnold like Arnold Dental Care?",
      answer:
        "Patients often compare Arnold practices based on parking, appointment availability, and technology. Pear Tree offers modern facilities, free parking, and transparent pricing in a relaxing setting just minutes from NG5.",
    },
    {
      question:
        "What do patients say about parking at Arnold dental practices?",
      answer:
        "Parking is a major concern for Arnold patients. Many high street practices have limited parking, while newer practices like Pear Tree Dental offer free, convenient parking that patients consistently praise in reviews.",
    },
    {
      question: "How do Arnold dental costs compare between practices?",
      answer:
        "Cost transparency varies significantly between Arnold practices. Patients appreciate clear pricing upfront, which is why practices with transparent fee structures tend to receive better feedback than those with hidden costs.",
    },
    {
      question:
        "What technology do Arnold patients expect from modern dental practices?",
      answer:
    ...
    {
      question:
        "How important is appointment availability to Arnold dental patients?",
      answer:
  ...
  const patientPriorities = [
    {
      ...
      patientFeedback:
        "High street parking difficulties create stress before appointments",
    ...
    },
    {
      ...
      patientFeedback:
        "Long waits and inflexible hours frustrate working professionals",
    ...
    },
    {
      ...
      description:
        "Clean, modern facilities that reflect professional standards",
      patientFeedback:
        "Practice environment affects confidence in care quality",
      peartreeAdvantage:
        "Spa-like environment designed for professional patients",
      icon: Shield,
    },
    {
      ...
      peartreeAdvantage:
        "Detailed explanations and professional treatment planning",
      icon: MessageSquare,
    },
  ];
  ...
  const commonConcerns = [
    {
      ...
      peartreeApproach:
        "Free parking directly outside our Burton Joyce practice - just 10 minutes from Arnold",
    },
    {
    ...
    },
    {
      ...
      solution:
        "Select practices with efficient scheduling and emergency access",
      peartreeApproach:
        "Professional-friendly scheduling with same-day emergency appointments",
    },
    {
      ...
      solution:
        "Choose practices focused on personal, professional relationships",
      peartreeApproach:
  ...
  const researchSources = [
    ...
    },
    {
      ...
      keyFindings:
        "Patients share experiences about professional treatment standards",
    },
    {
      platform: "Healthcare Review Sites",
      insights:
        "Treatment outcomes and professional service most important factors",
      sampleSize: "140+ detailed patient reviews across multiple platforms",
      keyFindings:
        "Professionals willing to travel for better service and technology",
    },
    {
      platform: "Local Community Forums",
      insights:
        "Word-of-mouth recommendations emphasize professional efficiency",
      sampleSize: "65+ discussion threads about Arnold dental care",
      keyFindings:
        "Professional referrals highly influential in practice selection",
    },
  ];
  ...
  const practiceComparison = [
    ...
    },
    {
      ...
      patientPreference:
        "Prefer high standards matching professional expectations",
      winner: "Modern",
    },
  ];
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-yellow-500 hover:bg-yellow-400 text-purple-800 px-8 py-4 text-lg font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all"
                >
              ...
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-white text-white hover:bg-white hover:text-purple-600 px-8 py-4 text-lg font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all"
                >
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🔍 Based on comprehensive analysis of Arnold dental patient
                feedback
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                discussions, these are the factors that matter most to Arnold
                dental patients.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-2xl p-8 text-white text-center shadow-xl">
              ...
              <p className="text-lg mb-6 opacity-90">
                Join hundreds of Arnold patients who've already made the switch
                to professional, hassle-free dental care.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/book">
                  <Button
                    size="lg"
                    className="bg-white text-emerald-600 hover:bg-gray-100 px-8 py-3 font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all"
                  >
                ...
                <a href="tel:01159312935">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-2 border-white text-white hover:bg-white hover:text-emerald-600 px-8 py-3 font-semibold rounded-full shadow-lg transform hover:scale-105 transition-all"
                  >
                    <Phone className="w-5 h-5 mr-2" />
                    Speak to Our Team
                  </Button>
              ...
              <p className="text-sm mt-4 opacity-80">
                📍 Free parking • ⏱️ 10 minutes from Arnold • 🦷 Same-day crowns
                available
              </p>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Traditional vs Modern Dental Practices: What Arnold Patients
                Prefer
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                ...
                practices consistently receive better feedback for professional
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <p className="text-lg mb-4 opacity-90">
                    Modern technology • Free parking • Professional service •
                    Transparent pricing
                  </p>
                  <p className="text-sm opacity-80">
                    ✓ CEREC same-day crowns ✓ Digital X-rays ✓ Emergency
                    appointments ✓ No hidden costs
                  </p>
                </div>
                <div className="text-center md:text-right">
                  <div className="flex flex-col gap-3">
                    <Link href="/book">
                      <Button
                        size="lg"
                        className="w-full bg-white text-purple-600 hover:bg-gray-100 px-8 py-3 font-semibold rounded-lg shadow-lg transform hover:scale-105 transition-all"
                      >
                    ...
                    <a href="tel:01159312935" className="w-full">
                      <Button
                        size="lg"
                        variant="outline"
                        className="w-full border-2 border-white text-white hover:bg-white hover:text-purple-600 px-8 py-3 font-semibold rounded-lg shadow-lg transform hover:scale-105 transition-all"
                      >
                        <Phone className="w-5 h-5 mr-2" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We analysed hundreds of patient reviews from Google, Facebook,
                and healthcare platforms to understand what Arnold residents
            ...
            <div className="mt-12 text-center bg-purple-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                community forums to understand what Arnold residents prioritize
                ...
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Journey: Just 10 minutes with free parking
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-purple-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      No high street parking hassles
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Free parking, modern technology, professional service, and
            ...
            <div className="bg-white/20 border-2 border-white/40 rounded-xl p-6 mb-8 inline-block backdrop-blur-sm shadow-xl">
              ...
              <p className="text-base opacity-95 font-semibold">
                Modern facilities • Free parking • Professional service • Quick
                drive from NG5
              </p>
            </div>
