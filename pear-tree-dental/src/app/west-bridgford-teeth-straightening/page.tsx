...
export const metadata: Metadata = {
  title: 'Teeth Straightening West Bridgford - Invisalign & Clear Aligners | Pear Tree Dental',
  description: 'Discreet teeth straightening for West Bridgford residents. Invisalign, clear aligners, and modern orthodontics. Straighten your teeth without metal braces.',
  keywords: [
  ...
  openGraph: {
    title: 'Teeth Straightening in West Bridgford - Invisalign & Clear Aligners',
    description: 'Discreet teeth straightening for West Bridgford professionals. Modern orthodontics with invisible aligners.',
    ...
    <div className="min-h-screen bg-dental-navy text-white">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Discreet teeth straightening treatments including Invisalign and clear aligners for West Bridgford residents.",
            "provider": {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Straighten your teeth discreetly with Invisalign and clear aligners. Perfect for West Bridgford professionals
              who want a confident smile without the appearance of traditional braces.
            </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Modern Teeth Straightening for West Bridgford</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Choose from our range of discreet orthodontic treatments designed for busy West Bridgford professionals and families.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 border border-pear-gold/20 bg-gradient-to-br from-white to-pear-gold/5">
                ...
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-pear-gold mb-2">From £1,995</p>
                  <p className="text-gray-600 mb-4">Quick correction for minor alignment issues</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
                  ...
                  <Button variant="outline" className="w-full border-pear-gold text-pear-gold hover:bg-pear-gold hover:text-white">
              ...
              <Card className="p-6 border border-pear-primary/20 bg-gradient-to-br from-white to-pear-primary/5">
                <CardHeader className="text-center pb-4">
                  ...
                  <CardTitle className="text-xl">Comprehensive Treatment</CardTitle>
                  <Badge variant="secondary" className="mt-2 bg-pear-primary/10 text-pear-primary">
                    Complete Solution
                  </Badge>
                </CardHeader>
                <CardContent className="text-center">
                  <p className="text-2xl font-bold text-pear-primary mb-2">From £3,500</p>
                  <p className="text-gray-600 mb-4">Full orthodontic treatment for complex cases</p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-8">Why West Bridgford Professionals Choose Clear Aligners</h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        without affecting your professional appearance.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2">Lifestyle Friendly</h3>
                      <p className="text-gray-700">
                        Removable aligners mean no food restrictions and easy cleaning. Perfect for
                        West Bridgford's active professional lifestyle.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2">Faster Treatment</h3>
                      <p className="text-gray-700">
                        Modern aligner technology often provides faster results than traditional braces,
                        with most cases completed in 6-18 months.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <Card className="overflow-hidden shadow-xl">
                  <div className="aspect-[4/3] bg-gradient-to-br from-dental-green/10 to-pear-gold/20 flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <h3 className="text-xl font-bold text-gray-700 mb-2">CLEAR ALIGNER TECHNOLOGY</h3>
                      <p className="text-gray-600 mb-4">Modern orthodontics for professionals</p>
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Your Teeth Straightening Journey</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A simple, straightforward process designed to fit around your West Bridgford lifestyle
              </p>
            </div>
              ...
              {[
                {
                  step: "1",
                  title: "Consultation",
                  description: "Free initial assessment and treatment planning",
                  icon: Users,
                  time: "45 minutes"
                },
                {
                  step: "2",
                  title: "Digital Scan",
                  description: "3D imaging to create your personalized treatment plan",
                  icon: Sparkles,
                  time: "30 minutes"
                },
                {
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">Convenient Treatment from West Bridgford</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Professional orthodontic care without the city center hassle. Easy access and flexible scheduling for busy lifestyles.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <p className="text-gray-700 mb-4">
                  Just 12 minutes from West Bridgford with free parking and easy countryside route.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-gold/20">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold">Flexible Appointments</h3>
                </div>
                <p className="text-gray-700 mb-4">
                  Evening and weekend appointments to fit around your professional schedule.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-primary/20">
                ...
                <p className="text-gray-700 mb-4">
                  Experienced orthodontic team with extensive clear aligner expertise.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real stories from West Bridgford residents who've transformed their smiles with clear aligners
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              Join West Bridgford professionals who've chosen clear aligners for a confident, straight smile.
              Book your consultation and discover how easy modern orthodontics can be.
            </p>
