...
export const metadata: Metadata = {
	title: "Composite Bonding in Nottingham - Affordable Smile Enhancement | Pear Tree Dental",
	description: "Composite bonding for Nottingham residents. Affordable same-day smile improvements, gap closure, and tooth reshaping just minutes away. Natural-looking results guaranteed.",
	keywords: [
	...
	openGraph: {
		title: "Composite Bonding in Nottingham - Affordable Smile Enhancement | Pear Tree Dental",
		description: "Composite bonding for Nottingham residents. Affordable same-day smile improvements with natural-looking results.",
...
export default function NottinghamCompositeBondingPage() {
	const nottinghamBondingFAQs = [
		{
			question: "How far is composite bonding treatment from Nottingham city centre?",
			answer: "Pear Tree Dental is just a short drive from Nottingham city centre. We're specialists in aesthetic composite bonding with same-day appointments and natural-looking results."
		},
		{
		...
		{
			question: "What makes your bonding service special for Nottingham residents?",
			...
			<script
				...
				dangerouslySetInnerHTML={{
					__html: JSON.stringify({
						...
						"image": "https://peartree.dental/images/composite-bonding-nottingham.jpg",
						"url": "https://peartree.dental/nottingham-dentist/composite-bonding",
