...
export const metadata: Metadata = {
  title:
    "Smile Design East Bridgford - Village Complete Smile Makeovers | Pear Tree Dental",
  description:
    "Exclusive smile design for East Bridgford village residents. Veneers, crowns, whitening, and smile makeovers with village convenience and personal care.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Transform your smile with exclusive smile design for East Bridgford village residents.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Exclusive smile design and makeover treatments for East Bridgford village residents using advanced cosmetic dentistry techniques.",
            provider: {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Transform your smile with exclusive smile design and makeovers for
              East Bridgford village residents. Expert cosmetic dentistry with
              the personal attention and village convenience you deserve.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Exclusive Smile Design for East Bridgford Village
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                From subtle enhancements to complete smile transformations, our
                expert team creates beautiful, natural-looking results with
                village personal care.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-6 border border-dental-green/20 bg-gradient-to-br from-white to-dental-green/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Comprehensive smile transformation with village care
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
              ...
              <Card className="p-6 border border-pear-primary/20 bg-gradient-to-br from-white to-pear-primary/5">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Subtle improvements with village personal touch
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Your Village Smile Design Journey
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A comprehensive, personal process designed to create your
                perfect smile with village care and attention
              </p>
            </div>
                ...
                [
                  {
                    ...
                    description:
                      "Personal assessment of your smile goals with village priority",
                    icon: Users,
                    time: "60 minutes",
                  },
                  {
                    ...
                    description:
                      "3D modeling and preview of your new smile options",
                    icon: Camera,
                    time: "45 minutes",
                  },
                  {
                    ...
                    description:
                      "Detailed treatment plan with village member benefits",
                    icon: CheckCircle,
                    time: "30 minutes",
                  },
                  {
                    ...
                    description:
                      "Precise implementation with village personal care",
                    icon: Crown,
                    time: "2-6 visits",
                  },
                ] || []
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Village Smile Design Treatment Options
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Multiple treatment approaches tailored to your needs with the
                personal care that East Bridgford village residents value
              </p>
            </div>
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Expert Village Smile Design from East Bridgford
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                World-class cosmetic dentistry without the city center hassle.
                Beautiful village access and the personal care you deserve.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green/20">
                ...
                <p className="text-gray-700 mb-4">
                  Just 5 minutes from East Bridgford with peaceful countryside
              ...
              <Card className="p-6 border border-pear-gold/20">
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  design expertise and village care approach.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                East Bridgford Village Smile Transformations
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real stories from East Bridgford village residents who've
                transformed their confidence with smile design
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-white/90">
              ...
              confidence that comes with a perfectly designed smile and the
              personal care that village life deserves.
            </p>
