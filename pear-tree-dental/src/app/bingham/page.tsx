...
export const metadata: Metadata = {
  ...
  description:
    "Family dental care for Bingham residents. Pear Tree Dental offers comprehensive dental treatments, membership plans, and convenient A52 access from Bingham.",
  keywords: [
    "dentist Bingham",
  ...
  openGraph: {
    title: "Family Dentist in Bingham - Pear Tree Dental | Quality Dental Care",
    description:
      "Comprehensive family dental care for Bingham residents. Modern treatments, membership plans, and convenient access.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Family dental practice serving Bingham residents with comprehensive dental care, children's dentistry, and membership plans.",
            address: {
              "@type": "PostalAddress",
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Comprehensive family dental care just 8 minutes from Bingham.
              Modern treatments, gentle care for children, and affordable
              membership plans that cover the whole family.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Convenient Family Dental Care from Bingham
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Easy A52 access makes dental care hassle-free for Bingham
                families. Same-day appointments and flexible scheduling for busy
                family life.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green bg-gradient-to-br from-white to-dental-green">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Direct drive from Bingham via A52 to Burton Joyce
                  </p>
              ...
              <Card className="p-6 border border-pear-gold bg-gradient-to-br from-white to-pear-gold">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    Easy route through Nottinghamshire countryside
                  </p>
                  <p className="text-sm text-gray-500 mt-2">
                    No city center traffic
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="p-6 border border-pear-primary bg-gradient-to-br from-white to-pear-primary">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600">
                    From toddlers to grandparents - everyone welcome
                  </p>
                  <p className="text-sm text-gray-500 mt-2">
      ...
      <section className="py-16 bg-gradient-to-br from-gray-50 to-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Complete Family Dental Care for Bingham
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive dental services for every member of your Bingham
                family, from first teeth to golden years
              </p>
            </div>
                ...
                [
                  {
                    ...
                    description:
                      "Gentle, fun dental care to build healthy habits",
                    icon: Baby,
                    features: [
                      "First dental visits",
                      "Fissure sealants",
                  ...
                  },
                  {
                    ...
                    description:
                      "Same-day treatment for urgent dental problems",
                    icon: Shield,
                    features: [
                  ...
                  },
                  {
                    ...
                    description:
                      "Affordable monthly plans for the whole family",
                    icon: Heart,
                    features: [
                      "Predictable costs",
            ...
            <div className="text-center mt-12">
              <div className="bg-gradient-to-r from-dental-green to-pear-gold rounded-2xl p-8 max-w-4xl mx-auto">
                ...
                <p className="text-gray-700 mb-6">
                  Save money with family memberships that cover everyone from
                  children to adults. Includes check-ups, cleaning, and
                  emergency cover for the whole family.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-pear-gold text-pear-gold hover:bg-pear-gold hover:text-dental-navy"
                  >
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Trusted by Bingham Families
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Read what Bingham families say about their dental care
                experience
              </p>
            </div>
            ...
            <div className="mt-12 text-center">
              <div className="bg-gradient-to-r from-dental-green to-pear-gold rounded-2xl p-8 max-w-2xl mx-auto">
                ...
                <p className="text-gray-700 font-semibold">
                  Based on 85+ reviews from Bingham families
                </p>
              </div>
            </div>
          </div>
