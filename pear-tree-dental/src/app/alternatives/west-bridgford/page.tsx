...
export const metadata: Metadata = {
  title:
    "Looking for a Private Dentist in West Bridgford? Try Pear Tree Dental",
  description:
    "Modern tech, free parking, and caring experts – all minutes from NG2. Discover why West Bridgford patients are choosing Pear Tree Dental for their private dental care.",
  keywords: [
...
export default function PrivateDentistWestBridgfordOverviewPage() {
  const alternativesFAQs = [
    {
      question:
        "What are the alternatives to older dental practices in West Bridgford?",
      answer:
        "Many patients seek newer private dentists offering flexible hours, digital tech, and easier parking. Pear Tree Dental delivers these benefits while keeping care personal and comprehensive.",
    },
    {
      question:
        "Why are West Bridgford patients switching to practices outside the city centre?",
      answer:
        "Parking difficulties, outdated equipment, and limited appointment times drive patients to seek modern alternatives. Practices like Pear Tree offer free parking, latest technology, and same-day appointments.",
    },
    {
      question:
        "How do modern private dentists compare to traditional West Bridgford practices?",
      answer:
        "Modern practices typically offer digital X-rays, CEREC same-day crowns, transparent pricing, and better parking. The investment in technology and patient experience often provides better value.",
    },
    {
      question:
        "Is it worth traveling slightly further for a better dental experience?",
      answer:
        "Many West Bridgford patients find that an 8-10 minute drive to a modern practice with free parking actually saves time compared to struggling with city centre parking and longer waiting times.",
    },
    {
      question:
        "What should West Bridgford patients look for in a private dentist?",
      answer:
        "Key factors include convenient parking, modern equipment, transparent pricing, flexible appointments, and a focus on preventive care. Pear Tree Dental specifically addresses these patient priorities.",
    },
  ];
  ...
  const whyPatientsSwitch = [
    {
      ...
      oldExperience:
        "Circling for parking, paying high fees, being late for appointments",
      newSolution:
        "Free parking directly outside practice - stress-free arrival",
      impact:
        "Transforms the entire visit experience from stressful to relaxing",
      icon: Car,
    },
    {
      ...
      impact:
        "Better diagnostics, faster treatment, more comfortable experience",
      icon: Zap,
    },
    {
      reason: "Hidden Costs",
    ...
    },
    {
      ...
      oldExperience:
        "Long waits for appointments, no emergency slots, rigid scheduling",
      newSolution:
        "Same-day emergency care, flexible hours, efficient scheduling",
    ...
    },
    {
      ...
      oldExperience:
        "Rushed appointments, seeing different staff, feeling like a number",
    ...
    },
    {
      ...
      oldExperience:
        "Only treating problems when they become painful or urgent",
      newSolution:
        "Preventive care, early intervention, comprehensive planning",
  ...
  const modernAdvantages = [
    {
      ...
      description:
        "Complete crown treatment in one visit instead of multiple appointments",
      traditionalAlternative: "Temporary crowns and weeks of waiting",
      patientBenefit:
        "Save time, avoid temporary crown discomfort, immediate results",
      technology: "Latest CEREC CAD/CAM technology for precision fitting",
    },
    {
      advantage: "Digital X-Ray Technology",
      description:
        "Instant, high-quality images with 90% less radiation exposure",
      traditionalAlternative:
        "Film X-rays with chemical processing and higher radiation",
      patientBenefit:
        "Safer, faster, and images can be enhanced for better diagnosis",
      technology: "State-of-the-art digital sensors and imaging software",
    },
    {
      advantage: "Intraoral Cameras",
      description:
        "See exactly what the dentist sees with detailed close-up images",
    ...
    },
    {
      ...
      description:
        "Clear pricing guides and detailed treatment estimates upfront",
      traditionalAlternative:
    ...
    },
    {
      ...
      description:
        "Detailed treatment plans addressing current and future needs",
      traditionalAlternative:
        "Addressing only immediate problems as they arise",
      patientBenefit:
        "Proactive care that prevents problems and saves money long-term",
  ...
  const patientJourneyComparison = [
    {
      ...
      peartree:
        "Book online anytime, comprehensive new patient information sent digitally",
    },
    {
    ...
    },
    {
      ...
      peartree:
        "Spa-like reception area, digital processes, calming atmosphere",
    },
    {
      ...
      peartree:
        "Full digital examination with intraoral camera, instant digital X-rays",
    },
    {
      ...
      peartree:
        "Detailed visual explanation using your own images, clear treatment options",
    },
    {
      ...
      peartree:
        "Detailed written plan with transparent pricing and payment options",
    },
    {
    ...
    },
    {
      ...
      peartree:
        "Comprehensive aftercare with preventive focus and easy contact",
    },
  ];
  ...
  const locationBenefits = [
    {
      ...
      description:
        "Just 8 minutes from West Bridgford with excellent transport links",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Looking for a{" "}
              <span className="text-yellow-300">Private Dentist</span> in West
              Bridgford?
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Modern tech, free parking, and caring experts – all minutes from
                NG2
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🚗 Just 8 minutes from West Bridgford with free parking!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Traditional dental practices have served West Bridgford well,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that modern dental care makes at every
                step of your visit.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Difference:</strong> Every step designed
                around your comfort, convenience, and optimal treatment
                outcomes.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from West Bridgford patients considering their
                options
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Experience what West Bridgford patients are discovering – better
              technology, easier parking, and superior care just minutes away.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                CEREC technology • Free parking • Same-day appointments • 8
                minutes from NG2
              </p>
            </div>
