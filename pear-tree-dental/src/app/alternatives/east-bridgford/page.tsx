...
export const metadata: Metadata = {
  ...
  description:
    "Modern countryside dental care with easy rural access and personal service – just 5 minutes from NG13. Discover why East Bridgford residents are choosing Pear Tree Dental.",
  keywords: [
  ...
  openGraph: {
    title:
      "Looking for a Rural Dentist in East Bridgford? Try Pear Tree Dental",
    description:
      "Modern countryside dental care with easy rural access and personal service – just 5 minutes from NG13.",
...
export default function RuralDentistEastBridgfordOverviewPage() {
  const alternativesFAQs = [
    {
      question:
        "What are the alternatives to limited rural dental practices serving East Bridgford?",
      answer:
        "Many rural residents seek practices offering modern technology, convenient countryside access, and comprehensive care. Pear Tree Dental delivers these benefits while maintaining the personal touch valued in rural communities.",
    },
    {
      question:
        "Why are East Bridgford residents switching to practices outside their immediate area?",
      answer:
        "Limited local options, outdated rural facilities, and long urban travels drive residents to seek modern alternatives. Practices like Pear Tree offer cutting-edge technology with easy countryside access.",
    },
    {
      question:
        "How do modern dental practices compare to traditional rural options for East Bridgford?",
      answer:
        "Modern practices typically offer digital X-rays, CEREC same-day crowns, transparent pricing, and efficient treatment. The investment in technology and rural accessibility often provides superior value.",
    },
    {
      question: "Is it worth traveling outside East Bridgford for dental care?",
      answer:
        "Many rural residents find that a 5-minute drive to a modern practice with comprehensive facilities actually provides better access than limited local options or long urban travels.",
    },
    {
      question:
        "What should East Bridgford rural residents look for in a modern dental practice?",
      answer:
        "Key factors include easy countryside access, modern equipment, efficient treatment, transparent pricing, and understanding of rural lifestyle needs. Pear Tree Dental specifically addresses these rural priorities.",
    },
  ];
  ...
  const whyRuralResidentsSwitch = [
    {
      ...
      impact:
        "Access to full range of modern dental services close to countryside",
      icon: Car,
    },
    {
      reason: "Outdated Rural Equipment",
      oldExperience:
        "Basic rural equipment, outdated technology, limited treatment options",
    ...
    },
    {
      ...
      oldExperience:
        "Long travels to cities, traffic, complex parking, time loss",
    ...
    },
    {
      ...
      oldExperience:
        "Multiple appointments, repeated rural travels, time inefficiency",
    ...
    },
    {
      ...
      oldExperience:
        "Variable rural pricing, hidden costs, limited payment options",
    ...
    },
    {
      ...
      oldExperience:
        "High-volume city practices, no rural understanding, impersonal care",
  ...
  const ruralAdvantages = [
    {
      ...
      traditionalAlternative:
        "Multiple rural travels, time off farm work, efficiency loss",
    ...
    },
    {
      ...
      description:
        "90% less radiation and instant results for rural family health",
    ...
    },
    {
      ...
      description:
        "Intraoral cameras help rural families understand their care",
      traditionalAlternative:
        "Complex explanations, no visual aids for rural understanding",
    ...
    },
    {
      ...
      description:
        "Clear pricing that works with rural budgeting and seasonal income",
      traditionalAlternative:
        "Hidden costs, inflexible payment, rural budget complications",
      ruralBenefit: "Rural family financial planning and payment flexibility",
      technology:
        "Digital treatment planning with rural-sensitive cost options",
    },
    {
      advantage: "Rural Access Solution",
      description:
        "Easy countryside access with convenient parking for rural vehicles",
      traditionalAlternative: "Limited rural parking, difficult urban access",
      ruralBenefit:
        "Easy access for rural families with farm vehicles and equipment",
      technology:
        "Rural-accessible location with countryside parking facilities",
    },
    {
      advantage: "Rural Lifestyle Understanding",
      description:
        "Scheduling and care that understands farming and countryside life",
      traditionalAlternative:
        "Urban scheduling, no rural lifestyle accommodation",
  ...
  const ruralJourneyComparison = [
    ...
    },
    {
      ...
      peartree:
        "Rural-accessible follow-up with countryside-friendly scheduling",
    },
  ];
  ...
  const ruralBenefits = [
    {
      ...
      description:
        "Easy access from rural areas without urban travel complications",
      advantage:
        "Eliminates city travel while providing modern dental technology",
      details:
        "Just 5 minutes from East Bridgford with rural-friendly roads and parking",
    },
    {
      benefit: "Rural Lifestyle Understanding",
      description:
        "Scheduling and care that accommodates farming and countryside work",
      advantage: "Dental care that fits with seasonal agricultural schedules",
      details:
        "Flexible timing for harvest, lambing, and other rural work priorities",
    },
    {
      benefit: "Countryside Family Care",
      description:
        "Comprehensive care for rural families from children to grandparents",
      advantage: "One practice serving all rural family dental needs",
      details:
        "Family-efficient scheduling and multi-generational countryside care",
    },
    {
      benefit: "Rural Value Pricing",
      description:
        "Transparent pricing that respects rural family budgeting patterns",
      advantage:
        "Clear costs with rural-friendly payment options and seasonal flexibility",
      details:
        "Understanding of rural income patterns and agricultural cash flow",
    },
  ];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Looking for a{" "}
              <span className="text-yellow-300">Rural Dentist</span> in East
              Bridgford?
            </h1>
            ...
            <div className="bg-white rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Rural values, modern tech, and easy countryside access – just 5
                minutes from NG13
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🌾 Just 5 minutes from East Bridgford with rural-friendly
                access!
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Why East Bridgford Rural Residents Are Switching to Modern
                Countryside Dental Care
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Limited rural options and long urban travels have led
                countryside residents to seek modern alternatives that
                understand and accommodate rural life.
              </p>
            </div>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Modern Rural Dental Technology: The Pear Tree Countryside
                Advantage
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Advanced technology designed for rural accessibility – better
                results, efficient treatment, and respect for countryside life.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that rural-aware modern dental care
                makes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              {(ruralJourneyComparison || []).map((stage, index) => (
                ...
                >
                  ...
                  <div className="text-center text-sm text-green-600 px-2 font-semibold">
                    {stage.peartree}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Rural Difference:</strong> Every step
                designed around countryside accessibility, rural values, and
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Modern dental care that understands and accommodates rural life
                and countryside values.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from East Bridgford countryside residents
                ...
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Free rural parking for farm vehicles
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Experience what East Bridgford countryside families are
              discovering – modern technology, rural values, and easy access
              just minutes away.
            </p>
            ...
            <div className="bg-white rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Rural accessibility • Modern technology • Countryside values • 5
                minutes from NG13
              </p>
            </div>
