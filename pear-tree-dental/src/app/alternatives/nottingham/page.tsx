...
export const metadata: Metadata = {
  ...
  description: "Escape city centre parking fees and crowds. Modern dental care with free parking and personal attention – just 15 minutes from Nottingham centre.",
  keywords: [
  ...
  openGraph: {
    title: "Looking for a Private Dentist in Nottingham? Try Pear Tree Dental",
    description: "Escape city centre parking fees and crowds. Modern dental care with free parking and personal attention.",
...
export default function PrivateDentistNottinghamOverviewPage() {
  const alternativesFAQs = [
    {
      question: "What are the alternatives to city centre dental practices in Nottingham?",
      answer: "Many patients seek practices outside the city centre offering free parking, modern technology, and personal attention. Pear Tree Dental delivers these benefits while providing easy access from all Nottingham areas."
    },
    {
      question: "Why are Nottingham patients switching to practices outside the city centre?",
      answer: "Expensive parking, traffic congestion, and rushed service drive patients to seek alternatives. Practices like Pear Tree offer free parking, modern technology, and unhurried personal care."
    },
    {
      question: "How do modern dental practices compare to traditional Nottingham city centre clinics?",
      answer: "Modern practices typically offer free parking, digital X-rays, CEREC same-day crowns, and more personal attention. The investment in patient experience often provides superior value and convenience."
    },
    {
      question: "Is it worth traveling outside Nottingham centre for dental care?",
      answer: "Many Nottingham patients find that a 15-minute drive to a practice with free parking actually saves time and money compared to struggling with city centre parking and traffic."
    },
    {
      question: "What should Nottingham patients look for in a modern dental practice?",
      answer: "Key factors include free convenient parking, modern equipment, transparent pricing, personal attention, and a calm environment. Pear Tree Dental specifically addresses these patient priorities."
    }
  ];
  ...
  const whyPatientsSwitch = [
    {
      ...
      oldExperience: "£5-£10 parking fees, searching for spaces, traffic wardens",
    ...
    },
    {
      ...
      oldExperience: "Old equipment, cramped facilities, dated treatment methods",
      newSolution: "Modern facilities, latest technology, spacious comfortable environment",
    ...
    },
    {
      ...
      oldExperience: "Limited appointment time, hurried treatment, impersonal care",
      newSolution: "Unhurried appointments, personal attention, time for questions",
    ...
    },
    {
      ...
      oldExperience: "High volume practices, different staff, feeling like a number",
      newSolution: "Personal care, consistent team, relationship-based treatment",
  ...
  const modernAdvantages = [
    {
      ...
      description: "Complete crown treatment in one visit - no return trips to city centre",
      traditionalAlternative: "Multiple visits, temporary crowns, city centre traffic",
    ...
    },
    {
      ...
      traditionalAlternative: "Film X-rays with processing delays and lower quality",
    ...
    },
    {
      ...
      description: "See exactly what needs attention with detailed close-up images",
    ...
    },
    {
      ...
      description: "Clear pricing guides and detailed estimates without hidden fees",
    ...
    },
    {
      ...
      description: "Unhurried appointments with time for questions and explanations",
      traditionalAlternative: "Rushed appointments in high-volume city practices",
      patientBenefit: "Better understanding, improved care, stronger relationships",
  ...
  const patientJourneyComparison = [
    {
      ...
      traditional: "Plan around parking costs, traffic, and limited appointment times",
      modern: "Easy online booking, no parking concerns",
      peartree: "Book online anytime, confirmed free parking, journey planning help"
    },
    {
      stage: "Journey to Practice",
      traditional: "City centre traffic, finding expensive parking, walking to practice",
    ...
    },
    {
      ...
      traditional: "Stress from parking costs/fines, rushed feeling, city noise",
  ...
  const escapeAdvantages = [
    ...
    },
    {
      ...
      description: "Move away from high-volume practices with rushed appointments",
    ...
    },
    {
      ...
      description: "Leave behind practices with surprise charges and unclear pricing",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Looking for a <span className="text-yellow-300">Private Dentist</span> in Nottingham?
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Free parking, modern tech, and personal care – just 15 minutes from city centre
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="tel:01159312935">
                <Button size="lg" variant="outline" className="border-white text-emerald-600 hover:bg-white hover:text-emerald-600 px-8 py-4 text-lg font-semibold rounded-full">
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">🚗 Free parking & no city centre fees!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Why struggle with expensive parking, traffic, and rushed service when there's a better way?
              </p>
            </div>

            <div className="grid md:grid-cols-2 gap-8">
              {escapeAdvantages.map((escape, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow border-2 border-emerald-200">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-pear-primary mb-2">{escape.benefit}</h3>
                        <p className="text-gray-700 mb-3">{escape.description}</p>

                        <div className="bg-emerald-50 rounded-lg p-3 mb-3">
                          <h4 className="font-semibold text-emerald-700 text-sm mb-1">Your Advantage:</h4>
                          <p className="text-sm text-emerald-700">{escape.advantage}</p>
                        </div>

                        <div className="bg-blue-50 rounded-lg p-3">
                          <h4 className="font-semibold text-blue-700 text-sm mb-1">How It Works:</h4>
                          <p className="text-sm text-blue-700">{escape.details}</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                City centre dental practices served Nottingham well in the past, but modern alternatives
                offer significant advantages that transform the entire dental experience.
              </p>
            </div>
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3">
                        <div className="bg-red-50 rounded-lg p-3">
                          <h4 className="font-semibold text-red-700 text-sm mb-1">City Centre Experience:</h4>
                          <p className="text-sm text-red-700">{reason.oldExperience}</p>
                        </div>

                        <div className="bg-emerald-50 rounded-lg p-3">
                          <h4 className="font-semibold text-emerald-700 text-sm mb-1">Modern Alternative:</h4>
                          <p className="text-sm text-emerald-700">{reason.newSolution}</p>
                        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Advanced technology and patient-focused care that transforms your dental experience.
              </p>
            </div>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-emerald-50 rounded-lg p-3">
                          <h4 className="font-semibold text-emerald-700 text-sm mb-1">Your Benefit:</h4>
                          <p className="text-sm text-emerald-700">{advantage.patientBenefit}</p>
                        </div>
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that escaping city centre limitations makes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              {patientJourneyComparison.map((stage, index) => (
                <div key={index} className="grid grid-cols-4 p-4 border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <div className="text-center text-sm text-emerald-600 px-2 font-semibold">{stage.peartree}</div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Escape:</strong> Every step designed to eliminate city centre hassles
                while providing superior dental care and technology.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                <div className="text-3xl font-bold text-emerald-600 mb-2">Escape parking fees</div>
                <p className="text-gray-600">Save £50-£100+ per year</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-emerald-600 mb-2">Peaceful journey</div>
                <p className="text-gray-600">No city centre traffic stress</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-emerald-600 mb-2">Personal attention</div>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the difference that escaping city centre limitations makes to your smile
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Nottingham patients considering their alternatives
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">No traffic, no fees, no stress</p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-emerald-50 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-emerald-700 mb-2">Freedom from City Centre</h4>
                    <p className="text-gray-600">No parking fees, no traffic stress</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Experience what Nottingham patients are discovering –
              better technology, free parking, and personal care just minutes away.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Free parking • Modern technology • Personal care • 15 minutes from city centre
              </p>
            </div>
