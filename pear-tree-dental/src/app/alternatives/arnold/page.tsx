...
export const metadata: Metadata = {
  ...
  description:
    "Professional dental care with modern tech, free parking, and expert service – all minutes from NG5. Discover why Arnold patients are choosing Pear Tree Dental.",
  keywords: [
  ...
  openGraph: {
    title: "Looking for a Private Dentist in Arnold? Try Pear Tree Dental",
    description:
      "Professional dental care with modern tech, free parking, and expert service – all minutes from NG5.",
...
export default function PrivateDentistArnoldOverviewPage() {
  const alternativesFAQs = [
    {
      question:
        "What are the alternatives to traditional dental practices in Arnold?",
      answer:
        "Many patients seek newer private dentists offering modern technology, professional service, and convenient parking. Pear Tree Dental delivers these benefits while maintaining high professional standards.",
    },
    {
      question:
        "Why are Arnold patients switching to practices outside the high street?",
      answer:
        "High street parking difficulties, outdated equipment, and inflexible scheduling drive patients to seek modern alternatives. Practices like Pear Tree offer free parking, latest technology, and professional-focused service.",
    },
    {
      question:
        "How do modern private dentists compare to traditional Arnold practices?",
      answer:
        "Modern practices typically offer digital X-rays, CEREC same-day crowns, transparent pricing, and better parking. The investment in technology and professional service often provides superior value.",
    },
    {
      question: "Is it worth traveling outside Arnold for better dental care?",
      answer:
        "Many Arnold patients find that a 10-minute drive to a modern practice with free parking actually saves time compared to struggling with high street parking and limited appointment times.",
    },
    {
      question:
        "What should Arnold professionals look for in a private dentist?",
      answer:
        "Key factors include convenient parking, modern equipment, transparent pricing, flexible professional scheduling, and respect for time. Pear Tree Dental specifically addresses these professional priorities.",
    },
  ];
  ...
  const whyPatientsSwitch = [
    {
      ...
      oldExperience:
        "Circling for parking, paid parking, being late for appointments",
      newSolution:
        "Free parking directly outside practice - stress-free arrival",
    ...
    },
    {
      ...
      newSolution:
        "Transparent pricing, detailed estimates, professional budgeting",
    ...
    },
    {
      ...
      oldExperience:
        "Limited hours, no emergency slots, rigid appointment times",
    ...
    },
    {
      ...
      oldExperience:
        "Rushed appointments, different staff, feeling like a number",
  ...
  const modernAdvantages = [
    {
      ...
      description:
        "Complete crown treatment in one visit - perfect for professionals",
      traditionalAlternative: "Temporary crowns and multiple appointments",
      patientBenefit:
        "Save time, avoid multiple visits, immediate professional results",
      technology:
        "Latest CEREC CAD/CAM technology for precision professional fitting",
    },
    {
      ...
      patientBenefit:
        "Safer, faster, and enhanced images for better professional diagnosis",
      technology:
        "State-of-the-art digital sensors and professional imaging software",
    },
    {
      advantage: "Intraoral Cameras",
      description:
        "See exactly what needs attention with detailed professional images",
      traditionalAlternative: "Verbal descriptions and basic hand mirrors",
      patientBenefit:
        "Professional understanding of treatments and oral health status",
      technology: "High-definition cameras for professional patient education",
    },
    {
      advantage: "Transparent Pricing System",
      description:
        "Clear professional pricing guides and detailed estimates upfront",
      traditionalAlternative:
        "Quotes only after examination with potential surprises",
      patientBenefit:
        "Professional budgeting confidence and understanding of value",
    ...
    },
    {
      ...
      traditionalAlternative:
        "Phone-only booking during limited business hours",
      patientBenefit:
        "Convenient professional scheduling that fits your career",
      technology:
        "Integrated practice management and professional patient portal",
    },
    {
      advantage: "Comprehensive Professional Care",
      description:
        "Detailed treatment plans addressing current and future professional needs",
      traditionalAlternative:
        "Addressing only immediate problems as they arise",
      patientBenefit:
        "Proactive care that prevents problems and maintains professional image",
      technology:
        "Digital charting and comprehensive professional examination protocols",
    },
  ];
  ...
  const patientJourneyComparison = [
    {
      ...
      peartree:
        "Professional online booking, comprehensive patient information",
    },
    {
    ...
    },
    {
      ...
      peartree:
        "Professional reception area, digital processes, calming atmosphere",
    },
    {
      ...
      peartree:
        "Full professional examination with intraoral camera, instant digital X-rays",
    },
    {
      ...
      peartree:
        "Detailed professional explanation using your images, clear treatment options",
    },
    {
      ...
      peartree:
        "Detailed professional plan with transparent pricing and payment options",
    },
    {
      ...
      peartree:
        "CEREC same-day crowns, minimal professional visits, maximum comfort",
    },
    {
  ...
  const locationBenefits = [
    ...
    },
    {
      ...
      details:
        "Professional spa-like environment designed for executive patients",
    },
    {
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-yellow-500 hover:bg-yellow-400 text-orange-800 px-8 py-4 text-lg font-semibold rounded-full"
                >
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🚗 Just 10 minutes from Arnold with executive parking!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Traditional high street practices have served Arnold well, but
                professional alternatives offer significant advantages that
                improve the entire dental experience.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                ...
                – it delivers better professional results and saves your
                valuable time.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that professional dental care makes at
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              {(patientJourneyComparison || []).map((stage, index) => (
                ...
                >
                  ...
                  <div className="text-center text-sm text-orange-600 px-2 font-semibold">
                    {stage.peartree}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Professional Difference:</strong> Every
                step designed around your professional needs, time constraints,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Sometimes the best professional choice is just outside the high
                street – easier to reach, easier to park, and much more
                professional.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-center">
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Matches your professional standards
                </p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-orange-600 mb-2">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600">
                  Respects your professional schedule
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the difference that professional technology and expert care
              make
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <BeforeAfterSlider
              beforeImage="/images/arnold-before-case-1.webp"
              afterImage="/images/arnold-after-case-1.webp"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Arnold professionals considering their
                options
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Executive parking directly outside
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-orange-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      No parking hassles or time limits
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Experience what Arnold professionals are discovering – better
              technology, executive parking, and superior service just minutes
              away.
            </p>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                CEREC technology • Executive parking • Professional service • 10
                minutes from NG5
              </p>
            </div>
