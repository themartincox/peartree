...
export const metadata: Metadata = {
  ...
  description:
    "Modern community dental care with free parking and personal service – just 8 minutes from NG3. Discover why Mapperley residents are choosing Pear Tree Dental.",
  keywords: [
  ...
  openGraph: {
    title: "Looking for a Community Dentist in Mapperley? Try Pear Tree Dental",
    description:
      "Modern community dental care with free parking and personal service – just 8 minutes from NG3.",
...
export default function CommunityDentistMapperleyOverviewPage() {
  const alternativesFAQs = [
    {
      question:
        "What are the alternatives to traditional dental practices in Mapperley?",
      answer:
        "Many community members seek practices offering modern technology, personal service, and convenient parking. Pear Tree Dental delivers these benefits while maintaining the community values Mapperley residents appreciate.",
    },
    {
      question:
        "Why are Mapperley residents switching to practices outside their local area?",
      answer:
        "Limited parking, outdated facilities, and impersonal service drive residents to seek modern alternatives. Practices like Pear Tree offer free parking, latest technology, and community-focused care.",
    },
    {
      question:
        "How do modern dental practices compare to traditional Mapperley practices?",
      answer:
        "Modern practices typically offer digital X-rays, CEREC same-day crowns, transparent pricing, and better parking. The investment in community experience often provides superior value and convenience.",
    },
    {
      question: "Is it worth traveling outside Mapperley for dental care?",
      answer:
        "Many Mapperley residents find that an 8-minute drive to a modern practice with free parking actually saves time and provides better community-focused experience than struggling with local parking issues.",
    },
    {
      question:
        "What should Mapperley residents look for in a modern dental practice?",
      answer:
        "Key factors include convenient parking, modern equipment, transparent pricing, community values, and personal attention. Pear Tree Dental specifically addresses these community priorities.",
    },
  ];
  ...
  const whyResidentsSwitch = [
    {
      ...
      oldExperience:
        "Limited parking spaces, competition with shops, resident permits",
      newSolution:
        "Free parking directly outside practice - no community parking stress",
      impact:
        "Transforms visits from stressful to relaxed community experience",
      icon: Car,
    },
    {
      reason: "Outdated Local Facilities",
      oldExperience:
        "Old equipment, dated facilities, limited technology options",
      newSolution:
        "Modern facilities with latest technology and community comfort",
    ...
    },
    {
      ...
      oldExperience:
        "High volume practices, rushed appointments, no community connection",
    ...
    },
    {
      ...
      oldExperience:
        "Surprise charges, unclear community pricing, budget uncertainty",
    ...
    },
    {
      ...
      oldExperience:
        "Rigid scheduling, no emergency access, limited community accommodation",
    ...
    },
    {
      ...
      oldExperience:
        "Different staff visits, no continuity, impersonal treatment",
      newSolution: "Consistent community care team, personal relationships",
      impact:
        "Maintains community spirit and trust in healthcare relationships",
      icon: Shield,
    },
  ];
  ...
  const communityAdvantages = [
    {
      ...
      description:
        "Same-day crowns mean community members don't need multiple visits",
      traditionalAlternative:
        "Multiple appointments, time off work, community scheduling conflicts",
    ...
    },
    {
      ...
      description:
        "90% less radiation and instant results for community health",
      traditionalAlternative:
        "Higher radiation film X-rays with processing delays",
      communityBenefit: "Safer for community members, faster community service",
      technology:
        "Digital sensors with instant community-friendly explanations",
    },
    {
      advantage: "Community Education Technology",
      description:
        "Intraoral cameras help community members understand their care",
      traditionalAlternative:
        "No visual aids, complex explanations residents don't understand",
      communityBenefit:
        "Community members understand and trust their treatment",
    ...
    },
    {
      ...
      traditionalAlternative:
        "Complex pricing, hidden fees, community budget confusion",
    ...
    },
    {
      ...
      traditionalAlternative:
        "Limited local parking, resident permit issues, community frustration",
      communityBenefit:
        "Easy community access without local parking competition",
    ...
    },
    {
      ...
      traditionalAlternative:
        "High-volume practices, different staff, no community connection",
      communityBenefit:
        "Maintains community values and personal healthcare relationships",
  ...
  const communityJourneyComparison = [
    ...
    },
    {
      ...
      traditional:
        "Search for local parking, compete with shoppers, community frustration",
    ...
    },
    {
      ...
      traditional:
        "Busy waiting room, impersonal check-in, community anonymity",
    ...
    },
    {
      ...
      traditional:
        "Rushed appointments, clinical atmosphere, no community connection",
      modern: "Some personal care, basic communication",
      peartree:
        "Community-focused care, personal attention, relationship building",
    },
    {
  ...
  const communityBenefits = [
    {
      ...
      details:
        "Personal attention and relationship-based care for community members",
    },
    {
      benefit: "Community Parking Solution",
      description:
        "Free parking that doesn't compete with local residents or shops",
      advantage:
        "Solves the biggest community frustration with local dental care",
    ...
    },
    {
      ...
      details:
        "Technology that enhances community relationships rather than replacing them",
    },
    {
      benefit: "Community Budget Respect",
      description:
        "Transparent pricing that respects community financial planning",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Looking for a{" "}
              <span className="text-yellow-300">Community Dentist</span> in
              Mapperley?
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/book">
                <Button
                  size="lg"
                  className="bg-yellow-500 hover:bg-yellow-400 text-lime-800 px-8 py-4 text-lg font-semibold rounded-full"
                >
              ...
              <a href="tel:01159312935">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-white hover:bg-white hover:text-lime-600 px-8 py-4 text-lg font-semibold rounded-full"
                >
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🏘️ Just 8 minutes from Mapperley with free community parking!
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Why Mapperley Residents Are Switching to Community-Focused
                Dental Care
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Local practices have served Mapperley well, but modern community
                alternatives offer significant advantages while maintaining the
                personal touch residents value.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {(whyResidentsSwitch || []).map((reason, index) => {
                ...
                return (
                  <Card
                    key={index}
                    className="hover:shadow-lg transition-shadow border-2 border-lime-200"
                  >
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="bg-lime-50 rounded-lg p-3">
                          <h4 className="font-semibold text-lime-700 text-sm mb-1">
                            Community Solution:
                          </h4>
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Modern Community Dental Technology: The Pear Tree Community
                Advantage
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Advanced technology designed with community values – better
                results, personal relationships, and respect for community life.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that community-focused modern dental
                care makes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg overflow-hidden">
              ...
              {(communityJourneyComparison || []).map((stage, index) => (
                ...
                >
                  ...
                  <div className="text-center text-sm text-lime-600 px-2 font-semibold">
                    {stage.peartree}
                  </div>
                </div>
              ))}
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Community Difference:</strong> Every step
                designed around community values, personal relationships, and
                modern convenience.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Modern dental care that understands and maintains community
      ...
      <section className="py-20 bg-cream/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the difference that community-focused care and modern
              technology make
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Mapperley residents considering their
                options
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Free community parking directly outside
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-lime-50 rounded-lg p-6">
                    ...
                    <h4 className="font-bold text-lime-700 mb-2">
                      Community Convenience
                    </h4>
                    <p className="text-gray-600">
                      No local parking competition
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              Experience what Mapperley residents are discovering – community
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Community values • Free parking • Modern technology • 8 minutes
                from NG3
              </p>
            </div>
