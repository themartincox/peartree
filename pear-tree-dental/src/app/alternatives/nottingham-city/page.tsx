...
export const metadata: Metadata = {
  title:
    "Looking for an Executive Dentist in Nottingham City? Try Pear Tree Dental",
  description:
    "Premium executive dental care with parking convenience and professional service – just 15 minutes from NG1. Discover why city professionals are choosing Pear Tree Dental.",
  keywords: [
  ...
  openGraph: {
    title:
      "Looking for an Executive Dentist in Nottingham City? Try Pear Tree Dental",
    description:
      "Premium executive dental care with parking convenience and professional service – just 15 minutes from NG1.",
...
export default function ExecutiveDentistNottinghamCityOverviewPage() {
  const alternativesFAQs = [
    {
      question:
        "What are the alternatives to city centre dental practices for Nottingham professionals like City Dental?",
      answer:
        "Many city professionals seek practices offering executive convenience, premium service, and parking solutions. Pear Tree Dental delivers these benefits while maintaining the professional excellence valued by city centre executives.",
    },
    {
      question:
        "Why are Nottingham City professionals switching to practices outside the city centre?",
      answer:
        "Expensive parking, crowded environments, and time-consuming city centre access drive professionals to seek executive alternatives. Practices like Pear Tree offer premium service with convenient access away from city complications.",
    },
    {
      question:
        "How do modern dental practices compare to traditional city centre options for professionals?",
      answer:
        "Modern practices typically offer free parking, executive service standards, professional scheduling, and premium convenience. The investment in professional experience often provides superior value for demanding executives.",
    },
    {
      question:
        "Is it worth traveling outside Nottingham City centre for executive dental care?",
      answer:
        "Many city professionals find that a 15-minute drive to a practice with free parking and executive service actually saves time compared to dealing with city centre parking fees and complications.",
    },
    {
      question:
        "What should Nottingham City professionals look for in an executive dental practice?",
      answer:
        "Key factors include convenient parking, professional service standards, executive scheduling flexibility, premium technology, and understanding of business demands. Pear Tree Dental specifically addresses these professional priorities.",
    },
  ];
  ...
  const whyProfessionalsSwitch = [
    {
      ...
      oldExperience:
        "Expensive parking fees, time wasted searching, appointment delays",
      newSolution: "Free executive parking directly outside practice",
      impact:
        "Eliminates parking stress and saves money on professional visits",
      icon: Car,
    },
    {
      reason: "Crowded City Centre Environment",
      oldExperience:
        "Busy waiting rooms, crowded facilities, stressful atmosphere",
      newSolution: "Professional spa-like environment away from city crowds",
      impact:
        "Relaxing executive experience matching professional expectations",
      icon: Building2,
    },
    {
      reason: "Inflexible Professional Scheduling",
      oldExperience:
        "Rigid city hours, limited emergency access, business conflict",
      newSolution:
    ...
    },
    {
      ...
      oldExperience:
        "Rushed appointments, variable quality, impersonal service",
      newSolution:
        "Consistent executive service exceeding professional expectations",
    ...
    },
    {
      ...
      oldExperience:
        "Traffic delays, complex navigation, professional time loss",
    ...
    },
    {
      ...
      oldExperience:
        "Basic city equipment, multiple visits, inefficient treatments",
  ...
  const executiveAdvantages = [
    {
      ...
      description:
        "Same-day premium crowns eliminating multiple professional visits",
      traditionalAlternative:
        "Multiple city appointments, parking fees, professional time loss",
      executiveBenefit:
        "Complete treatment in one visit, maximizing professional efficiency",
      technology: "Premium CEREC technology designed for executive convenience",
    },
    {
      advantage: "Professional Digital Imaging",
      description:
        "Advanced digital X-rays with immediate executive consultation",
      traditionalAlternative:
        "Processing delays, additional appointments, professional disruption",
      executiveBenefit:
        "Instant results with immediate professional consultation",
      technology:
        "Cutting-edge digital sensors with executive-level explanations",
    },
    {
      advantage: "Executive Scheduling Technology",
      description:
        "Professional scheduling systems accommodating business demands",
      traditionalAlternative:
        "Rigid city scheduling, business conflicts, limited flexibility",
      executiveBenefit:
        "Scheduling that works around meetings, travel, and business priorities",
      technology: "Advanced scheduling systems with executive priority access",
    },
    {
      advantage: "Professional Parking Solution",
      description:
        "Free executive parking eliminating city centre parking fees",
      traditionalAlternative:
        "Expensive city parking, time wasted searching, financial drain",
      executiveBenefit:
        "Free convenient parking saving money and professional time",
      technology: "Dedicated executive parking with direct practice access",
    },
    {
      advantage: "Executive Service Standards",
      description:
        "Professional service delivery matching business environment expectations",
      traditionalAlternative:
        "Variable city service, inconsistent quality, professional disappointment",
      executiveBenefit:
        "Consistent executive service exceeding professional standards",
      technology:
        "Executive service protocols with professional excellence focus",
    },
    {
      advantage: "Business-Grade Technology",
      description:
        "Professional-level equipment and treatment matching executive expectations",
      traditionalAlternative:
        "Basic city equipment, limited technology, standard treatment",
      executiveBenefit: "Premium technology delivering executive-level results",
      technology:
        "Professional-grade equipment with executive treatment protocols",
    },
  ];
  ...
  const executiveJourneyComparison = [
    {
      ...
      traditional:
        "Complex city booking, parking concerns, professional complications",
      modern: "Some convenience, basic professional accommodation",
      peartree:
        "Executive booking with guaranteed parking and professional priority",
    },
    {
      ...
      peartree:
        "15-minute efficient escape from city centre with free executive parking",
    },
    {
      stage: "Executive Arrival",
      traditional:
        "Parking stress, crowded environment, professional frustration",
      modern: "Some convenience, basic comfort",
      peartree:
        "Stress-free arrival with executive parking and professional welcome",
    },
    {
      stage: "Executive Reception",
      traditional:
        "Busy city reception, impersonal check-in, professional anonymity",
      modern: "Some personal attention, basic recognition",
      peartree:
        "Executive reception with professional recognition and premium service",
    },
    {
      stage: "Executive Consultation",
      traditional:
        "Rushed city appointments, basic technology, limited explanation",
      modern: "Some professional attention, basic consultation",
      peartree:
        "Executive consultation with cutting-edge technology and professional focus",
    },
    {
      stage: "Executive Treatment Planning",
      traditional:
        "Basic city planning, unclear professional pricing, limited options",
      modern: "Some planning clarity, basic professional consideration",
      peartree:
        "Executive treatment planning with premium options and transparent pricing",
    },
    {
      stage: "Executive Treatment Delivery",
      traditional:
        "Multiple city visits, parking fees, professional disruption",
      modern: "Some efficiency, reduced visits",
      peartree:
        "Same-day executive treatments minimizing professional disruption",
    },
    {
      ...
      peartree:
        "Executive aftercare with professional priority and convenient access",
    },
  ];
  ...
  const executiveBenefits = [
    {
      ...
      description:
        "Free parking that eliminates expensive city centre fees and complications",
      advantage:
        "Significant cost savings and time efficiency for professional visits",
      details:
        "Dedicated parking directly outside practice with no city centre fees or searching",
    },
    {
      benefit: "Executive Time Efficiency",
      description:
        "Same-day treatments and efficient service maximizing professional time",
      advantage:
        "Minimal disruption to demanding business schedules and commitments",
      details:
        "CEREC same-day crowns and streamlined executive service protocols",
    },
    {
      benefit: "Professional Service Standards",
      description:
        "Executive-level service matching business environment expectations",
      advantage:
        "Consistent quality and professionalism that executives can depend on",
      details:
        "Service delivery designed to exceed professional standards and expectations",
    },
    {
      benefit: "Business Schedule Accommodation",
      description:
        "Flexible scheduling that works around meetings, travel, and business priorities",
      advantage:
        "Dental care that fits professional demands rather than disrupting them",
      details:
        "Executive scheduling with emergency access and business travel understanding",
    },
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-pear-background to-white">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Looking for an{" "}
              <span className="text-yellow-300">Executive Dentist</span> in
              Nottingham City?
            </h1>
            ...
            <div className="bg-white rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Executive service, free parking, and professional convenience –
                just 15 minutes from NG1
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">
                🏢 Just 15 minutes from Nottingham City with executive
                convenience!
              </p>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Why Nottingham City Professionals Are Switching to Executive
                Dental Care
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                City centre dental care comes with complications that busy
                professionals shouldn't have to tolerate. Executive alternatives
                offer significant advantages that respect professional time and
                expectations.
              </p>
            </div>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="heading-serif text-3xl sm:text-4xl font-bold text-pear-primary mb-6">
                Executive Dental Technology: The Pear Tree Professional
                Advantage
              </h2>
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Professional-grade technology designed for executives – superior
                results with executive convenience that eliminates city centre
                complications.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Experience the difference that executive-focused dental care
                makes at every step.
              </p>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-lg text-gray-600">
                <strong>The Pear Tree Executive Difference:</strong> Every step
                designed around professional needs, executive convenience, and
                elimination of city centre complications.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Professional dental care that understands and accommodates the
                demanding schedules and high expectations of city executives.
              </p>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-4">
                Why Nottingham City Professionals Choose the Executive
                Alternative
              </h2>
            </div>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See the difference that professional-grade technology and
              executive service make
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Nottingham City professionals considering
                their options
              </p>
            </div>
      ...
      <section className="py-20 bg-cream">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold text-pear-primary mb-6">
              Executive Escape from Nottingham City Centre to Professional
              Dental Care
            </h2>
                ...
                <div className="text-left">
                  ...
                  <div className="space-y-3 text-gray-600">
                    ...
                    <p className="text-pear-primary font-semibold">
                      Free executive parking directly outside
                    </p>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <div className="bg-indigo-50 rounded-lg p-6">
                    ...
                    <p className="text-gray-600">
                      Professional escape from city complications
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed opacity-90 mb-8">
              ...
              executive convenience, professional service, and freedom from city
            ...
            <div className="bg-white rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                Executive service • Free parking • Professional convenience • 15
                minutes from NG1
              </p>
            </div>
