...
export const metadata: Metadata = {
  title:
    "Teeth Straightening East Bridgford - Village Invisalign & Clear Aligners | Pear Tree Dental",
  description:
    "Exclusive teeth straightening for East Bridgford village residents. Invisalign, clear aligners, and discreet orthodontics with village convenience.",
  keywords: [
  ...
  openGraph: {
    title:
      "Village Teeth Straightening in East Bridgford - Invisalign & Clear Aligners",
    description:
      "Discreet teeth straightening for East Bridgford village residents with personal care and attention.",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description:
              "Exclusive teeth straightening treatments including Invisalign and clear aligners for East Bridgford village residents.",
            provider: {
              "@type": "Dentist",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="flex items-center justify-center space-x-2 mb-6">
              ...
              <span className="text-dental-green font-medium">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
              ...
              <span className="text-dental-green block">
                for East Bridgford
              </span>
            </h1>

            <p className="text-xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
              Discreet teeth straightening for East Bridgford village residents
              with Invisalign and clear aligners. Professional orthodontic care
              with the personal attention and village convenience you value.
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Exclusive Teeth Straightening for East Bridgford Village
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Choose from our range of discreet orthodontic treatments with
                the personal care and village convenience that East Bridgford
                residents value.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green bg-gradient-to-br from-white to-dental-green">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Clear, removable aligners with village priority
                  </p>
              ...
              <Card className="p-6 border border-pear-primary bg-gradient-to-br from-white to-pear-primary">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Fast correction with village convenience
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
              ...
              <Card className="p-6 border border-pear-gold bg-gradient-to-br from-white to-pear-gold">
                ...
                <CardContent className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    Comprehensive treatment with village benefits
                  </p>
                  <div className="space-y-2 text-sm text-gray-700 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-bold mb-8">
                  Why East Bridgford Village Chooses Clear Aligners
                </h2>
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        ...
                        straighten your teeth discreetly while maintaining the
                        confidence that village life requires.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2">
                        Village Lifestyle Friendly
                      </h3>
                      <p className="text-gray-700">
                        Removable aligners mean no food restrictions and easy
                        cleaning. Perfect for the active village lifestyle and
                        community events.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">
                        Modern aligner technology with the personal attention
                        and village service that East Bridgford residents have
                        come to expect.
                      </p>
                    </div>
                  </div>
              ...
              <div className="relative">
                <Card className="overflow-hidden shadow-xl">
                  <div className="aspect-[4/3] bg-gradient-to-br from-dental-green to-pear-primary flex items-center justify-center">
                    <div className="text-center p-8">
                      ...
                      <p className="text-gray-600 mb-4">
                        Exclusive alignment for East Bridgford
                      </p>
      ...
      <section className="py-16 bg-white text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Your Village Teeth Straightening Journey
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                A simple, personal process designed with village convenience and
                care in mind
              </p>
            </div>
                ...
                [
                  {
                    ...
                    description:
                      "Personal assessment with village priority scheduling",
                    icon: Users,
                    time: "45 minutes",
                  },
                  {
                    ...
                    description:
                      "3D scans to create your personalized treatment plan",
                    icon: Sparkles,
                    time: "30 minutes",
                  },
                  {
                    ...
                    description:
                      "Receive your aligners with personal instructions",
                    icon: CheckCircle,
                    time: "20 minutes",
                  },
                  {
      ...
      <section className="py-16 bg-gray-50 text-dental-navy">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4">
                Village Orthodontic Care from East Bridgford
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Professional teeth straightening without the city center hassle.
                Peaceful village access and personal care.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="p-6 border border-dental-green">
                ...
                <p className="text-gray-700 mb-4">
                  Just 5 minutes from East Bridgford with beautiful countryside
                  route and village parking.
                </p>
                <div className="space-y-2 text-sm text-gray-600">
              ...
              <Card className="p-6 border border-pear-primary">
                ...
                <p className="text-gray-700 mb-4">
                  Flexible appointments with village priority and personal
              ...
              <Card className="p-6 border border-pear-gold">
                ...
                <p className="text-gray-700 mb-4">
                  Experienced orthodontic team with village community approach
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Real stories from East Bridgford village residents who've
                transformed their smiles with clear aligners
              </p>
            </div>
                ...
                <Card key={index} className="p-6 shadow-lg">
                  <div className="space-y-4">
                    ...
                    <div className="border-t pt-4">
                      ...
                      <div className="text-sm text-pear-primary font-medium">
                        {review.treatment}
                      </div>
                    </div>
                  </div>
