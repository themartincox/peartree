...
export const metadata: Metadata = {
  ...
  description: 'Seeking an alternative to Sherwood Dental Care NHS practice? Discover Pear Tree Dental in Burton Joyce - membership pricing, no waiting lists, all treatments available.',
  keywords: [
    'Sherwood Dental Care alternative',
    'alternative to Sherwood Dental Care',
...
const reasonsToSwitch = [
  {
    icon: Shield,
    title: "Escape NHS Restrictions",
    description: "No waiting lists, no limited treatment options, no NHS funding restrictions",
    benefit: "Access all dental treatments when you need them"
  },
  {
    icon: CreditCard,
    title: "Predictable Costs",
    description: "Simple monthly membership eliminates NHS bands and surprise private charges",
  ...
  },
  {
    ...
    description: "Simple family membership plans without individual NHS registrations",
    benefit: "One plan covers the whole family's dental care"
  }
];
...
const switchingProcess = [
  ...
  },
  {
    ...
    description: "We'll request your NHS dental records seamlessly"
  },
  {
    step: "3",
...
const nhsVsMembership = [
  {
    ...
    nhs: "Weeks/months for routine care",
  ...
  },
  {
    ...
    membership: "Fixed monthly membership fee",
    advantage: "membership"
  },
  {
    aspect: "Emergency Care",
    nhs: "NHS emergency appointments",
    membership: "Guaranteed same-day access",
    advantage: "membership"
  },
  {
    aspect: "Cosmetic Treatments",
    nhs: "Generally not available",
    membership: "Included in membership",
    advantage: "membership"
  }
];
...
const faqs = [
  {
    question: "Why would someone choose Pear Tree Dental as an alternative to NHS Sherwood Dental Care?",
    answer: "Common reasons include escaping NHS waiting lists, accessing all treatment options, predictable monthly costs, same-day emergency care, and freedom from NHS funding restrictions that can limit treatment choices."
  },
  {
    question: "How does membership dental care differ from NHS dental care?",
    answer: "Membership care provides unlimited access to all treatments, no waiting lists, priority emergency appointments, and predictable monthly costs. NHS care involves band charges, waiting lists, and treatment limitations based on funding availability."
  },
  {
    question: "Can I transfer from NHS dental care to membership care?",
    answer: "Yes, we can request your NHS dental records and continue any ongoing treatments. The transition is seamless, and you'll immediately benefit from membership privileges including priority booking and emergency care."
  },
  {
    question: "What treatments are included in membership that might not be available on NHS?",
    answer: "Membership includes cosmetic treatments like teeth whitening and bonding, premium materials for fillings and crowns, advanced periodontal treatments, and comprehensive preventive care - all without NHS funding restrictions."
  }
];

export default function SherwoodDentalCareAlternativePage() {
  return (
    <div className="min-h-screen bg-pear-background">
      ...
      <nav className="bg-secondary py-3" aria-label="Breadcrumb">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <li>/</li>
            <li className="text-foreground font-medium">Sherwood Dental Care Alternative</li>
          </ol>
        </div>
      </nav>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="heading-serif text-4xl md:text-5xl font-bold mb-6 text-primary">
              Looking for an Alternative to Sherwood Dental Care?
            </h1>
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              Escape NHS waiting lists and restrictions with Pear Tree Dental's membership model.
              Access all treatments when you need them, with transparent pricing and no NHS limitations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/sherwood-dental-care-reviews-nottingham">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold mb-4 text-primary">
                NHS vs Membership Care: The Key Differences
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Understanding the fundamental differences between NHS dental care and
                membership-based private practice.
              </p>
            </div>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="heading-serif text-3xl font-bold mb-4 text-primary">
                Pear Tree Dental: Freedom from NHS Limitations
              </h2>
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-secondary">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-serif text-3xl font-bold text-center mb-12 text-primary">
              Making the Switch from NHS is Simple
            </h2>
            ...
            <div className="mt-12 text-center">
              <Card className="bg-primary/5 border-primary/20 p-6">
                <h3 className="heading-serif text-xl font-semibold mb-4">
                  Ready to Escape NHS Limitations?
                </h3>
                <p className="text-muted-foreground mb-6">
                  Book your consultation today and discover the freedom of membership-based dental care
                  without NHS restrictions, waiting lists, or limited treatment options.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Button asChild size="lg" className="bg-accent-gold hover:bg-accent-gold/90 text-primary">
                    <Link href="tel:01159312935">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="heading-serif text-3xl font-bold text-center mb-8 text-primary">
              Frequently Asked Questions About Switching from NHS
            </h2>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl font-bold mb-6">
              Experience Dental Care Without NHS Limitations
            </h2>
