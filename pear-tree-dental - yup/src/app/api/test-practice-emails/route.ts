...
export async function GET() {
  try {
    ...
    const diagnostics = {
      ...
      emailTemplate: 'Individual emails sent to each practice address separately',
      emailContent: 'New membership signup notification with application details'
    };
    ...
    const membershipEmailAnalysis = {
      ...
      testRecommendation: 'Send a manual test email to membership@peartree.dental to verify deliverability'
    };
    ...
    const emailSystemStatus = {
      ...
      currentStatus: emailPass ? 'Operational' : 'Development mode - credentials missing'
    };
