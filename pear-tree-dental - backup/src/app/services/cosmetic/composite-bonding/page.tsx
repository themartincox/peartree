...
export const metadata: Metadata = {
  ...
  description: "Composite bonding in Burton Joyce. Same-day smile transformation with tooth-coloured resin. Fix chips, gaps, and discoloration instantly from £150 per tooth.",
  keywords: [
...
const faqs = [
  {
    ...
    answer: "Composite bonding starts from £150 per tooth. Costs vary depending on the complexity and number of teeth treated. Gap closure typically costs £300 for two teeth, while full smile makeovers range from £900-1500. Our membership plans include 20% discounts."
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceStructuredData
        ...
        description="Same-day smile transformation with composite bonding. Fix chips, close gaps, and reshape teeth instantly with tooth-coloured resin."
        provider={{
          "@type": "Dentist",
        ...
        availableChannel={{
          "@type": "ServiceChannel",
          "serviceUrl": "https://peartree.dental/services/cosmetic/composite-bonding",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h1 className="heading-serif text-4xl sm:text-5xl font-bold text-pear-primary leading-tight mb-6">
                Composite
                <span className="block text-pear-gold">Bonding</span>
              </h1>
              ...
              <div className="bg-pear-background border border-pear-gold/20 rounded-lg p-4 mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-bold text-pear-primary">SAME-DAY RESULTS</div>
                    <div className="text-gray-600 text-sm">Complete smile transformation in one appointment!</div>
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-pear-gold">£150</div>
                  <div className="text-sm text-gray-600">From</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-pear-gold">Same Day</div>
                  <div className="text-sm text-gray-600">Results</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-pear-gold">1-2 Hours</div>
                  <div className="text-sm text-gray-600">Treatment</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-pear-gold">Painless</div>
            ...
            <div className="relative">
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-pear-background to-soft-lavender flex items-center justify-center">
                  <div className="text-center">
                    <Palette className="w-16 h-16 text-pear-gold mx-auto mb-4" />
                    <h3 className="text-xl font-bold text-pear-primary mb-2">COMPOSITE BONDING</h3>
              ...
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-pear-gold to-pear-primary text-white rounded-full px-4 py-2 shadow-lg transform rotate-12">
                <div className="text-center">
                  <div className="text-sm font-bold">ENHANCED</div>
                  <div className="text-lg font-extrabold">1,500+</div>
                  <div className="text-xs">SMILES</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {bondingApplications.map((application, index) => (
              <Card key={index} className={`${application.popular ? 'ring-2 ring-pear-gold scale-105 relative' : ''}`}>
                {application.popular && (
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-pear-gold">{application.cost}</div>
                ...
                <div className="flex">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div className="bg-pear-gold/10 p-4 rounded">
      ...
      <section className="py-16 bg-pear-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="overflow-hidden shadow-xl">
            <CardHeader className="bg-gradient-to-r from-pear-primary to-pear-gold text-white">
                ...
                <table className="w-full">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-center text-sm font-semibold text-pear-gold">Composite Bonding</th>
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {bondingVsAlternatives.map((comparison, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="px-4 py-3 text-sm font-medium text-pear-primary">{comparison.aspect}</td>
                        <td className="px-4 py-3 text-sm text-center text-pear-gold font-medium">{comparison.bonding}</td>
                        ...
                        <td className="px-4 py-3 text-sm text-center font-medium">
                          <Badge variant={comparison.advantage.includes('Bonding') ? 'default' : 'secondary'}
                                 className={comparison.advantage.includes('Bonding') ? 'bg-pear-gold' : ''}>
            ...
            {beforeAfterScenarios.map((scenario, index) => (
              <Card key={index} className="p-6">
                <div className="text-center mb-4">
                  <Badge className="bg-pear-gold text-white mb-2">{scenario.cost}</Badge>
                  <h3 className="font-semibold text-lg text-pear-primary">{scenario.concern}</h3>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-pear-background p-3 rounded border">
                    <h4 className="font-semibold mb-1">Expected Result:</h4>
                    <p className="text-sm text-gray-700">{scenario.result}</p>
                  </div>

                  <div className="text-center">
                    <Badge variant="outline" className="text-pear-gold border-pear-gold">
            ...
            {careInstructions.map((period, index) => (
              <Card key={index} className={`p-6 ${period.critical ? 'border-2 border-red-200 bg-red-50' : ''}`}>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="font-semibold text-pear-gold text-lg">{period.timeframe}</h3>
                  {period.critical && (
                ...
                <div className="space-y-4">
                    ...
                    <ul className="space-y-2">
                      {period.instructions.map((instruction, idx) => (
                        <li key={idx} className="flex items-start space-x-2">
                          <CheckCircle className="w-4 h-4 text-pear-gold mt-0.5 flex-shrink-0" />
                  ...
                  <div className="bg-pear-gold/10 p-3 rounded border">
