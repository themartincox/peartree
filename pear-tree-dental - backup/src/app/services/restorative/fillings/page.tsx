...
export const metadata: Metadata = {
  ...
  description: "Modern white dental fillings in Burton Joyce. Natural-looking, mercury-free composite fillings. Replace old amalgam fillings with tooth-coloured alternatives from £200.",
  keywords: [
    "white dental fillings Burton Joyce",
    "tooth coloured fillings",
    "composite fillings",
    "mercury free fillings",
    "replace silver fillings",
    "dental restoration Burton Joyce"
  ],
};
...
const afterCareInstructions = [
  ...
  },
  {
    ...
    whatToExpect: "Sensitivity should decrease, normal function returns"
  },
  {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ServiceStructuredData
        serviceName="White Dental Fillings"
        description="Modern tooth-coloured fillings that blend seamlessly with natural teeth. Mercury-free, strong, and aesthetically pleasing alternatives to traditional silver fillings."
        provider={{
          "@type": "Dentist",
        ...
        availableChannel={{
          "@type": "ServiceChannel",
          "serviceUrl": "https://peartree.dental/services/restorative/fillings",
              ...
              <Card className="overflow-hidden shadow-2xl">
                <div className="aspect-[4/3] bg-gradient-to-br from-dental-green/20 to-soft-blue/20 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-xl font-bold text-pear-primary mb-2">WHITE FILLINGS</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {fillingTypes.map((filling, index) => (
              <Card key={index} className={`${filling.popular ? 'ring-2 ring-dental-green scale-105 relative' : ''}`}>
                {filling.popular && (
