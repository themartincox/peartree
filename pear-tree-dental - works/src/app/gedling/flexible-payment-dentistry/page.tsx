...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Flexible Payment Dentistry in Gedling - Financing Options for Working Families | Pear Tree Dental",
    description: "Flexible payment dentistry for Gedling working families. Affordable financing options and payment plans for all treatments.",
...
export default function GedlingFlexiblePaymentDentistryPage() {
  const gedlingPaymentFAQs = [
    {
      question: "What payment options are available for working families from Gedling?",
      answer: "We offer multiple payment options including 0% interest payment plans (6-24 months), third-party financing, family payment packages, and flexible scheduling to spread costs. We believe quality dental care should be accessible to all Gedling working families regardless of budget constraints."
    },
    {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "image": "https://peartree.dental/images/flexible-payment-dentistry-gedling.jpg",
            "url": "https://peartree.dental/gedling/flexible-payment-dentistry",
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-serif text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">
              Flexible Payment Dentistry in <span className="text-yellow-300">Gedling</span>
            </h1>
            ...
            <div className="bg-white/10 rounded-lg p-4 mb-8 inline-block">
              <p className="text-lg font-medium">
                ...
                Quick drive from Gedling — Flexible payment plans from £25/month with 0% interest options
              </p>
            </div>
            ...
            <div className="mt-8 text-yellow-200">
              <p className="text-lg font-semibold">💳 Flexible financing makes quality dental care accessible for every Gedling family!</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We understand that Gedling working families have varying financial situations and cash flow needs.
            ...
            <div className="text-center bg-teal-50 rounded-lg p-8">
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                Our flexible payment solutions ensure that every Gedling family can access the dental treatment they need.
              </p>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600">
                Common questions from Gedling working families about flexible payment and financing options
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="heading-serif text-3xl sm:text-4xl font-bold mb-6">
              Don't Let Budget Concerns Delay Your Family's Dental Care from Gedling
            </h2>
            ...
            <div className="bg-white/10 rounded-lg p-6 mb-8 inline-block">
              ...
              <p className="text-sm opacity-90">
                0% interest options • From £25/month • Family plans available • Quick drive from Gedling
              </p>
            </div>
