...
// Get encryption key from environment or use fallback for dev (not for production)
const ENCRYPTION_KEY = process.env.ENCRYPTION_KEY || 'dev-fallback-key-must-be-32-bytes-lng';
